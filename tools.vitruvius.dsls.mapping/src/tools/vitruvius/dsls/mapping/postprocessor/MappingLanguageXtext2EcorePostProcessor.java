package tools.vitruvius.dsls.mapping.postprocessor;
...
public class MappingLanguageXtext2EcorePostProcessor implements IXtext2EcorePostProcessor {
	...
	public void process(GeneratedMetamodel metamodel) {
		...
		final Resource baseResource = rs.getResource(URI.createPlatformResourceURI("tools.vitruvius.dsls.mirbase/model/generated/MirBase.ecore", true), true);
