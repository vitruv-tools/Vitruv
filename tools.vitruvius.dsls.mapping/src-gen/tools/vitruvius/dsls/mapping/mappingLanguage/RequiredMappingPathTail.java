 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.dsls.mapping.mappingLanguage.RequiredMappingPathTail#getRequiredMapping <em>Required Mapping</em>}</li>
 *   <li>{@link tools.vitruvius.dsls.mapping.mappingLanguage.RequiredMappingPathTail#getTail <em>Tail</em>}</li>
 * </ul>
 *
 * @see tools.vitruvius.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathTail()
 * @model
 * @generated
 */
public interface RequiredMappingPathTail extends EObject
{
   ...
   * @see tools.vitruvius.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathTail_RequiredMapping()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruvius.dsls.mapping.mappingLanguage.RequiredMappingPathTail#getRequiredMapping <em>Required Mapping</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruvius.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathTail_Tail()
  ...
  /**
   * Sets the value of the '{@link tools.vitruvius.dsls.mapping.mappingLanguage.RequiredMappingPathTail#getTail <em>Tail</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
