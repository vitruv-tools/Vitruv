				...
				(
					...
					lv_mappings_1_0=ruleMapping
					{
						...
						add(
							...
							"mappings",
							lv_mappings_1_0,
							"tools.vitruvius.dsls.mapping.MappingLanguage.Mapping");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_mappings_2_0=ruleDefaultMapping
					{
						...
						add(
							...
							"mappings",
							lv_mappings_2_0,
							"tools.vitruvius.dsls.mapping.MappingLanguage.DefaultMapping");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_signatures_5_0=ruleSignature
						{
							...
							add(
								...
								"signatures",
								lv_signatures_5_0,
								"tools.vitruvius.dsls.mapping.MappingLanguage.Signature");
							afterParserOrEnumRuleCall();
						}
					)
				)
					...
					(
						...
						lv_constraints_7_0=ruleSignatureConstraintBlock
						{
							...
							add(
								...
								"constraints",
								lv_constraints_7_0,
								"tools.vitruvius.dsls.mapping.MappingLanguage.SignatureConstraintBlock");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_requires_6_0=ruleRequiredMapping
					{
						...
						add(
							...
							"requires",
							lv_requires_6_0,
							"tools.vitruvius.dsls.mapping.MappingLanguage.RequiredMapping");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_constraintsBody_19_0=ruleBodyConstraintBlock
						{
							...
							set(
								...
								"tools.vitruvius.dsls.mapping.MappingLanguage.BodyConstraintBlock");
							afterParserOrEnumRuleCall();
						}
					)
				)
					...
					(
						...
						lv_expressions_2_0=ruleSignatureConstraintExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_0,
								"tools.vitruvius.dsls.mapping.MappingLanguage.SignatureConstraintExpression");
							afterParserOrEnumRuleCall();
						}
					)
				)
					...
					(
						...
						lv_expressions_2_0=ruleBodyConstraintExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_0,
								"tools.vitruvius.dsls.mapping.MappingLanguage.BodyConstraintExpression");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_target_3_0=ruleContextVariable
				{
					...
					set(
						...
						"target",
						lv_target_3_0,
						"tools.vitruvius.dsls.mapping.MappingLanguage.ContextVariable");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_source_5_0=ruleFeatureOfContextVariable
				{
					...
					set(
						...
						"source",
						lv_source_5_0,
						"tools.vitruvius.dsls.mapping.MappingLanguage.FeatureOfContextVariable");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_value_5_0=ruleConstraintLiteral
				{
					...
					set(
						...
						"value",
						lv_value_5_0,
						"tools.vitruvius.dsls.mapping.MappingLanguage.ConstraintLiteral");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_requiredMappingPath_0_0=ruleRequiredMappingPathBase
					{
						...
						set(
							...
							"tools.vitruvius.dsls.mapping.MappingLanguage.RequiredMappingPathBase");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_tail_1_0=ruleRequiredMappingPathTail
				{
					...
					set(
						...
						"tail",
						lv_tail_1_0,
						"tools.vitruvius.dsls.mapping.MappingLanguage.RequiredMappingPathTail");
					afterParserOrEnumRuleCall();
				}
			)
		)?
