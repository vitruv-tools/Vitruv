	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getModelChangeEventAccess().getAlternatives_0(), "rule__ModelChangeEvent__Alternatives_0");
					...
					put(grammarAccess.getEffectsAccess().getGroup(), "rule__Effects__Group__0");
					put(grammarAccess.getEffectsAccess().getGroup_0(), "rule__Effects__Group_0__0");
					put(grammarAccess.getModelChangeEventAccess().getGroup(), "rule__ModelChangeEvent__Group__0");
					put(grammarAccess.getUpdateEventAccess().getGroup(), "rule__UpdateEvent__Group__0");
					put(grammarAccess.getCreateEventAccess().getGroup(), "rule__CreateEvent__Group__0");
					put(grammarAccess.getDeleteEventAccess().getGroup(), "rule__DeleteEvent__Group__0");
					...
					put(grammarAccess.getResponseFileAccess().getImportsAssignment_0(), "rule__ResponseFile__ImportsAssignment_0");
					put(grammarAccess.getResponseFileAccess().getResponsesAssignment_1(), "rule__ResponseFile__ResponsesAssignment_1");
					...
					put(grammarAccess.getResponseAccess().getTriggerAssignment_1(), "rule__Response__TriggerAssignment_1");
					put(grammarAccess.getResponseAccess().getEffectsAssignment_2(), "rule__Response__EffectsAssignment_2");
					put(grammarAccess.getEffectsAccess().getAffectedModelAssignment_0_1(), "rule__Effects__AffectedModelAssignment_0_1");
					put(grammarAccess.getEffectsAccess().getCodeAssignment_1(), "rule__Effects__CodeAssignment_1");
					put(grammarAccess.getAffectedModelAccess().getModelAssignment(), "rule__AffectedModel__ModelAssignment");
					put(grammarAccess.getModelChangeEventAccess().getFeatureAssignment_2(), "rule__ModelChangeEvent__FeatureAssignment_2");
					put(grammarAccess.getModelChangeEventAccess().getMetamodelAssignment_4(), "rule__ModelChangeEvent__MetamodelAssignment_4");
					put(grammarAccess.getUpdateEventAccess().getNameAssignment_1(), "rule__UpdateEvent__NameAssignment_1");
					put(grammarAccess.getCreateEventAccess().getNameAssignment_1(), "rule__CreateEvent__NameAssignment_1");
					put(grammarAccess.getDeleteEventAccess().getNameAssignment_1(), "rule__DeleteEvent__NameAssignment_1");
