 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.framework.change.echange.EObjectSubtractedEChange#getOldValue <em>Old Value</em>}</li>
 *   <li>{@link tools.vitruvius.framework.change.echange.EObjectSubtractedEChange#isIsDelete <em>Is Delete</em>}</li>
 * </ul>
 *
 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectSubtractedEChange()
 * @model abstract="true"
 * @generated
 */
public interface EObjectSubtractedEChange<T extends EObject> extends SubtractiveEChange<T> {
	 ...
	 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectSubtractedEChange_OldValue()
	 * @model required="true"
	 * @generated
	 */
    T getOldValue();
    ...
    /**
	 * Sets the value of the '{@link tools.vitruvius.framework.change.echange.EObjectSubtractedEChange#getOldValue <em>Old Value</em>}' reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectSubtractedEChange_IsDelete()
	 * @model required="true"
	 * @generated
	 */
    boolean isIsDelete();
    ...
    /**
	 * Sets the value of the '{@link tools.vitruvius.framework.change.echange.EObjectSubtractedEChange#isIsDelete <em>Is Delete</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
