/**
 */
package tools.vitruvius.framework.change.echange.feature.reference.util;
...
import tools.vitruvius.framework.change.echange.feature.list.PermuteListEChange;
 ...
 * <!-- end-user-doc -->
 * @see tools.vitruvius.framework.change.echange.feature.reference.ReferencePackage
 * @generated
 */
public class ReferenceAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ReferenceSwitch<Adapter> modelSwitch =
        new ReferenceSwitch<Adapter>() {
			@Override
			public <A extends EObject> Adapter caseUpdateReferenceEChange(tools.vitruvius.framework.change.echange.feature.reference.UpdateReferenceEChange<A> object) {
    ...
    /**
	 * Creates a new adapter for an object of class '{@link tools.vitruvius.framework.change.echange.feature.reference.PermuteEReferences <em>Permute EReferences</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
	 * Creates a new adapter for an object of class '{@link tools.vitruvius.framework.change.echange.feature.list.PermuteListEChange <em>Permute List EChange</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see tools.vitruvius.framework.change.echange.feature.list.PermuteListEChange
	 * @generated
	 */
