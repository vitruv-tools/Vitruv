 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.framework.change.echange.EObjectAddedEChange#getNewValue <em>New Value</em>}</li>
 *   <li>{@link tools.vitruvius.framework.change.echange.EObjectAddedEChange#isIsCreate <em>Is Create</em>}</li>
 * </ul>
 *
 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectAddedEChange()
 * @model abstract="true"
 * @generated
 */
public interface EObjectAddedEChange<T extends EObject> extends AdditiveEChange<T> {
	 ...
	 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectAddedEChange_NewValue()
	 * @model required="true"
	 * @generated
	 */
    T getNewValue();
    ...
    /**
	 * Sets the value of the '{@link tools.vitruvius.framework.change.echange.EObjectAddedEChange#getNewValue <em>New Value</em>}' reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * @see tools.vitruvius.framework.change.echange.EChangePackage#getEObjectAddedEChange_IsCreate()
	 * @model required="true"
	 * @generated
	 */
    boolean isIsCreate();
    ...
    /**
	 * Sets the value of the '{@link tools.vitruvius.framework.change.echange.EObjectAddedEChange#isIsCreate <em>Is Create</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
