 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.framework.change.echange.impl.EObjectAddedEChangeImpl#getNewValue <em>New Value</em>}</li>
 *   <li>{@link tools.vitruvius.framework.change.echange.impl.EObjectAddedEChangeImpl#isIsCreate <em>Is Create</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EObjectAddedEChangeImpl<T extends EObject> extends tools.vitruvius.framework.change.echange.impl.AdditiveEChangeImpl<T> implements EObjectAddedEChange<T> {
    /**
