 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.framework.change.echange.compound.ExplicitUnsetEFeature#getSubtractiveChanges <em>Subtractive Changes</em>}</li>
 * </ul>
 *
 * @see tools.vitruvius.framework.change.echange.compound.CompoundPackage#getExplicitUnsetEFeature()
...
public interface ExplicitUnsetEFeature<A extends EObject, F extends EStructuralFeature, T extends Object, S extends FeatureEChange<A, F> & SubtractiveEChange<T>> extends CompoundEChange {
	 ...
	 * @see tools.vitruvius.framework.change.echange.compound.CompoundPackage#getExplicitUnsetEFeature_SubtractiveChanges()
    ...
    /**
	 * Unsets the value of the '{@link tools.vitruvius.framework.change.echange.compound.ExplicitUnsetEFeature#getSubtractiveChanges <em>Subtractive Changes</em>}' reference list.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #isSetSubtractiveChanges()
    ...
    /**
	 * Returns whether the value of the '{@link tools.vitruvius.framework.change.echange.compound.ExplicitUnsetEFeature#getSubtractiveChanges <em>Subtractive Changes</em>}' reference list is set.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
