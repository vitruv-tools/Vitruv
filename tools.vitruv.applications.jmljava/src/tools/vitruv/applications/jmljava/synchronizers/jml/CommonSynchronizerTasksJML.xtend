package tools.vitruv.applications.jmljava.synchronizers.jml
...
import tools.vitruv.applications.jmljava.helper.java.shadowcopy.ShadowCopyCorrespondences
import tools.vitruv.applications.jmljava.helper.java.shadowcopy.ShadowCopyJavaJmlHelperBase
