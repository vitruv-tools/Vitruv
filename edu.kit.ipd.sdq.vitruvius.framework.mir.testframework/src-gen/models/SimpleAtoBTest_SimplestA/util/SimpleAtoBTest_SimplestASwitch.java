/**
 */
package SimpleAtoBTest_SimplestA.util;
 ...
 * @generated
 */
public class SimpleAtoBTest_SimplestASwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SimpleAtoBTest_SimplestAPackage modelPackage;
	 ...
	 * @generated
	 */
	public SimpleAtoBTest_SimplestASwitch() {
		if (modelPackage == null) {
			modelPackage = SimpleAtoBTest_SimplestAPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimpleAtoBTest_SimplestAPackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleAtoBTest_SimplestAPackage.ACHILD: {
				AChild aChild = (AChild)theEObject;
				T result = caseAChild(aChild);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAChild(AChild object) {
		return null;
	}
...
} //SimpleAtoBTest_SimplestASwitch
