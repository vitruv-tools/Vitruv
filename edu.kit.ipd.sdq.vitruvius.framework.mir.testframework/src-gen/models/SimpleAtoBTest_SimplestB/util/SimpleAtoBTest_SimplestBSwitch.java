 ...
 * @generated
 */
public class SimpleAtoBTest_SimplestBSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SimpleAtoBTest_SimplestBSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimpleAtoBTest_SimplestBPackage.B: {
				B b = (B)theEObject;
				T result = caseB(b);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleAtoBTest_SimplestBPackage.BCHILD: {
				BChild bChild = (BChild)theEObject;
				T result = caseBChild(bChild);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseBChild(BChild object) {
		return null;
	}
...
} //SimpleAtoBTest_SimplestBSwitch
