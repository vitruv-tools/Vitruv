		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInExpressionAccess().getTargetAssignment_1(), "rule__InExpression__TargetAssignment_1");
					put(grammarAccess.getInExpressionAccess().getSourceAssignment_3(), "rule__InExpression__SourceAssignment_3");
					put(grammarAccess.getEqualsLiteralExpressionAccess().getTargetAssignment_1(), "rule__EqualsLiteralExpression__TargetAssignment_1");
					put(grammarAccess.getEqualsLiteralExpressionAccess().getValueAssignment_3(), "rule__EqualsLiteralExpression__ValueAssignment_3");
					...
					put(grammarAccess.getFeatureOfContextVariableAccess().getFeatureAssignment_2(), "rule__FeatureOfContextVariable__FeatureAssignment_2");
					put(grammarAccess.getContextVariableAccess().getTargetAssignment(), "rule__ContextVariable__TargetAssignment");
