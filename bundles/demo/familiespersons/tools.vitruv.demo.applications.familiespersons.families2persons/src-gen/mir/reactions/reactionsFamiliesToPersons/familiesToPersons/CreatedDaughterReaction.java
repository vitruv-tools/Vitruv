...
public class CreatedDaughterReaction extends AbstractReactionRealization {
  ...
  public CreatedDaughterReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsFamiliesToPersons.familiesToPersons.CreatedDaughterReaction.ActionUserExecution userExecution = new mir.reactions.reactionsFamiliesToPersons.familiesToPersons.CreatedDaughterReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final Family affectedEObject, final EReference affectedFeature, final Member newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createDaughter(newValue);
    }
  }
}
