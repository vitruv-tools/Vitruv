...
public class ChangedLastNameReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Family, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedLastNameReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.familiesToPersons.ChangedLastNameReaction.ActionUserExecution userExecution = new mir.reactions.familiesToPersons.ChangedLastNameReaction.ActionUserExecution(this.executionState, this);
