...
public class DeletedMemberReaction extends AbstractReactionRealization {
  private DeleteEObject<Member> deleteChange;
  
  private int currentlyMatchedChange;
  
  public DeletedMemberReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.familiesToPersons.DeletedMemberReaction.ActionUserExecution userExecution = new mir.reactions.familiesToPersons.DeletedMemberReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Member affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
