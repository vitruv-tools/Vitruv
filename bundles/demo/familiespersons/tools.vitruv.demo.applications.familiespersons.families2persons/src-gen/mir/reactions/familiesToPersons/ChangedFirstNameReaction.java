...
public class ChangedFirstNameReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Member, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedFirstNameReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    edu.kit.ipd.sdq.metamodels.families.Member affectedEObject = replaceChange.getAffectedEObject();
    ...
    mir.reactions.familiesToPersons.ChangedFirstNameReaction.ActionUserExecution userExecution = new mir.reactions.familiesToPersons.ChangedFirstNameReaction.ActionUserExecution(this.executionState, this);
