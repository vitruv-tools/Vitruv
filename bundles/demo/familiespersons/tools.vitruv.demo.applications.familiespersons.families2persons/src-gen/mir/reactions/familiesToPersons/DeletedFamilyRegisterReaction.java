...
public class DeletedFamilyRegisterReaction extends AbstractReactionRealization {
  private DeleteEObject<FamilyRegister> deleteChange;
  
  private int currentlyMatchedChange;
  
  public DeletedFamilyRegisterReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.familiesToPersons.DeletedFamilyRegisterReaction.ActionUserExecution userExecution = new mir.reactions.familiesToPersons.DeletedFamilyRegisterReaction.ActionUserExecution(this.executionState, this);
