...
public class CreatedFamilyRegisterReaction extends AbstractReactionRealization {
  ...
  public CreatedFamilyRegisterReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.familiesToPersons.CreatedFamilyRegisterReaction.ActionUserExecution userExecution = new mir.reactions.familiesToPersons.CreatedFamilyRegisterReaction.ActionUserExecution(this.executionState, this);
