...
public class CreatedPersonRegisterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.personsToFamilies.CreatedPersonRegisterReaction.ActionUserExecution userExecution = new mir.reactions.personsToFamilies.CreatedPersonRegisterReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertRootEObject insertChange, final PersonRegister newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
