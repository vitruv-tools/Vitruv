...
public class ChangedFullNameReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Person, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedFullNameReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.personsToFamilies.ChangedFullNameReaction.ActionUserExecution userExecution = new mir.reactions.personsToFamilies.ChangedFullNameReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Person affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
