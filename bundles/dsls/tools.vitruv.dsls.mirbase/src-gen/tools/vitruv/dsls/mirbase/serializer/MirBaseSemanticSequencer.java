 ...
 */
package tools.vitruv.dsls.mirbase.serializer;
...
public class MirBaseSemanticSequencer extends XbaseSemanticSequencer {
	...
	protected void sequence_MetamodelReference(ISerializationContext context, MetamodelReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMetamodelReferenceAccess().getModelMetamodelImportIDTerminalRuleCall_0_1(), semanticObject.eGet(MirBasePackage.Literals.METAMODEL_REFERENCE__MODEL, false));
		feeder.finish();
	}
