...
import tools.vitruv.dsls.mappings.ide.contentassist.antlr.PartialMappingsLanguageContentAssistParser;
import tools.vitruv.dsls.mappings.ide.contentassist.antlr.internal.InternalMappingsLanguageLexer;
import tools.vitruv.dsls.mappings.ui.contentassist.MappingsLanguageProposalProvider;
import tools.vitruv.dsls.mappings.ui.labeling.MappingsLanguageDescriptionLabelProvider;
import tools.vitruv.dsls.mappings.ui.labeling.MappingsLanguageLabelProvider;
import tools.vitruv.dsls.mappings.ui.outline.MappingsLanguageOutlineTreeProvider;
import tools.vitruv.dsls.mappings.ui.quickfix.MappingsLanguageQuickfixProvider;

/**
 * Manual modifications go to {@link MappingsLanguageUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMappingsLanguageUiModule extends DefaultXbaseUiModule {

	public AbstractMappingsLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(tools.vitruv.dsls.mappings.parser.antlr.internal.InternalMappingsLanguageLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMappingsLanguageLexer.class).toProvider(LexerProvider.create(InternalMappingsLanguageLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return MappingsLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MappingsLanguageDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return MappingsLanguageOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return MappingsLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MappingsLanguageProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMappingsLanguageContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("MappingsLanguage Compare");
	}
