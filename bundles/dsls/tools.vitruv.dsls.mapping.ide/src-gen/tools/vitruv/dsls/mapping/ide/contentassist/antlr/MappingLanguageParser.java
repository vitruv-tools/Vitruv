 ...
 */
package tools.vitruv.dsls.mapping.ide.contentassist.antlr;
...
import tools.vitruv.dsls.mapping.ide.contentassist.antlr.internal.InternalMappingLanguageParser;
import tools.vitruv.dsls.mapping.services.MappingLanguageGrammarAccess;

public class MappingLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalMappingLanguageParser createParser() {
		InternalMappingLanguageParser result = new InternalMappingLanguageParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBodyConstraintExpressionAccess().getAlternatives(), "rule__BodyConstraintExpression__Alternatives");
					put(grammarAccess.getDefaultContainExpressionAccess().getAlternatives_1(), "rule__DefaultContainExpression__Alternatives_1");
					put(grammarAccess.getConstraintLiteralAccess().getAlternatives(), "rule__ConstraintLiteral__Alternatives");
					put(grammarAccess.getConstraintBooleanLiteralAccess().getAlternatives_1(), "rule__ConstraintBooleanLiteral__Alternatives_1");
					...
					put(grammarAccess.getMappingAccess().getGroup_1(), "rule__Mapping__Group_1__0");
					put(grammarAccess.getMappingAccess().getGroup_2(), "rule__Mapping__Group_2__0");
					put(grammarAccess.getMappingAccess().getGroup_2_3(), "rule__Mapping__Group_2_3__0");
					put(grammarAccess.getMappingAccess().getGroup_3(), "rule__Mapping__Group_3__0");
					put(grammarAccess.getMappingAccess().getGroup_3_1(), "rule__Mapping__Group_3_1__0");
					put(grammarAccess.getMappingAccess().getGroup_3_1_0(), "rule__Mapping__Group_3_1_0__0");
					put(grammarAccess.getMappingAccess().getGroup_3_1_0_1(), "rule__Mapping__Group_3_1_0_1__0");
					put(grammarAccess.getMappingAccess().getGroup_3_1_2(), "rule__Mapping__Group_3_1_2__0");
					put(grammarAccess.getMappingAccess().getGroup_3_1_2_1(), "rule__Mapping__Group_3_1_2_1__0");
					put(grammarAccess.getMappingAccess().getGroup_3_2(), "rule__Mapping__Group_3_2__0");
					...
					put(grammarAccess.getRequiredMappingAccess().getGroup_1(), "rule__RequiredMapping__Group_1__0");
					...
					put(grammarAccess.getXbaseSignatureConstraintExpressionAccess().getGroup(), "rule__XbaseSignatureConstraintExpression__Group__0");
					put(grammarAccess.getXbaseBodyConstraintExpressionAccess().getGroup(), "rule__XbaseBodyConstraintExpression__Group__0");
					...
					put(grammarAccess.getFeatureOfContextVariableAccess().getGroup_1(), "rule__FeatureOfContextVariable__Group_1__0");
					put(grammarAccess.getContextVariableAccess().getGroup(), "rule__ContextVariable__Group__0");
					put(grammarAccess.getContextVariableAccess().getGroup_0(), "rule__ContextVariable__Group_0__0");
					put(grammarAccess.getRequiredMappingPathBaseAccess().getGroup(), "rule__RequiredMappingPathBase__Group__0");
					put(grammarAccess.getRequiredMappingPathTailAccess().getGroup(), "rule__RequiredMappingPathTail__Group__0");
					put(grammarAccess.getConstraintBooleanLiteralAccess().getGroup(), "rule__ConstraintBooleanLiteral__Group__0");
					...
					put(grammarAccess.getDefaultMappingAccess().getConstraintsAssignment_4_1_2(), "rule__DefaultMapping__ConstraintsAssignment_4_1_2");
					put(grammarAccess.getMappingAccess().getNameAssignment_1_1(), "rule__Mapping__NameAssignment_1_1");
					put(grammarAccess.getMappingAccess().getRequiresAssignment_2_2(), "rule__Mapping__RequiresAssignment_2_2");
					put(grammarAccess.getMappingAccess().getRequiresAssignment_2_3_1(), "rule__Mapping__RequiresAssignment_2_3_1");
					put(grammarAccess.getMappingAccess().getSignaturesAssignment_3_1_0_0(), "rule__Mapping__SignaturesAssignment_3_1_0_0");
					put(grammarAccess.getMappingAccess().getConstraintsAssignment_3_1_0_1_1(), "rule__Mapping__ConstraintsAssignment_3_1_0_1_1");
					put(grammarAccess.getMappingAccess().getSignaturesAssignment_3_1_2_0(), "rule__Mapping__SignaturesAssignment_3_1_2_0");
					put(grammarAccess.getMappingAccess().getConstraintsAssignment_3_1_2_1_1(), "rule__Mapping__ConstraintsAssignment_3_1_2_1_1");
					put(grammarAccess.getMappingAccess().getConstraintsBodyAssignment_3_2_1(), "rule__Mapping__ConstraintsBodyAssignment_3_2_1");
					put(grammarAccess.getMappingAccess().getChildMappingsAssignment_3_2_2(), "rule__Mapping__ChildMappingsAssignment_3_2_2");
					put(grammarAccess.getSignatureAccess().getDeclaredPackageAssignment_2_0(), "rule__Signature__DeclaredPackageAssignment_2_0");
					put(grammarAccess.getSignatureAccess().getElementsAssignment_3_0(), "rule__Signature__ElementsAssignment_3_0");
					put(grammarAccess.getSignatureAccess().getElementsAssignment_3_1_1(), "rule__Signature__ElementsAssignment_3_1_1");
					put(grammarAccess.getRequiredMappingAccess().getMappingAssignment_0(), "rule__RequiredMapping__MappingAssignment_0");
					put(grammarAccess.getRequiredMappingAccess().getNameAssignment_1_1(), "rule__RequiredMapping__NameAssignment_1_1");
					...
					put(grammarAccess.getXbaseSignatureConstraintExpressionAccess().getCheckBlockAssignment_3(), "rule__XbaseSignatureConstraintExpression__CheckBlockAssignment_3");
					put(grammarAccess.getXbaseSignatureConstraintExpressionAccess().getEnforceBlockAssignment_5(), "rule__XbaseSignatureConstraintExpression__EnforceBlockAssignment_5");
					put(grammarAccess.getXbaseBodyConstraintExpressionAccess().getMetamodelAssignment_3(), "rule__XbaseBodyConstraintExpression__MetamodelAssignment_3");
					put(grammarAccess.getXbaseBodyConstraintExpressionAccess().getBlockAssignment_5(), "rule__XbaseBodyConstraintExpression__BlockAssignment_5");
					...
					put(grammarAccess.getContextVariableAccess().getRequiredMappingPathAssignment_0_0(), "rule__ContextVariable__RequiredMappingPathAssignment_0_0");
					put(grammarAccess.getContextVariableAccess().getTargetClassAssignment_1(), "rule__ContextVariable__TargetClassAssignment_1");
					put(grammarAccess.getRequiredMappingPathBaseAccess().getRequiredMappingAssignment_0(), "rule__RequiredMappingPathBase__RequiredMappingAssignment_0");
					put(grammarAccess.getRequiredMappingPathBaseAccess().getTailAssignment_1(), "rule__RequiredMappingPathBase__TailAssignment_1");
					put(grammarAccess.getRequiredMappingPathTailAccess().getRequiredMappingAssignment_1(), "rule__RequiredMappingPathTail__RequiredMappingAssignment_1");
					put(grammarAccess.getRequiredMappingPathTailAccess().getTailAssignment_2(), "rule__RequiredMappingPathTail__TailAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalMappingLanguageParser typedParser = (InternalMappingLanguageParser) parser;
			typedParser.entryRuleMappingFile();
