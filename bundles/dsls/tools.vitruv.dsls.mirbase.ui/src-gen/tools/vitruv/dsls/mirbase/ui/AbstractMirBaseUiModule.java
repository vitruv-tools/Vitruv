...
import tools.vitruv.dsls.mirbase.ide.contentassist.antlr.MirBaseParser;
import tools.vitruv.dsls.mirbase.ide.contentassist.antlr.PartialMirBaseContentAssistParser;
import tools.vitruv.dsls.mirbase.ide.contentassist.antlr.internal.InternalMirBaseLexer;
import tools.vitruv.dsls.mirbase.ui.contentassist.MirBaseProposalProvider;
import tools.vitruv.dsls.mirbase.ui.labeling.MirBaseDescriptionLabelProvider;
import tools.vitruv.dsls.mirbase.ui.labeling.MirBaseLabelProvider;
import tools.vitruv.dsls.mirbase.ui.outline.MirBaseOutlineTreeProvider;
...
public abstract class AbstractMirBaseUiModule extends DefaultXbaseUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(tools.vitruv.dsls.mirbase.parser.antlr.internal.InternalMirBaseLexer.class);
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("MirBase Compare");
	}
