...
public abstract class AbstractMappingLanguageSemanticSequencer extends MirBaseSemanticSequencer {
	...
	protected void sequence_FeatureOfContextVariable(ISerializationContext context, FeatureOfContextVariable semanticObject) {
		...
		feeder.accept(grammarAccess.getFeatureOfContextVariableAccess().getFeatureEStructuralFeatureValidIDParserRuleCall_1_1_0_1(), semanticObject.eGet(MappingLanguagePackage.Literals.FEATURE_OF_CONTEXT_VARIABLE__FEATURE, false));
		feeder.finish();
	}
