...
public abstract class AbstractReactionsLanguageSemanticSequencer extends MirBaseSemanticSequencer {
	...
	protected void sequence_InvariantViolationEvent(ISerializationContext context, InvariantViolationEvent semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInvariantViolationEventAccess().getViolationEClassQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(ReactionsLanguagePackage.Literals.INVARIANT_VIOLATION_EVENT__VIOLATION, false));
		feeder.finish();
	}
	...
	protected void sequence_ModelAttributeChange(ISerializationContext context, ModelAttributeInsertedChange semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getModelAttributeChangeAccess().getFeatureMetaclassEAttributeReferenceParserRuleCall_2_0(), semanticObject.getFeature());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (feature=MetaclassEAttributeReference precondition=PreconditionCodeBlock?)
	 */
