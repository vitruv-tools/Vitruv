...
entryRuleMappingsFile returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMappingsFileRule()); }
	iv_ruleMappingsFile=ruleMappingsFile
	{ $current=$iv_ruleMappingsFile.current; }
	EOF;

// Rule MappingsFile
ruleMappingsFile returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMappingsSegment returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMappingsSegmentRule()); }
	iv_ruleMappingsSegment=ruleMappingsSegment
	{ $current=$iv_ruleMappingsSegment.current; }
	EOF;

// Rule MappingsSegment
ruleMappingsSegment returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_Documentable_0.current;
			afterParserOrEnumRuleCall();
		}
		otherlv_1='mappings:'
		{
...
entryRuleSingleSidedCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSingleSidedConditionRule()); }
	iv_ruleSingleSidedCondition=ruleSingleSidedCondition
	{ $current=$iv_ruleSingleSidedCondition.current; }
	EOF;

// Rule SingleSidedCondition
ruleSingleSidedCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_EnforceableCondition_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_CheckAndEnforceCondition_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleEnforceableCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnforceableConditionRule()); }
	iv_ruleEnforceableCondition=ruleEnforceableCondition
	{ $current=$iv_ruleEnforceableCondition.current; }
	EOF;

// Rule EnforceableCondition
ruleEnforceableCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_FeatureCondition_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ResourceCondition_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		(
			...
			{
				$current = $this_SingleValueCondition_0.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_MultiValueCondition_1.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_ElementCondition_2.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_NotEmptyCondition_3.current;
				afterParserOrEnumRuleCall();
			}
		)
		(
...
entryRuleDependentFeatureReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleDependentFeatureReference.current; }
	EOF;

// Rule DependentFeatureReference
ruleDependentFeatureReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSingleValueCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSingleValueConditionRule()); }
	iv_ruleSingleValueCondition=ruleSingleValueCondition
	{ $current=$iv_ruleSingleValueCondition.current; }
	EOF;

// Rule SingleValueCondition
ruleSingleValueCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_IndexCondition_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_NumCompareCondition_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleIndexCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIndexConditionRule()); }
	iv_ruleIndexCondition=ruleIndexCondition
	{ $current=$iv_ruleIndexCondition.current; }
	EOF;

// Rule IndexCondition
ruleIndexCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleNumCompareCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getNumCompareConditionRule()); }
	iv_ruleNumCompareCondition=ruleNumCompareCondition
	{ $current=$iv_ruleNumCompareCondition.current; }
	EOF;

// Rule NumCompareCondition
ruleNumCompareCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMultiValueCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMultiValueConditionRule()); }
	iv_ruleMultiValueCondition=ruleMultiValueCondition
	{ $current=$iv_ruleMultiValueCondition.current; }
	EOF;

// Rule MultiValueCondition
ruleMultiValueCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleElementCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getElementConditionRule()); }
	iv_ruleElementCondition=ruleElementCondition
	{ $current=$iv_ruleElementCondition.current; }
	EOF;

// Rule ElementCondition
ruleElementCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		otherlv_1='default contained in'
		{
...
entryRuleElementExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getElementExpressionRule()); }
	iv_ruleElementExpression=ruleElementExpression
	{ $current=$iv_ruleElementExpression.current; }
	EOF;

// Rule ElementExpression
ruleElementExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleNotEmptyCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getNotEmptyConditionRule()); }
	iv_ruleNotEmptyCondition=ruleNotEmptyCondition
	{ $current=$iv_ruleNotEmptyCondition.current; }
	EOF;

// Rule NotEmptyCondition
ruleNotEmptyCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleResourceCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getResourceConditionRule()); }
	iv_ruleResourceCondition=ruleResourceCondition
	{ $current=$iv_ruleResourceCondition.current; }
	EOF;

// Rule ResourceCondition
ruleResourceCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCheckAndEnforceCondition returns [EObject current=null]:
	...
	{ $current=$iv_ruleCheckAndEnforceCondition.current; }
	EOF;

// Rule CheckAndEnforceCondition
ruleCheckAndEnforceCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBidirectionalizableCondition returns [EObject current=null]:
	...
	{ $current=$iv_ruleBidirectionalizableCondition.current; }
	EOF;

// Rule BidirectionalizableCondition
ruleBidirectionalizableCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBidirectionalizableExpression returns [EObject current=null]:
	...
	{ $current=$iv_ruleBidirectionalizableExpression.current; }
	EOF;

// Rule BidirectionalizableExpression
ruleBidirectionalizableExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleUnidirectionalExpression returns [EObject current=null]:
	...
	{ $current=$iv_ruleUnidirectionalExpression.current; }
	EOF;

// Rule UnidirectionalExpression
ruleUnidirectionalExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule Documentable
ruleDocumentable[EObject in_current]  returns [EObject current=in_current]
@init {
	enterRule();
}
@after {
...
ruleNumCompareOperator returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
...
ruleMultiValueConditionOperator returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
