 ...
 * </p>
 * <ul>
 *   <li>{@link allElementTypes.impl.IdentifiedImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiedImpl extends MinimalEObjectImpl.Container implements Identified {
	...
	protected EClass eStaticClass() {
		return AllElementTypesPackage.Literals.IDENTIFIED;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AllElementTypesPackage.IDENTIFIED__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AllElementTypesPackage.IDENTIFIED__ID:
				return getId();
		}
