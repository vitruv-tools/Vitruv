...
public class UuidPackageImpl extends EPackageImpl implements UuidPackage {
	 ...
	 * @see tools.vitruv.framework.uuid.UuidPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getEObjectToUuidMapEntry_Key() {
		return (EReference)eObjectToUuidMapEntryEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getEObjectToUuidMapEntry_Value() {
		return (EAttribute)eObjectToUuidMapEntryEClass.getEStructuralFeatures().get(1);
	}
