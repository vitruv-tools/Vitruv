 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see tools.vitruv.framework.uuid.UuidFactory
 * @model kind="package"
 * @generated
 */
public interface UuidPackage extends EPackage {
	 ...
	 * @generated
	 */
	UuidPackage eINSTANCE = tools.vitruv.framework.uuid.impl.UuidPackageImpl.init();

	/**
	 * The meta object id for the '{@link tools.vitruv.framework.uuid.impl.UuidToEObjectRepositoryImpl <em>To EObject Repository</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.framework.uuid.impl.UuidToEObjectRepositoryImpl
	 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getUuidToEObjectRepository()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link tools.vitruv.framework.uuid.impl.UuidToEObjectMapEntryImpl <em>To EObject Map Entry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.framework.uuid.impl.UuidToEObjectMapEntryImpl
	 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getUuidToEObjectMapEntry()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link tools.vitruv.framework.uuid.impl.EObjectToUuidMapEntryImpl <em>EObject To Uuid Map Entry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.framework.uuid.impl.EObjectToUuidMapEntryImpl
	 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getEObjectToUuidMapEntry()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int EOBJECT_TO_UUID_MAP_ENTRY__KEY = 0;
	 ...
	 * @ordered
	 */
	int EOBJECT_TO_UUID_MAP_ENTRY__VALUE = 1;
	 ...
	 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getUuid()
	 * @generated
	 */
	int UUID = 3;
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.framework.uuid.UuidToEObjectRepository <em>To EObject Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>To EObject Repository</em>'.
	 * @see tools.vitruv.framework.uuid.UuidToEObjectRepository
	 * @generated
	 */
	EClass getUuidToEObjectRepository();

	/**
	 * Returns the meta object for the map '{@link tools.vitruv.framework.uuid.UuidToEObjectRepository#getUuidToEObject <em>Uuid To EObject</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>Uuid To EObject</em>'.
	 * @see tools.vitruv.framework.uuid.UuidToEObjectRepository#getUuidToEObject()
	...
	/**
	 * Returns the meta object for the map '{@link tools.vitruv.framework.uuid.UuidToEObjectRepository#getEObjectToUuid <em>EObject To Uuid</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>EObject To Uuid</em>'.
	 * @see tools.vitruv.framework.uuid.UuidToEObjectRepository#getEObjectToUuid()
	 * @see #getUuidToEObjectRepository()
	 * @generated
	 */
	 ...
	 * @model keyDataType="tools.vitruv.framework.uuid.Uuid"
	 ...
	 *        valueDataType="tools.vitruv.framework.uuid.Uuid"
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link tools.vitruv.framework.uuid.impl.UuidToEObjectRepositoryImpl <em>To EObject Repository</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.framework.uuid.impl.UuidToEObjectRepositoryImpl
		 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getUuidToEObjectRepository()
		...
		/**
		 * The meta object literal for the '{@link tools.vitruv.framework.uuid.impl.UuidToEObjectMapEntryImpl <em>To EObject Map Entry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.framework.uuid.impl.UuidToEObjectMapEntryImpl
		 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getUuidToEObjectMapEntry()
		...
		/**
		 * The meta object literal for the '{@link tools.vitruv.framework.uuid.impl.EObjectToUuidMapEntryImpl <em>EObject To Uuid Map Entry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.framework.uuid.impl.EObjectToUuidMapEntryImpl
		 * @see tools.vitruv.framework.uuid.impl.UuidPackageImpl#getEObjectToUuidMapEntry()
