...
abstract class VitruviusApplicationTest extends VitruviusUnmonitoredApplicationTest implements ChangeObservable {
	...
	override final void registerObserver(ChangeObserver observer) {
		observers.add(observer)
	}

	override final void unRegisterObserver(ChangeObserver observer) {
		observers.remove(observer)
	}

	override final void notifyObservers(VURI vuri, TransactionalChange change) {
