...
interface StateBasedChangeResolutionStrategy {
	 ...
	 * @param idResolver is the ID resolver of the virtual model using this propagation strategy, must not be <code>null</code>.
	 * @return a {@link VitruviusChange} that contains the individual change sequence.
	 */
	def VitruviusChange getChangeSequenceBetween(Resource newState, Resource oldState, IdResolver resolver)
	 ...
	 * @return a {@link VitruviusChange} that contains the individual change sequence.
	 */
	def VitruviusChange getChangeSequenceForCreated(Resource newState, IdResolver resolver)
	 ...
	 * @return a {@link VitruviusChange} that contains the individual change sequence.
	 */
	def VitruviusChange getChangeSequenceForDeleted(Resource oldState, IdResolver resolver)
}
