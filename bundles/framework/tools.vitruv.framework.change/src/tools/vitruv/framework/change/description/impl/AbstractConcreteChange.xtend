...
abstract class AbstractConcreteChange implements ConcreteChange {
	...
	private def dispatch boolean isChangedEObjectEqual(ConcreteChange change) {
		return EcoreUtil.equals(EChange.involvedEObjects, change.EChange.involvedEObjects)
	}
