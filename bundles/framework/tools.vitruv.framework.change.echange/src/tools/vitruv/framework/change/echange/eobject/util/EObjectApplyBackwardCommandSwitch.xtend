...
class EObjectApplyBackwardCommandSwitch extends EobjectSwitch<List<Command>> {
	 ...
	 */
	override public <A extends EObject> List<Command> caseCreateEObject(CreateEObject<A> object) {
	 ...
	 * @param object The change which commands should be created.
	 */
	override public <A extends EObject> List<Command> caseDeleteEObject(DeleteEObject<A> object) {
		val editingDomain = EChangeUtil.getEditingDomain(object.affectedEObject)
