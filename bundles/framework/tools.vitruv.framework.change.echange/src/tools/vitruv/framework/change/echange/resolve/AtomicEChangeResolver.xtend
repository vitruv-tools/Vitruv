...
class AtomicEChangeResolver {
	 ...
	 * 						{@code false} if the model is in state after.
	 */
	private def static <A extends EObject, F extends EStructuralFeature> boolean resolveFeatureEChange(
	 ...
	 */
	private def static <A extends EObject, T extends EObject> EObject resolveReferenceValue(
	 ...
	 * 							{@code false} if the model is in state after.
	 */
	private def static <A extends EObject> boolean resolveEObjectExistenceEChange(
	 ...
	 * 							{@code false} if the model is in state after.
	 */
	private def static boolean resolveRootEChange(RootEChange change, ResourceSet resourceSet, boolean resolveBefore) {
	 ...
	 */
	private def static <T extends EObject> resolveRootValue(
		RootEChange change,
		T value,
		ResourceSet resourceSet,
		boolean isInserted
