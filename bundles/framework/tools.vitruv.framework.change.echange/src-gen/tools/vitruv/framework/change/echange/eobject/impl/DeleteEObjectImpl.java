...
public class DeleteEObjectImpl<A extends EObject> extends EObjectExistenceEChangeImpl<A> implements DeleteEObject<A> {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == EChange.class) {
			switch (baseOperationID) {
				case EChangePackage.ECHANGE___RESOLVE_APPLY__RESOURCESET: return EobjectPackage.DELETE_EOBJECT___RESOLVE_APPLY__RESOURCESET;
				case EChangePackage.ECHANGE___RESOLVE_REVERT__RESOURCESET: return EobjectPackage.DELETE_EOBJECT___RESOLVE_REVERT__RESOURCESET;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EobjectPackage.DELETE_EOBJECT___RESOLVE_APPLY__RESOURCESET:
				return resolveApply((ResourceSet)arguments.get(0));
			case EobjectPackage.DELETE_EOBJECT___RESOLVE_REVERT__RESOURCESET:
