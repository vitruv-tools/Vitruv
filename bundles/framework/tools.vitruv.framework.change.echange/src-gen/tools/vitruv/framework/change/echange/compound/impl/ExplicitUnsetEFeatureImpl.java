 ...
 *   <li>{@link tools.vitruv.framework.change.echange.compound.impl.ExplicitUnsetEFeatureImpl#getAffectedEObjectID <em>Affected EObject ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExplicitUnsetEFeatureImpl<A extends EObject, F extends EStructuralFeature> extends CompoundEChangeImpl implements ExplicitUnsetEFeature<A, F> {
	...
	public void setAffectedEObjectID(String newAffectedEObjectID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompoundPackage.EXPLICIT_UNSET_EFEATURE__AFFECTED_EOBJECT_ID, oldAffectedEObjectID, affectedEObjectID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CompoundPackage.EXPLICIT_UNSET_EFEATURE__AFFECTED_EOBJECT_ID:
