...
class CommitPackageImpl extends EPackageImpl implements CommitPackage {
	 ...
	 * @generated
	 */
	override EClass getChangeMatch() {
		return changeMatchEClass
	}
	...
	def void createPackageContents() {
		...
		changeMatchEClass = createEClass(CHANGE_MATCH)
	}
	...
	def void initializePackageContents() {
		...
		initEClass(mergeCommitEClass, typeof(MergeCommit), "MergeCommit", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS)
		initEReference(getMergeCommit_CommitsMergedToThis(), this.getCommit(), this.getCommit_CommitsMergedFromThis(),
			"commitsMergedToThis", null, 2, 2, typeof(MergeCommit), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEClass(simpleCommitEClass, typeof(SimpleCommit), "SimpleCommit", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS)
		initEReference(getSimpleCommit_Parent(), this.getCommit(), this.getCommit_CommitsBranchedFromThis(), "parent",
			null, 1, 1, typeof(SimpleCommit), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEClass(commitEClass, typeof(Commit), "Commit", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS)
		initEAttribute(getCommit_Checksum(), ecorePackage.getELong(), "checksum", "1000", 1, 1, typeof(Commit),
			!IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED)
		initEReference(getCommit_Changes(), this.getChangeMatch(), null, "changes", null, 1, -1, typeof(Commit),
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED)
		initEReference(getCommit_Commitmessage(), this.getCommitMessage(), null, "commitmessage", null, 1, 1,
			typeof(Commit), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEReference(getCommit_CommitsBranchedFromThis(), this.getSimpleCommit(), this.getSimpleCommit_Parent(),
			"commitsBranchedFromThis", null, 0, -1, typeof(Commit), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEReference(getCommit_CommitsMergedFromThis(), this.getMergeCommit(),
			this.getMergeCommit_CommitsMergedToThis(), "commitsMergedFromThis", null, 0, -1, typeof(Commit),
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED)
		initEAttribute(getCommit_Identifier(), ecorePackage.getEInt(), "identifier", "2000", 1, 1, typeof(Commit),
			!IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEClass(commitMessageEClass, typeof(CommitMessage), "CommitMessage", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS)
		initEAttribute(getCommitMessage_Date(), ecorePackage.getEDate(), "date", null, 1, 1, typeof(CommitMessage),
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEAttribute(getCommitMessage_Message(), ecorePackage.getEString(), "message", null, 1, 1,
			typeof(CommitMessage), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED)
		initEReference(getCommitMessage_Author(), theAuthorPackage.getAuthor(), null, "author", null, 1, 1,
			typeof(CommitMessage), !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEClass(initialCommitEClass, typeof(InitialCommit), "InitialCommit", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS)
		initEClass(changeMatchEClass, typeof(ChangeMatch), "ChangeMatch", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS)
	} // CommitPackageImpl
}
