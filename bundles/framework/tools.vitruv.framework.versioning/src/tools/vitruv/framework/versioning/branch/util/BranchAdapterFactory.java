...
public class BranchAdapterFactory extends AdapterFactoryImpl {
	...
	protected BranchSwitch<Adapter> modelSwitch =
		new BranchSwitch<Adapter>() {
			@Override
			public Adapter caseBranchDiffCreator(BranchDiffCreator object) {
				return createBranchDiffCreatorAdapter();
			}
			@Override
			public Adapter caseBranchDiff(BranchDiff object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.framework.versioning.branch.BranchDiffCreator <em>Diff Creator</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBranchDiffCreatorAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.framework.versioning.branch.BranchDiff <em>Diff</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.framework.versioning.branch.Branch <em>Branch</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
