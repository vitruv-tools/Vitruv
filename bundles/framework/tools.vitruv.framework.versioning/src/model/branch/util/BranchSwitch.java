 ...
 * @generated
 */
public class BranchSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BranchPackage.BRANCH_DIFF_CREATOR: {
				BranchDiffCreator branchDiffCreator = (BranchDiffCreator)theEObject;
				T result = caseBranchDiffCreator(branchDiffCreator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BranchPackage.BRANCH_DIFF: {
				BranchDiff branchDiff = (BranchDiff)theEObject;
				T result = caseBranchDiff(branchDiff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseBranchDiffCreator(BranchDiffCreator object) {
		return null;
	}
