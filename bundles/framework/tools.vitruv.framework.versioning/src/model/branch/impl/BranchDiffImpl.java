 ...
 * </p>
 * <ul>
 *   <li>{@link model.branch.impl.BranchDiffImpl#getSourceCommits <em>Source Commits</em>}</li>
 *   <li>{@link model.branch.impl.BranchDiffImpl#getTargetCommits <em>Target Commits</em>}</li>
 *   <li>{@link model.branch.impl.BranchDiffImpl#getSource <em>Source</em>}</li>
 *   <li>{@link model.branch.impl.BranchDiffImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link model.branch.impl.BranchDiffImpl#getLastCommonAncestor <em>Last Common Ancestor</em>}</li>
 * </ul>
 *
 * @generated
 */
