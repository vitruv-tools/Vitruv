 ...
 * </p>
 * <ul>
 *   <li>{@link model.commit.MergeCommit#getCommitsMergedToThis <em>Commits Merged To This</em>}</li>
 * </ul>
 *
 * @see model.commit.CommitPackage#getMergeCommit()
 * @model
 * @generated
 */
public interface MergeCommit extends Commit {
	 ...
	 * It is bidirectional and its opposite is '{@link model.commit.Commit#getCommitsMergedFromThis <em>Commits Merged From This</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see model.commit.CommitPackage#getMergeCommit_CommitsMergedToThis()
	 * @see model.commit.Commit#getCommitsMergedFromThis
	 * @model opposite="commitsMergedFromThis" lower="2" upper="2"
	 * @generated
	 */
	EList<Commit> getCommitsMergedToThis();
