 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.SignatureImpl#getSigner <em>Signer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignatureImpl extends MinimalEObjectImpl.Container implements Signature {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SIGNATURE;
	}
		...
		if (signer != null && signer.eIsProxy()) {
			...
			if (signer != oldSigner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SIGNATURE__SIGNER, oldSigner, signer));
			}
		}
		return signer;
	}
	...
	public void setSigner(Author newSigner) {
		...
		signer = newSigner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SIGNATURE__SIGNER, oldSigner, signer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SIGNATURE__SIGNER:
