 ...
 * @generated
 */
class VersioningPackageImpl extends EPackageImpl implements VersioningPackage {
	/** 
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	EClass namedEClass = null
	/** 
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	def static VersioningPackage init() {
		if (isInited) return (EPackage.Registry.INSTANCE.getEPackage(VersioningPackage.eNS_URI) as VersioningPackage)
		// Obtain or create and register package
		var VersioningPackageImpl theVersioningPackage = ((if (EPackage.Registry.INSTANCE.get(
			eNS_URI) instanceof VersioningPackageImpl) EPackage.Registry.INSTANCE.get(
			eNS_URI) else new VersioningPackageImpl() ) as VersioningPackageImpl)
		isInited = true
	 ...
	 * @generated
	 */
	override EAttribute getNamed_Name() {
		return (namedEClass.getEStructuralFeatures().get(0) as EAttribute)
	}
	 ...
	 * @generated
	 */
	override EReference getRoot_Repositories() {
		return (rootEClass.getEStructuralFeatures().get(0) as EReference)
	}
	 ...
	 * @generated
	 */
	override EReference getRoot_Authors() {
		return (rootEClass.getEStructuralFeatures().get(1) as EReference)
	}
	 ...
	 * @generated
	 */
	override EOperation getRoot__CreateAuthor__String_String() {
	 ...
	 * @generated
	 */
	override EOperation getRoot__CreateRepository() {
	 ...
	 * @generated
	 */
	override VersioningFactory getVersioningFactory() {
		return (getEFactoryInstance() as VersioningFactory)
	}
	...
	def void initializePackageContents() {
		...
		var ConflictPackage theConflictPackage = (EPackage.Registry.INSTANCE.getEPackage(
			ConflictPackage.eNS_URI) as ConflictPackage)
		...
		initEClass(namedEClass, Named, "Named", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS)
		initEAttribute(getNamed_Name(), ecorePackage.getEString(), "name", null, 1, 1, Named, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEClass(rootEClass, Root, "Root", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS)
		initEReference(getRoot_Repositories(), theRepositoryPackage.getRepository(), null, "repositories", null, 0, -1,
			Root, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
			IS_UNIQUE, !IS_DERIVED, IS_ORDERED)
		initEReference(getRoot_Authors(), theAuthorPackage.getAuthor(), null, "authors", null, 0, -1, Root,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED)
		var EOperation op = initEOperation(getRoot__CreateAuthor__String_String(), theAuthorPackage.getAuthor(),
			"createAuthor", 1, 1, IS_UNIQUE, IS_ORDERED)
		addEParameter(op, ecorePackage.getEString(), "name", 1, 1, IS_UNIQUE, IS_ORDERED)
		addEParameter(op, ecorePackage.getEString(), "email", 1, 1, IS_UNIQUE, IS_ORDERED)
		initEOperation(getRoot__CreateRepository(), theRepositoryPackage.getRepository(), "createRepository", 1, 1,
