...
public interface UserInteractor {
	...
	/**
	 * @return a {@link NotificationInteractionBuilder} used to configure, build and show notification dialogs to inform the
	 * user about something.
	 */
	NotificationInteractionBuilder getNotificationDialogBuilder();
	
	/**
	 * @return a {@link ConfirmationInteractionBuilder} used to configure, build and show confirmation dialogs to prompt the
	 * user to answer a question in the positive or negative.
	 */
	ConfirmationInteractionBuilder getConfirmationDialogBuilder();
	
	/**
	 * @return a {@link TextInputInteractionBuilder} used to configure, build and show text input dialogs to prompt the user to
	...
	/**
	 * @return a {@link MultipleChoiceMultiSelectionInteractionBuilder} used to configure, build and show multiple choice input
