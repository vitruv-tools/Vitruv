...
class CreatedMaleReaction extends AbstractReactionRealization {
  public CreatedMaleReaction(final UserInteracting userInteracting) {
    super(userInteracting);
  }
  
  public void executeReaction(final EChange change) {
    InsertRootEObject<Male> typedChange = ((CreateAndInsertRoot<Male>)change).getInsertChange();
  ...
  private boolean checkChangeProperties(final EChange change) {
    InsertRootEObject<Male> relevantChange = ((CreateAndInsertRoot<Male>)change).getInsertChange();
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Male newValue, @Extension final RoutinesFacade _routinesFacade) {
