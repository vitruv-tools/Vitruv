package tools.vitruvius.applications.jmljava.tests.unittests.synchronizers;
...
import tools.vitruvius.applications.jmljava.tests.unittests.utils.CorrespondingProvidingMock;
import tools.vitruvius.applications.jmljava.tests.unittests.utils.Initializer;
import tools.vitruvius.applications.jmljava.tests.unittests.utils.ModelLoader;
import tools.vitruvius.applications.jmljava.tests.unittests.utils.ModelLoader.IResourceFiles;
import tools.vitruvius.applications.jmljava.tests.unittests.utils.ModelProvidingMock;
...
public abstract class TransformationTestsBase {
    ...
    private static CorrespondenceModelProxy createCorrespondenceModelProxy(final ModelProviding modelProviding,
        ...
        final tools.vitruvius.domains.jml.language.jML.CompilationUnit jmlCu = modelInstances.getSecond()
                .getUniqueRootEObjectIfCorrectlyTyped(
                        tools.vitruvius.domains.jml.language.jML.CompilationUnit.class);
