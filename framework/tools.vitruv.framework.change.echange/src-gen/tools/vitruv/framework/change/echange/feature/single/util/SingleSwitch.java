 ...
 * @generated
 */
public class SingleSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SinglePackage.REPLACE_SINGLE_VALUED_FEATURE_ECHANGE: {
				ReplaceSingleValuedFeatureEChange<?, ?, ?> replaceSingleValuedFeatureEChange = (ReplaceSingleValuedFeatureEChange<?, ?, ?>)theEObject;
				T1 result = caseReplaceSingleValuedFeatureEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseUpdateSingleValuedFeatureEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseAdditiveEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseSubtractiveEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseFeatureEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseAtomicEChange(replaceSingleValuedFeatureEChange);
				if (result == null) result = caseEChange(replaceSingleValuedFeatureEChange);
