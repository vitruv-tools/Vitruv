...
import tools.vitruvius.dsls.mirbase.ide.contentassist.antlr.MirBaseParser;
import tools.vitruvius.dsls.mirbase.ide.contentassist.antlr.PartialMirBaseContentAssistParser;
import tools.vitruvius.dsls.mirbase.ide.contentassist.antlr.internal.InternalMirBaseLexer;
import tools.vitruvius.dsls.mirbase.ui.contentassist.MirBaseProposalProvider;
import tools.vitruvius.dsls.mirbase.ui.labeling.MirBaseDescriptionLabelProvider;
import tools.vitruvius.dsls.mirbase.ui.labeling.MirBaseLabelProvider;
import tools.vitruvius.dsls.mirbase.ui.outline.MirBaseOutlineTreeProvider;
...
/**
 * Manual modifications go to {@link MirBaseUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMirBaseUiModule extends DefaultXbaseUiModule {

	public AbstractMirBaseUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(tools.vitruvius.dsls.mirbase.parser.antlr.internal.InternalMirBaseLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMirBaseLexer.class).toProvider(LexerProvider.create(InternalMirBaseLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return MirBaseLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MirBaseDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return MirBaseOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return MirBaseQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MirBaseProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMirBaseContentAssistParser.class;
	}
