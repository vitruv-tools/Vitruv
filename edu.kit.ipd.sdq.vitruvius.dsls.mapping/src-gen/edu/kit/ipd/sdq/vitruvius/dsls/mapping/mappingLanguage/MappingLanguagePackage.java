...
public interface MappingLanguagePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.MappingFile#getDefaultRequirements <em>Default Requirements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Default Requirements</em>'.
   * @see edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.MappingFile#getDefaultRequirements()
   * @see #getMappingFile()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.Mapping#getChildMappings <em>Child Mappings</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Child Mappings</em>'.
   * @see edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.Mapping#getChildMappings()
   * @see #getMapping()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the container reference '{@link edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.Mapping#getParentMapping <em>Parent Mapping</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the container reference '<em>Parent Mapping</em>'.
   * @see edu.kit.ipd.sdq.vitruvius.dsls.mapping.mappingLanguage.Mapping#getParentMapping()
   * @see #getMapping()
   * @generated
   */
