...
public class SignatureImpl extends MinimalEObjectImpl.Container implements Signature
{
   ...
   * @ordered
   */
  protected EList<NamedEClass> elements;
   ...
   * @generated
   */
  public EList<NamedEClass> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<NamedEClass>(NamedEClass.class, this, MappingLanguagePackage.SIGNATURE__ELEMENTS);
    }
    return elements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MappingLanguagePackage.SIGNATURE__ELEMENTS:
        getElements().clear();
        getElements().addAll((Collection<? extends NamedEClass>)newValue);
        return;
    }
