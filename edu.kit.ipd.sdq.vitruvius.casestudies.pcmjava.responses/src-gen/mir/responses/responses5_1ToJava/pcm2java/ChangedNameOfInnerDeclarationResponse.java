...
class ChangedNameOfInnerDeclarationResponse extends AbstractResponseRealization {
  public ChangedNameOfInnerDeclarationResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2java.ChangedNameOfInnerDeclarationEffect effect = new mir.routines.pcm2java.ChangedNameOfInnerDeclarationEffect(this.executionState, this);
