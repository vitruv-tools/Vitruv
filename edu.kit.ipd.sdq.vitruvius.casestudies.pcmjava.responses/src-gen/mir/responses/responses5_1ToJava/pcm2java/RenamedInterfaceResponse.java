...
class RenamedInterfaceResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2java.RenamedInterfaceEffect effect = new mir.routines.pcm2java.RenamedInterfaceEffect(this.executionState, this);
  ...
  private boolean checkChangedObject(final EChange change) {
    ...
    return changedElement instanceof Interface;
  }
}
