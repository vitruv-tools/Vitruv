...
class AddedInnerDeclarationToCompositeDataTypeResponse extends AbstractResponseRealization {
  public AddedInnerDeclarationToCompositeDataTypeResponse(final UserInteracting userInteracting) {
  ...
  private boolean checkChangedObject(final EChange change) {
    ...
    if (!typedChange.getAffectedFeature().getName().equals("innerDeclaration_CompositeDataType")) {
    	return false;
    }
    return changedElement instanceof CompositeDataType;
  }
}
