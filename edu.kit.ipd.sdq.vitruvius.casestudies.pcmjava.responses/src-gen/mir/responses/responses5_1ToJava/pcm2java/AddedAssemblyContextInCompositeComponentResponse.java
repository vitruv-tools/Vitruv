...
class AddedAssemblyContextInCompositeComponentResponse extends AbstractResponseRealization {
  public AddedAssemblyContextInCompositeComponentResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.effects.pcm2java.AddedAssemblyContextInCompositeComponentEffect effect = new mir.effects.pcm2java.AddedAssemblyContextInCompositeComponentEffect(this.executionState, this);
  ...
  private boolean checkChangedObject(final EChange change) {
    ...
    return changedElement instanceof CompositeComponent;
  }
}
