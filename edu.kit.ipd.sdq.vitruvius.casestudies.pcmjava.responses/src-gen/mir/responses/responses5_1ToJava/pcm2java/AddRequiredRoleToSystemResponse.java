...
class AddRequiredRoleToSystemResponse extends AbstractResponseRealization {
  public AddRequiredRoleToSystemResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.effects.pcm2java.AddRequiredRoleToSystemEffect effect = new mir.effects.pcm2java.AddRequiredRoleToSystemEffect(this.executionState, this);
