...
class ChangedParameterNameResponse extends AbstractResponseRealization {
  public ChangedParameterNameResponse(final UserInteracting userInteracting) {
  ...
  private boolean checkChangedObject(final EChange change) {
    ...
    if (!typedChange.getAffectedFeature().getName().equals("parameterName")) {
    	return false;
    }
