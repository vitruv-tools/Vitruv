...
class ChangedProvidedInterfaceOfProvidedRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2java.ChangedProvidedInterfaceOfProvidedRoleEffect effect = new mir.routines.pcm2java.ChangedProvidedInterfaceOfProvidedRoleEffect(this.executionState, this);
  ...
  private boolean checkChangedObject(final EChange change) {
    ...
    if (!typedChange.getAffectedFeature().getName().equals("providedInterface__OperationProvidedRole")) {
    	return false;
    }
