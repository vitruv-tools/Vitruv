...
class RemovedProvidedRoleFromSystemResponse extends AbstractResponseRealization {
  public RemovedProvidedRoleFromSystemResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.effects.pcm2java.RemovedProvidedRoleFromSystemEffect effect = new mir.effects.pcm2java.RemovedProvidedRoleFromSystemEffect(this.executionState, this);
