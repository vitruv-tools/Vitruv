...
class RemovedCompositeDataTypeResponse extends AbstractResponseRealization {
  public RemovedCompositeDataTypeResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2java.RemovedCompositeDataTypeEffect effect = new mir.routines.pcm2java.RemovedCompositeDataTypeEffect(this.executionState, this);
