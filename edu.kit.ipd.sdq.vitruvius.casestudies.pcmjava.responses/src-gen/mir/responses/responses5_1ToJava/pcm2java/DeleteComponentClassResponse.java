...
class DeleteComponentClassResponse extends AbstractResponseRealization {
  public DeleteComponentClassResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2java.DeleteComponentClassEffect effect = new mir.routines.pcm2java.DeleteComponentClassEffect(this.executionState, this);
