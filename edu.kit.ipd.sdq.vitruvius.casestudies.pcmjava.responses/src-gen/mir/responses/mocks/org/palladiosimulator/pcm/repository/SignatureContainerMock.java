...
public class SignatureContainerMock implements Signature {
  public SignatureContainerMock(final Signature containedObject, final EObject containerObject) {
    super();
    this.containedObject = containedObject;
    this.containerObject = containerObject;
  }
  
  private Signature containedObject;
