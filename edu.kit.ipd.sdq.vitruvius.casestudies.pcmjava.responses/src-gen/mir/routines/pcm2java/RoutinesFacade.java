...
public class RoutinesFacade extends AbstractEffectsFacade {
  ...
  public void callChangeNameOfInnerDeclaration(final InnerDeclaration innerDeclaration) {
    mir.routines.pcm2java.ChangeNameOfInnerDeclarationEffect effect = new mir.routines.pcm2java.ChangeNameOfInnerDeclarationEffect(this.executionState, calledBy);
    effect.setInnerDeclaration(innerDeclaration);
    effect.applyEffect();
  }
