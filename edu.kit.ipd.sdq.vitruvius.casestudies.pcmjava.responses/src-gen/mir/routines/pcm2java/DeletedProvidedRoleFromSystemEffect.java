...
public class DeletedProvidedRoleFromSystemEffect extends AbstractEffectRealization {
  public DeletedProvidedRoleFromSystemEffect(final ResponseExecutionState responseExecutionState, final CallHierarchyHaving calledBy, final DeleteNonRootEObjectInList<ProvidedRole> change) {
