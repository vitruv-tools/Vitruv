...
public class RemovedCompositeDataTypeEffect extends AbstractEffectRealization {
  ...
  protected void executeEffect() throws IOException {
    getLogger().debug("Called routine RemovedCompositeDataTypeEffect with input:");
    ...
    preProcessElements();
    new mir.routines.pcm2java.RemovedCompositeDataTypeEffect.EffectUserExecution(getExecutionState(), this).executeUserOperations(
    	change);
    postProcessElements();
  }
