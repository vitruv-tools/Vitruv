...
public class DeletedCompositeDataTypeEffect extends AbstractEffectRealization {
  public DeletedCompositeDataTypeEffect(final ResponseExecutionState responseExecutionState, final CallHierarchyHaving calledBy, final DeleteNonRootEObjectInList<DataType> change) {
