...
public class RenamedRepositoryPackagesEffect extends AbstractEffectRealization {
  ...
  protected void executeEffect() throws IOException {
    getLogger().debug("Called routine RenamedRepositoryPackagesEffect with input:");
    ...
    preProcessElements();
    new mir.routines.pcm2java.RenamedRepositoryPackagesEffect.EffectUserExecution(getExecutionState(), this).executeUserOperations(
    	change, rootPackage);
    postProcessElements();
  }
