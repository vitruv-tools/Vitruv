...
public class AddedAssemblyContextInSystemEffect extends AbstractEffectRealization {
  public AddedAssemblyContextInSystemEffect(final ResponseExecutionState responseExecutionState, final CallHierarchyHaving calledBy) {
  ...
  protected void executeEffect() throws IOException {
    getLogger().debug("Called effect AddedAssemblyContextInSystemEffect with input:");
