...
package edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.monitor;
...
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.ISynchronizingMonitoredEmfEditor;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.IEditorPartAdapterFactory.IEditorPartAdapter;
...
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.monitor.VitruviusEMFEditorMonitorImpl;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.mocking.EclipseMock;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.mocking.EclipseMock.SaveEventKind;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.testmodels.Files;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.utils.BasicTestCase;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.utils.ChangeAssert;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.utils.DefaultImplementations;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.utils.EnsureExecuted;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.test.utils.DefaultImplementations.TestChangeSynchronizing;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.tools.EclipseAdapterProvider;
import edu.kit.ipd.sdq.vitruvius.domains.emf.monitorededitor.tools.IEclipseAdapter;
