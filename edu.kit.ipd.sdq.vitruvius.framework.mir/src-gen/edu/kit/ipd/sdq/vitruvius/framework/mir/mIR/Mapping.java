 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.Mapping#getWhens <em>Whens</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.Mapping#getWiths <em>Withs</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.Mapping#getWheres <em>Wheres</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Mapping extends EObject
{
   ...
   * The list contents are of type {@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.MappableElement}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @generated
   */
  EList<MappableElement> getMappedElements();
   ...
   * @see edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.MIRPackage#getMapping_Whens()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.MIRPackage#getMapping_Withs()
   * @model containment="true"
   * @generated
   */
   ...
   * @see edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.MIRPackage#getMapping_Wheres()
   * @model containment="true"
   * @generated
   */
