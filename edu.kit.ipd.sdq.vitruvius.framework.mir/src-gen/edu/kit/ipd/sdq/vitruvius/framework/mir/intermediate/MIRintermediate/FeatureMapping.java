 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.intermediate.MIRintermediate.FeatureMapping#getPredicates <em>Predicates</em>}</li>
 * </ul>
 * </p>
 *
...
public interface FeatureMapping extends EObject {
	 ...
	 * @see #setLeft(EStructuralFeature)
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.mir.intermediate.MIRintermediate.FeatureMapping#getLeft <em>Left</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setLeft(EStructuralFeature value);
	 ...
	 * @see #setRight(EStructuralFeature)
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.mir.intermediate.MIRintermediate.FeatureMapping#getRight <em>Right</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setRight(EStructuralFeature value);
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.mir.intermediate.MIRintermediate.MIRintermediatePackage#getFeatureMapping_Predicates()
	 * @model
	 * @generated
	 */
