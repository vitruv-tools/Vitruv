 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.impl.ClassMappingImpl#getMappedElements <em>Mapped Elements</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.impl.ClassMappingImpl#getWhens <em>Whens</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.impl.ClassMappingImpl#getWiths <em>Withs</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.mir.mIR.impl.ClassMappingImpl#getWheres <em>Wheres</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassMappingImpl extends MinimalEObjectImpl.Container implements ClassMapping
{
   ...
   * @ordered
   */
  protected EList<NamedEClass> mappedElements;
  ...
  {
    return MIRPackage.Literals.CLASS_MAPPING;
  }
   ...
   * @generated
   */
  public EList<NamedEClass> getMappedElements()
  {
    if (mappedElements == null)
    {
      mappedElements = new EObjectContainmentEList<NamedEClass>(NamedEClass.class, this, MIRPackage.CLASS_MAPPING__MAPPED_ELEMENTS);
    }
  ...
  public EList<EObject> getWhens()
  {
    if (whens == null)
    {
      whens = new EObjectContainmentEList<EObject>(EObject.class, this, MIRPackage.CLASS_MAPPING__WHENS);
    }
    return whens;
  }
  ...
  public EList<FeatureMapping> getWiths()
  {
    if (withs == null)
    {
      withs = new EObjectContainmentEList<FeatureMapping>(FeatureMapping.class, this, MIRPackage.CLASS_MAPPING__WITHS);
    }
    return withs;
  }
  ...
  public EList<EObject> getWheres()
  {
    if (wheres == null)
    {
      wheres = new EObjectContainmentEList<EObject>(EObject.class, this, MIRPackage.CLASS_MAPPING__WHERES);
    }
    return wheres;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MIRPackage.CLASS_MAPPING__MAPPED_ELEMENTS:
        ...
        getMappedElements().addAll((Collection<? extends NamedEClass>)newValue);
        return;
      case MIRPackage.CLASS_MAPPING__WHENS:
        getWhens().clear();
