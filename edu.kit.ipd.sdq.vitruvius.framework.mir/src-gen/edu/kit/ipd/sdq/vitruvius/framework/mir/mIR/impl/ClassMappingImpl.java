...
public class ClassMappingImpl extends MinimalEObjectImpl.Container implements ClassMapping
{
  ...
  public EList<TypedElement> getMappedElements()
  {
    ...
    {
      mappedElements = new EObjectContainmentEList<TypedElement>(TypedElement.class, this, MIRPackage.CLASS_MAPPING__MAPPED_ELEMENTS);
    }
  ...
  public EList<When> getWhens()
  {
    if (whens == null)
    {
      whens = new EObjectContainmentEList<When>(When.class, this, MIRPackage.CLASS_MAPPING__WHENS);
    }
    return whens;
  }
  ...
  public EList<Where> getWheres()
  {
    if (wheres == null)
    {
      wheres = new EObjectContainmentEList<Where>(Where.class, this, MIRPackage.CLASS_MAPPING__WHERES);
    }
    return wheres;
  }
