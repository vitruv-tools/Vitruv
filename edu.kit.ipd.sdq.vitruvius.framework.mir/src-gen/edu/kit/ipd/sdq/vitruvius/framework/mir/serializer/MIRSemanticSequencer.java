...
public class MIRSemanticSequencer extends XbaseSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == MIRPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case MIRPackage.FEATURE_CALL:
				if(context == grammarAccess.getFeatureCallRule() ||
				   context == grammarAccess.getFeatureCallAccess().getFeatureCallRefAction_1_0()) {
			...
			case MIRPackage.JAVA_BLOCK:
				if(context == grammarAccess.getExpressionBlockRule() ||
				   context == grammarAccess.getJavaBlockRule() ||
				   context == grammarAccess.getPredicateBlockRule()) {
					sequence_JavaBlock(context, (JavaBlock) semanticObject); 
					return; 
				}
				else break;
			...
			case MIRPackage.TYPED_ELEMENT_REF:
				if(context == grammarAccess.getFeatureCallRule() ||
				   context == grammarAccess.getFeatureCallAccess().getFeatureCallRefAction_1_0() ||
				   context == grammarAccess.getTypedElementRefRule()) {
	...
	/**
	 * Constraint:
	 *     (mappedElements+=NamedEClass mappedElements+=NamedEClass (whens+=When | wheres+=Where | withs+=FeatureMapping)*)
	 */
	...
	/**
	 * Constraint:
	 *     (mappedElements+=FeatureCall mappedElements+=FeatureCall (whens+=When | wheres+=Where | withs+=FeatureMapping)*)
	 */
	 ...
	 *     javaString=STRING
	 */
	protected void sequence_JavaBlock(EObject context, JavaBlock semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, MIRPackage.Literals.JAVA_BLOCK__JAVA_STRING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MIRPackage.Literals.JAVA_BLOCK__JAVA_STRING));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJavaBlockAccess().getJavaStringSTRINGTerminalRuleCall_0(), semanticObject.getJavaString());
		feeder.finish();
	}
	...
	protected void sequence_TypedElementRef(EObject context, TypedElementRef semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getTypedElementRefAccess().getRefTypedElementIDTerminalRuleCall_1_0_1(), semanticObject.getRef());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (predicate=PredicateBlock oppositeExpression=ExpressionBlock?)
	 */
	...
	/**
	 * Constraint:
	 *     (expression=ExpressionBlock oppositePredicate=PredicateBlock?)
	 */
