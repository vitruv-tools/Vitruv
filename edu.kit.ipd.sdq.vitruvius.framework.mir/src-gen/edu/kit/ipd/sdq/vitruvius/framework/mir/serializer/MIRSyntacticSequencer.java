...
public class MIRSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_MappingBody___LeftCurlyBracketKeyword_0_RightCurlyBracketKeyword_3__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_MappingBody___LeftCurlyBracketKeyword_0_RightCurlyBracketKeyword_3__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getMappingBodyAccess().getLeftCurlyBracketKeyword_0()), new TokenAlias(false, false, grammarAccess.getMappingBodyAccess().getRightCurlyBracketKeyword_3()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_MappingBody___LeftCurlyBracketKeyword_0_RightCurlyBracketKeyword_3__q.equals(syntax))
				emit_MappingBody___LeftCurlyBracketKeyword_0_RightCurlyBracketKeyword_3__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_MappingBody___LeftCurlyBracketKeyword_0_RightCurlyBracketKeyword_3__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
