/**
 */
package tools.vitruv.dsls.response.meta.correspondence.response;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see tools.vitruv.dsls.response.meta.correspondence.response.ResponseFactory
 * @model kind="package"
 * @generated
 */
public interface ResponsePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://tools.vitruv/Correspondence/Response/1.0";
	 ...
	 * @generated
	 */
	ResponsePackage eINSTANCE = tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponsePackageImpl.init();

	/**
	 * The meta object id for the '{@link tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponseCorrespondenceImpl <em>Correspondence</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponseCorrespondenceImpl
	 * @see tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponsePackageImpl#getResponseCorrespondence()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.dsls.response.meta.correspondence.response.ResponseCorrespondence <em>Correspondence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.dsls.response.meta.correspondence.response.ResponseCorrespondence#getTag <em>Tag</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Tag</em>'.
	 * @see tools.vitruv.dsls.response.meta.correspondence.response.ResponseCorrespondence#getTag()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponseCorrespondenceImpl <em>Correspondence</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponseCorrespondenceImpl
		 * @see tools.vitruv.dsls.response.meta.correspondence.response.impl.ResponsePackageImpl#getResponseCorrespondence()
