...
/** Tests for the IdentityMappingViewType class. */
...
public class IdentityMappingViewTypeTest {
  ...
  /** Tests for the createView method of the IdentityMappingViewType class. */
  @Nested
  ...
  public class CreateView {
    ...
    /**
     * This test validates that the view created by the view type is empty if the selector does not
     * select any element.
     */
    @BeforeEach
    ...
    /**
     * This test validates that if there are two resources with the root of one of them being
     * contained in the other resource (like a Java compilation unit being root of a resource but
     * also contained in its packages represented in a further resource), the root element that is
     * also contained in the other resource is not duplicated but copied properly.
     *
  ...
  class CommitViewChanges {
    ...
    void withEmptyChanges(VitruviusChange<HierarchicalId> change) {
      ArgumentCaptor<VitruviusChange<Uuid>> changeArgument =
    ...
    private VitruviusChange<HierarchicalId> assignIds(VitruviusChange<EObject> change) {
      VitruviusChangeResolver<HierarchicalId> idChangeResolver =
          VitruviusChangeResolverFactory.forHierarchicalIds(viewResourceSet);
