...
public class XmiIdEdgeCaseTest {
  ...
  public void testSingleResourceCopy() {
    ...
    XMLResource copiedModel =
        (XMLResource) ResourceCopier.copyViewResource(umlResourcePair.get0(), copyResourceSet);
  ...
  public void testMultiResourceCopy() {
    ...
    Pair<XMLResource, Map<String, EObject>> umlResourcePair2 =
        createPopulatedUmlResourceAndIdMapping("my2");
    Pair<XMLResource, Map<String, EObject>> umlResourcePair3 =
  ...
  private Pair<XMLResource, Map<String, EObject>> createPopulatedUmlResourceAndIdMapping(
      String name) {
    XMLResource umlResource =
        (XMLResource) resourceSet.createResource(getModelURI(name + ".uml_mockup"));
  ...
  /**
   * Returns the URI for the given model file name.
   *
