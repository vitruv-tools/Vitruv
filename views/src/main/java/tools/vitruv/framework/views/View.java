...
public interface View extends AutoCloseable {
   ...
   * and now providing an updated view on the {@code ViewSource}. It reuses the {@link
   * ViewSelection} with whom the view has been created. This can only be done for an unmodified
   * view.
   *
