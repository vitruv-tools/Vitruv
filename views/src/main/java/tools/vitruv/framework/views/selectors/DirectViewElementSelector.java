...
public class DirectViewElementSelector<Id> implements ViewSelector {
   ...
   * {@link ViewType} and {@link ChangeableViewSource}. All arguments must not be <code>null</code>.
   ...
   * @param selectableElements - the elements to select from to be used by the {@link ViewType} when
   *     creating a view
   */
