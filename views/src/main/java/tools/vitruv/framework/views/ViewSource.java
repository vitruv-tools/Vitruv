...
public interface ViewSource {
  /**
   * Returns {@link Resource}s representing the source models of a view to be instantiated.
   *
  ...
  /**
   * Returns the {@link UuidResolver} associated with the resources in this view source.
   *
