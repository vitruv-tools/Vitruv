...
public class ChangeDerivingView implements ModifiableView, CommittableView {
   ...
   * @see #commitChanges()
   */
  public ChangeDerivingView(
      BasicView view, StateBasedChangeResolutionStrategy changeResolutionStrategy) {
  ...
  private void setupReferenceState() {
    ...
    ResourceCopier.copyViewResources(
        view.getViewResourceSet().getResources(), originalStateViewResourceSet);
    originalStateResourceMapping = new HashMap<>();
    view.getViewResourceSet()
        .getResources()
        .forEach(
            resource -> {
              Resource originalResource =
                  originalStateViewResourceSet.getResources().stream()
  ...
  private VitruviusChange<HierarchicalId> generateChange(
      Resource newState, Resource referenceState) {
  ...
  public void registerRoot(
      org.eclipse.emf.ecore.EObject object, org.eclipse.emf.common.util.URI persistAt) {
    view.registerRoot(object, persistAt);
  }

  @Override
  public void moveRoot(
      org.eclipse.emf.ecore.EObject object, org.eclipse.emf.common.util.URI newLocation) {
