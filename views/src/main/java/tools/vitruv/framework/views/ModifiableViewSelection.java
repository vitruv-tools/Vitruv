...
public interface ModifiableViewSelection extends ViewSelection {
  ...
  /**
   * Returns whether the given {@link EObject} is selected. Also returns <code>false</code> when the
   * given object is <code>null</code> or not selectable at all.
   *
  ...
  /**
   * Returns whether the given {@link EObject} can be selected. May only be called for objects that
   * are selectable (i.e., contained in {@link #getSelectableElements()} and throws an exception
   * otherwise.
   *
   * @param eObject the {@link EObject} to check the selection state for
   * @return whether the given {@link EObject} is selected
  ...
  /**
   * Sets the selection state of the given {@link EObject}. May only be called for objects that are
   * selectable (i.e., contained in {@link #getSelectableElements()} and throws an exception
   * otherwise.
   *
