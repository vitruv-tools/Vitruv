...
package tools.vitruv.views.java.projumled4j.editor.viewpoint.javaActions;

import org.emftext.language.java.containers.Package;

/**
 * This abstract action has to be called in the context of a JaMoPP package. In that case the user is
 * asked to specify a name for a new Java class that will be created in the Java package the
 * JaMoPP package is representing.
 * 
 * @author Heiko Klare
 */
public class CreateJavaClassAction extends CreateTemplateAction {
	@Override
	protected void createTemplateFile(Package pckg) {
		createTemplateFile(pckg, "class");
	}
