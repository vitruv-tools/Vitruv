...
package tools.vitruv.views.java.projumled4j.editor.diagramGeneration.commands;
		...
		if (firstElement instanceof IPackageFragment) {
			...
			IRunnableWithProgress diagramGeneration = new IRunnableWithProgress() {
				public void run(IProgressMonitor monitor) {
					try {
						new tools.vitruv.views.java.projumled4j.editor.diagramGeneration.UmlClassDiagramGeneration(monitor, packg).createAndOpenDiagram();
