package edu.kit.ipd.sdq.vitruvius.framework.tests.change.attribute

import org.junit.Test

import static extension edu.kit.ipd.sdq.vitruvius.framework.tests.change.util.ChangeAssertHelper.*
import static extension edu.kit.ipd.sdq.vitruvius.framework.tests.change.util.ChangeDescription2ChangeTransformationTestUtil.*
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.attribute.PermuteEAttributeValues

class ChangeDescription2PermuteEAttrbuteValueTest extends edu.kit.ipd.sdq.vitruvius.framework.tests.change.ChangeDescription2ChangeTransformationTest {
