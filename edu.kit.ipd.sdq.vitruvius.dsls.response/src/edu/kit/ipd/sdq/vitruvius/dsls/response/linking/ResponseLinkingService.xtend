package edu.kit.ipd.sdq.vitruvius.dsls.response.linking
 ...
 */
class ResponseLinkingService extends DefaultLinkingService {
	private static final Logger log = Logger.getLogger(typeof(ResponseLinkingService));
