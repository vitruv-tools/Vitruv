...
class SingleChangeResponseGenerator {
	...
	public def generateResponse(String packageName, String className) {
	...
	private def getChangeEventTypeString() '''
		«ih.typeRef(changeEvent.change)»<«ih.typeRef(changeEvent.genericTypeParameterFQNOfChange)»>'''
