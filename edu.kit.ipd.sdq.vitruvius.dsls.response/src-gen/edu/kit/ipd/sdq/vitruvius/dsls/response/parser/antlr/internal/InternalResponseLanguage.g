			...
			(
				...
				lv_responsesSegments_2_0=ruleResponsesSegment
				{
					...
					add(
						...
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.ResponsesSegment");
					afterParserOrEnumRuleCall();
				}
			)
		)+
				...
				(
					...
					lv_routines_7_0=ruleExplicitRoutine
					{
						...
						add(
							...
							"routines",
							lv_routines_7_0,
							"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.ExplicitRoutine");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_routine_4_0=ruleImplicitRoutine
				{
					...
					set(
						...
						"routine",
						lv_routine_4_0,
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.ImplicitRoutine");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_matching_0_0=ruleMatching
				{
					...
					set(
						...
						"matching",
						lv_matching_0_0,
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.Matching");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_effect_1_0=ruleEffect
				{
					...
					set(
						...
						"effect",
						lv_effect_1_0,
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.Effect");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_retrievedElements_2_0=ruleRetrieveModelElement
				{
					...
					add(
						...
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.RetrieveModelElement");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_elementCreation_2_0=ruleCreateElement
					{
						...
						add(
							...
							"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.CreateElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_elementDeletion_3_0=ruleDeleteElement
					{
						...
						add(
							...
							"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.DeleteElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_correspondenceCreation_4_0=ruleCreateCorrespondence
					{
						...
						add(
							...
							"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.CreateCorrespondence");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_correspondenceDeletion_5_0=ruleRemoveCorrespondence
					{
						...
						add(
							...
							"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.RemoveCorrespondence");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_input_2_0=ruleRoutineInput
				{
					...
					set(
						...
						"input",
						lv_input_2_0,
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.RoutineInput");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_javaInputElements_6_0=ruleNamedJavaElement
					{
						...
						add(
							...
							"edu.kit.ipd.sdq.vitruvius.dsls.mirbase.MirBase.NamedJavaElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
		...
		(
			...
			lv_tag_0_0=ruleTagCodeBlock
			{
				...
				set(
					...
					"tag",
					lv_tag_0_0,
					"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.TagCodeBlock");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_element_1_0=ruleExistingElementReference
				{
					...
					set(
						...
						"element",
						lv_element_1_0,
						"edu.kit.ipd.sdq.vitruvius.dsls.response.ResponseLanguage.ExistingElementReference");
					afterParserOrEnumRuleCall();
				}
			)
		)
