 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.ResponseFileImpl#getNamespaceImports <em>Namespace Imports</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.ResponseFileImpl#getResponses <em>Responses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseFileImpl extends MirBaseFileImpl implements ResponseFile
{
  ...
  public EList<Response> getResponses()
  {
    if (responses == null)
    {
      responses = new EObjectContainmentEList<Response>(Response.class, this, ResponseLanguagePackage.RESPONSE_FILE__RESPONSES);
    }
    return responses;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case ResponseLanguagePackage.RESPONSE_FILE__RESPONSES:
