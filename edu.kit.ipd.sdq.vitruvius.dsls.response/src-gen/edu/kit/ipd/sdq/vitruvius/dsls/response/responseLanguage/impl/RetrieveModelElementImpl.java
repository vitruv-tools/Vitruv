 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#isAbscence <em>Abscence</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#getElement <em>Element</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#getCorrespondenceSource <em>Correspondence Source</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.RetrieveModelElementImpl#getPrecondition <em>Precondition</em>}</li>
 * </ul>
 *
 * @generated
 */
