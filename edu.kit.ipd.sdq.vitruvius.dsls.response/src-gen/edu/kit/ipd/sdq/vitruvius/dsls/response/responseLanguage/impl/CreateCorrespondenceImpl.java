 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.CreateCorrespondenceImpl#getFirstElement <em>First Element</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.impl.CreateCorrespondenceImpl#getSecondElement <em>Second Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateCorrespondenceImpl extends TaggableImpl implements CreateCorrespondence
{
  ...
  public NotificationChain basicSetFirstElement(ExistingElementReference newFirstElement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.CREATE_CORRESPONDENCE__FIRST_ELEMENT, oldFirstElement, newFirstElement);
  ...
  public void setFirstElement(ExistingElementReference newFirstElement)
  {
    if (newFirstElement != firstElement)
    {
      ...
      if (firstElement != null)
        msgs = ((InternalEObject)firstElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ResponseLanguagePackage.CREATE_CORRESPONDENCE__FIRST_ELEMENT, null, msgs);
      if (newFirstElement != null)
        msgs = ((InternalEObject)newFirstElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ResponseLanguagePackage.CREATE_CORRESPONDENCE__FIRST_ELEMENT, null, msgs);
      msgs = basicSetFirstElement(newFirstElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.CREATE_CORRESPONDENCE__FIRST_ELEMENT, newFirstElement, newFirstElement));
  }
  ...
  public NotificationChain basicSetSecondElement(ExistingElementReference newSecondElement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.CREATE_CORRESPONDENCE__SECOND_ELEMENT, oldSecondElement, newSecondElement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSecondElement(ExistingElementReference newSecondElement)
  {
    if (newSecondElement != secondElement)
    {
      ...
      if (secondElement != null)
        msgs = ((InternalEObject)secondElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ResponseLanguagePackage.CREATE_CORRESPONDENCE__SECOND_ELEMENT, null, msgs);
      if (newSecondElement != null)
        msgs = ((InternalEObject)newSecondElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ResponseLanguagePackage.CREATE_CORRESPONDENCE__SECOND_ELEMENT, null, msgs);
      msgs = basicSetSecondElement(newSecondElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.CREATE_CORRESPONDENCE__SECOND_ELEMENT, newSecondElement, newSecondElement));
  }
