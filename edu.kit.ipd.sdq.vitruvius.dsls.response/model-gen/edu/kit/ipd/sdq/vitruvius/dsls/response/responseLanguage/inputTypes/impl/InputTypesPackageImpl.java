/**
 */
package edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.impl;

import edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.InputTypesFactory;
...
public class InputTypesPackageImpl extends EPackageImpl implements InputTypesPackage {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.InputTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(stringEClass, edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
