...
public class InputTypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InputTypesPackage.STRING: {
				edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.String string = (edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.String)theEObject;
	 ...
	 * @generated
	 */
	public T caseString(edu.kit.ipd.sdq.vitruvius.dsls.response.responseLanguage.inputTypes.String object) {
		return null;
	}
