...
import edu.kit.ipd.sdq.vitruvius.tests.casestudies.pcmjava.responses.jamopp2pcm.JaMoPPPCMTestUtil;
...
public class PCM2JaMoPPTransformationTest extends VitruviusEMFCasestudyTest {
	public PCM2JaMoPPTransformationTest() {
		super(PCMJavaChange2CommandTransformingProviding::new);
	}
...
*/
        ...
        // we currently do not synchronize the parameters
    ...
    protected java.lang.Class<?> getChange2CommandTransformerClass() {
        return AbstractResponseChange2CommandTransforming.class;
    }
