		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureCallAccess().getGroup_1_2_1(), "rule__FeatureCall__Group_1_2_1__0");
					put(grammarAccess.getNamedFeatureAccess().getGroup(), "rule__NamedFeature__Group__0");
					put(grammarAccess.getNamedFeatureAccess().getGroup_1(), "rule__NamedFeature__Group_1__0");
					...
					put(grammarAccess.getClassOrFeatureAccess().getReferencedClassAssignment_2_0_1(), "rule__ClassOrFeature__ReferencedClassAssignment_2_0_1");
					put(grammarAccess.getClassOrFeatureAccess().getReferencedFeatureAssignment_2_1_1(), "rule__ClassOrFeature__ReferencedFeatureAssignment_2_1_1");
					put(grammarAccess.getFeatureCallAccess().getTailAssignment_1_2_0(), "rule__FeatureCall__TailAssignment_1_2_0");
					put(grammarAccess.getFeatureCallAccess().getTypeAssignment_1_2_1_1(), "rule__FeatureCall__TypeAssignment_1_2_1_1");
					put(grammarAccess.getNamedFeatureAccess().getFeatureAssignment_0(), "rule__NamedFeature__FeatureAssignment_0");
					put(grammarAccess.getNamedFeatureAccess().getNameAssignment_1_1(), "rule__NamedFeature__NameAssignment_1_1");
