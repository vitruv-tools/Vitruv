		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMappingBodyAccess().getAlternatives_2(), "rule__MappingBody__Alternatives_2");
					...
					put(grammarAccess.getMappingBodyAccess().getGroup_1(), "rule__MappingBody__Group_1__0");
					put(grammarAccess.getMappingBodyAccess().getGroup_2_0(), "rule__MappingBody__Group_2_0__0");
					put(grammarAccess.getMappingBodyAccess().getGroup_2_1(), "rule__MappingBody__Group_2_1__0");
					...
					put(grammarAccess.getFeatureCallAccess().getGroup_1_2_2(), "rule__FeatureCall__Group_1_2_2__0");
					put(grammarAccess.getFeatureCallAccess().getGroup_1_2_3(), "rule__FeatureCall__Group_1_2_3__0");
					...
					put(grammarAccess.getMIRFileAccess().getBundlesAssignment_4_0(), "rule__MIRFile__BundlesAssignment_4_0");
					put(grammarAccess.getMIRFileAccess().getImportsAssignment_4_1(), "rule__MIRFile__ImportsAssignment_4_1");
					put(grammarAccess.getMIRFileAccess().getMappingsAssignment_4_2(), "rule__MIRFile__MappingsAssignment_4_2");
					put(grammarAccess.getMIRFileAccess().getInvariantsAssignment_4_3(), "rule__MIRFile__InvariantsAssignment_4_3");
					...
					put(grammarAccess.getBundleAccess().getBundleFQNAssignment_1(), "rule__Bundle__BundleFQNAssignment_1");
					put(grammarAccess.getMappingBodyAccess().getWhenwhereAssignment_1_1(), "rule__MappingBody__WhenwhereAssignment_1_1");
					put(grammarAccess.getMappingBodyAccess().getWithBlocksAssignment_2_0_1(), "rule__MappingBody__WithBlocksAssignment_2_0_1");
					put(grammarAccess.getMappingBodyAccess().getWithsAssignment_2_1_1(), "rule__MappingBody__WithsAssignment_2_1_1");
					put(grammarAccess.getClassMappingAccess().getMappedElementsAssignment_2(), "rule__ClassMapping__MappedElementsAssignment_2");
					put(grammarAccess.getClassMappingAccess().getMappedElementsAssignment_4(), "rule__ClassMapping__MappedElementsAssignment_4");
					put(grammarAccess.getClassMappingAccess().getConstraintsAssignment_5(), "rule__ClassMapping__ConstraintsAssignment_5");
					put(grammarAccess.getFeatureMappingAccess().getMappedElementsAssignment_2(), "rule__FeatureMapping__MappedElementsAssignment_2");
					put(grammarAccess.getFeatureMappingAccess().getMappedElementsAssignment_4(), "rule__FeatureMapping__MappedElementsAssignment_4");
					put(grammarAccess.getFeatureMappingAccess().getConstraintsAssignment_5(), "rule__FeatureMapping__ConstraintsAssignment_5");
					put(grammarAccess.getNamedEClassAccess().getTypeAssignment_1(), "rule__NamedEClass__TypeAssignment_1");
					put(grammarAccess.getNamedEClassAccess().getNameAssignment_2_1(), "rule__NamedEClass__NameAssignment_2_1");
					put(grammarAccess.getTypedElementRefAccess().getRefAssignment(), "rule__TypedElementRef__RefAssignment");
					put(grammarAccess.getFeatureCallAccess().getTailAssignment_1_2_1(), "rule__FeatureCall__TailAssignment_1_2_1");
					put(grammarAccess.getFeatureCallAccess().getTypeAssignment_1_2_2_1(), "rule__FeatureCall__TypeAssignment_1_2_2_1");
					put(grammarAccess.getFeatureCallAccess().getNameAssignment_1_2_3_1(), "rule__FeatureCall__NameAssignment_1_2_3_1");
					put(grammarAccess.getInvariantAccess().getNameAssignment_1(), "rule__Invariant__NameAssignment_1");
					put(grammarAccess.getInvariantAccess().getBlockAssignment_2(), "rule__Invariant__BlockAssignment_2");
