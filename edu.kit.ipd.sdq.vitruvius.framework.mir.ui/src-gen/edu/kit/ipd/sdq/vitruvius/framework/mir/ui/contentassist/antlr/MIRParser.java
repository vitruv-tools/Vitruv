		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBaseMappingAccess().getWhensAssignment_4_1_0(), "rule__BaseMapping__WhensAssignment_4_1_0");
					put(grammarAccess.getBaseMappingAccess().getWithsAssignment_4_1_1(), "rule__BaseMapping__WithsAssignment_4_1_1");
					put(grammarAccess.getBaseMappingAccess().getWheresAssignment_4_1_2(), "rule__BaseMapping__WheresAssignment_4_1_2");
					...
					put(grammarAccess.getSubMappingAccess().getWhensAssignment_4_1_0(), "rule__SubMapping__WhensAssignment_4_1_0");
					put(grammarAccess.getSubMappingAccess().getWithsAssignment_4_1_1(), "rule__SubMapping__WithsAssignment_4_1_1");
					put(grammarAccess.getSubMappingAccess().getWheresAssignment_4_1_2(), "rule__SubMapping__WheresAssignment_4_1_2");
					...
					put(grammarAccess.getWhenAccess().getPredicateAssignment_1(), "rule__When__PredicateAssignment_1");
					put(grammarAccess.getWhereAccess().getPredicateAssignment_1(), "rule__Where__PredicateAssignment_1");
