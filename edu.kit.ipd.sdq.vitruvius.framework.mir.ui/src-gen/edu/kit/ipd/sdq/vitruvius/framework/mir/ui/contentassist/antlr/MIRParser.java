		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassOrFeatureAccess().getAlternatives_2(), "rule__ClassOrFeature__Alternatives_2");
					...
					put(grammarAccess.getClassOrFeatureAccess().getGroup(), "rule__ClassOrFeature__Group__0");
					put(grammarAccess.getClassOrFeatureAccess().getGroup_2_0(), "rule__ClassOrFeature__Group_2_0__0");
					put(grammarAccess.getClassOrFeatureAccess().getGroup_2_1(), "rule__ClassOrFeature__Group_2_1__0");
					put(grammarAccess.getNamedFeatureCallAccess().getGroup(), "rule__NamedFeatureCall__Group__0");
					put(grammarAccess.getNamedFeatureCallAccess().getGroup_1(), "rule__NamedFeatureCall__Group_1__0");
					put(grammarAccess.getNamedFeatureCallAccess().getGroup_1_2(), "rule__NamedFeatureCall__Group_1_2__0");
					put(grammarAccess.getNamedFeatureCallAccess().getGroup_1_2_1(), "rule__NamedFeatureCall__Group_1_2_1__0");
					...
					put(grammarAccess.getClassOrFeatureAccess().getContainingNamedEClassAssignment_2_0_1(), "rule__ClassOrFeature__ContainingNamedEClassAssignment_2_0_1");
					put(grammarAccess.getClassOrFeatureAccess().getContainingNamedFeatureAssignment_2_1_1(), "rule__ClassOrFeature__ContainingNamedFeatureAssignment_2_1_1");
					put(grammarAccess.getNamedFeatureCallAccess().getTailAssignment_1_2_0(), "rule__NamedFeatureCall__TailAssignment_1_2_0");
					put(grammarAccess.getNamedFeatureCallAccess().getTypeAssignment_1_2_1_1(), "rule__NamedFeatureCall__TypeAssignment_1_2_1_1");
					put(grammarAccess.getNamedFeatureAccess().getFeatureAssignment_0(), "rule__NamedFeature__FeatureAssignment_0");
					put(grammarAccess.getNamedFeatureAccess().getNameAssignment_2(), "rule__NamedFeature__NameAssignment_2");
