...
* generated by Xtext
*/
package edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr;
...
public class MIRParser extends AbstractContentAssistParser {
	...
	@Override
	protected edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr.internal.InternalMIRParser createParser() {
		edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr.internal.InternalMIRParser result = new edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr.internal.InternalMIRParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBaseMappingAccess().getAlternatives_4_1(), "rule__BaseMapping__Alternatives_4_1");
					put(grammarAccess.getSubMappingAccess().getAlternatives_4_1(), "rule__SubMapping__Alternatives_4_1");
					...
					put(grammarAccess.getResponseActionAccess().getAlternatives(), "rule__ResponseAction__Alternatives");
					put(grammarAccess.getMIRFileAccess().getGroup(), "rule__MIRFile__Group__0");
					put(grammarAccess.getMIRFileAccess().getGroup_3(), "rule__MIRFile__Group_3__0");
					put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
					put(grammarAccess.getMappingAccess().getGroup(), "rule__Mapping__Group__0");
					put(grammarAccess.getBaseMappingAccess().getGroup(), "rule__BaseMapping__Group__0");
					put(grammarAccess.getBaseMappingAccess().getGroup_4(), "rule__BaseMapping__Group_4__0");
					put(grammarAccess.getBaseMappingAccess().getGroup_4_1_0(), "rule__BaseMapping__Group_4_1_0__0");
					put(grammarAccess.getBaseMappingAccess().getGroup_4_1_1(), "rule__BaseMapping__Group_4_1_1__0");
					put(grammarAccess.getBaseMappingAccess().getGroup_4_1_2(), "rule__BaseMapping__Group_4_1_2__0");
					put(grammarAccess.getSubMappingAccess().getGroup(), "rule__SubMapping__Group__0");
					put(grammarAccess.getSubMappingAccess().getGroup_4(), "rule__SubMapping__Group_4__0");
					put(grammarAccess.getSubMappingAccess().getGroup_4_1_0(), "rule__SubMapping__Group_4_1_0__0");
					put(grammarAccess.getSubMappingAccess().getGroup_4_1_1(), "rule__SubMapping__Group_4_1_1__0");
					put(grammarAccess.getSubMappingAccess().getGroup_4_1_2(), "rule__SubMapping__Group_4_1_2__0");
					put(grammarAccess.getNamedEClassAccess().getGroup(), "rule__NamedEClass__Group__0");
					put(grammarAccess.getNamedEClassAccess().getGroup_2(), "rule__NamedEClass__Group_2__0");
					put(grammarAccess.getNamedFeatureAccess().getGroup(), "rule__NamedFeature__Group__0");
					put(grammarAccess.getNamedFeatureAccess().getGroup_4(), "rule__NamedFeature__Group_4__0");
					...
					put(grammarAccess.getInvariantAccess().getGroup_4_1(), "rule__Invariant__Group_4_1__0");
					...
					put(grammarAccess.getMIRFileAccess().getGeneratedPackageAssignment_2(), "rule__MIRFile__GeneratedPackageAssignment_2");
					put(grammarAccess.getMIRFileAccess().getGeneratedClassAssignment_3_2(), "rule__MIRFile__GeneratedClassAssignment_3_2");
					put(grammarAccess.getMIRFileAccess().getImportsAssignment_4_0(), "rule__MIRFile__ImportsAssignment_4_0");
					put(grammarAccess.getMIRFileAccess().getMappingsAssignment_4_1(), "rule__MIRFile__MappingsAssignment_4_1");
					put(grammarAccess.getMIRFileAccess().getInvariantsAssignment_4_2(), "rule__MIRFile__InvariantsAssignment_4_2");
					put(grammarAccess.getMIRFileAccess().getResponsesAssignment_4_3(), "rule__MIRFile__ResponsesAssignment_4_3");
					put(grammarAccess.getImportAccess().getPackageAssignment_2(), "rule__Import__PackageAssignment_2");
					put(grammarAccess.getImportAccess().getNameAssignment_4(), "rule__Import__NameAssignment_4");
					put(grammarAccess.getBaseMappingAccess().getMappedElementsAssignment_1(), "rule__BaseMapping__MappedElementsAssignment_1");
					put(grammarAccess.getBaseMappingAccess().getMappedElementsAssignment_3(), "rule__BaseMapping__MappedElementsAssignment_3");
					put(grammarAccess.getBaseMappingAccess().getWhensAssignment_4_1_0_1(), "rule__BaseMapping__WhensAssignment_4_1_0_1");
					put(grammarAccess.getBaseMappingAccess().getWithsAssignment_4_1_1_1(), "rule__BaseMapping__WithsAssignment_4_1_1_1");
					put(grammarAccess.getBaseMappingAccess().getWheresAssignment_4_1_2_1(), "rule__BaseMapping__WheresAssignment_4_1_2_1");
					put(grammarAccess.getSubMappingAccess().getMappedElementsAssignment_1(), "rule__SubMapping__MappedElementsAssignment_1");
					put(grammarAccess.getSubMappingAccess().getMappedElementsAssignment_3(), "rule__SubMapping__MappedElementsAssignment_3");
					put(grammarAccess.getSubMappingAccess().getWhensAssignment_4_1_0_1(), "rule__SubMapping__WhensAssignment_4_1_0_1");
					put(grammarAccess.getSubMappingAccess().getWithsAssignment_4_1_1_1(), "rule__SubMapping__WithsAssignment_4_1_1_1");
					put(grammarAccess.getSubMappingAccess().getWheresAssignment_4_1_2_1(), "rule__SubMapping__WheresAssignment_4_1_2_1");
					...
					put(grammarAccess.getNamedFeatureAccess().getContainingNamedEClassAssignment_1(), "rule__NamedFeature__ContainingNamedEClassAssignment_1");
					put(grammarAccess.getNamedFeatureAccess().getRepresentedFeatureAssignment_3(), "rule__NamedFeature__RepresentedFeatureAssignment_3");
					put(grammarAccess.getNamedFeatureAccess().getNameAssignment_4_1(), "rule__NamedFeature__NameAssignment_4_1");
					...
					put(grammarAccess.getInvariantAccess().getParamsAssignment_4_1_0(), "rule__Invariant__ParamsAssignment_4_1_0");
					...
					put(grammarAccess.getResponseAccess().getRestoreActionAssignment_4(), "rule__Response__RestoreActionAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr.internal.InternalMIRParser typedParser = (edu.kit.ipd.sdq.vitruvius.framework.mir.ui.contentassist.antlr.internal.InternalMIRParser) parser;
			typedParser.entryRuleMIRFile();
