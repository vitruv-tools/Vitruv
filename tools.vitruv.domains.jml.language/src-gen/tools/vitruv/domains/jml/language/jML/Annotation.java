 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.Annotation#getAnnotationname <em>Annotationname</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.Annotation#getElementvaluepairs <em>Elementvaluepairs</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.Annotation#getElementvalue <em>Elementvalue</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getAnnotation()
 * @model
 * @generated
 */
public interface Annotation extends Modifier, ElementValue
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getAnnotation_Annotationname()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.Annotation#getAnnotationname <em>Annotationname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getAnnotation_Elementvaluepairs()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.Annotation#getElementvaluepairs <em>Elementvaluepairs</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getAnnotation_Elementvalue()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.Annotation#getElementvalue <em>Elementvalue</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
