 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.DefaultValue#getElementvalue <em>Elementvalue</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getDefaultValue()
 * @model
 * @generated
 */
public interface DefaultValue extends EObject
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getDefaultValue_Elementvalue()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.DefaultValue#getElementvalue <em>Elementvalue</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
