 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.CompilationUnit#getPackagedeclaration <em>Packagedeclaration</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.CompilationUnit#getImportdeclaration <em>Importdeclaration</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.CompilationUnit#getTypedeclaration <em>Typedeclaration</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getCompilationUnit()
 * @model
 * @generated
 */
public interface CompilationUnit extends EObject
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getCompilationUnit_Packagedeclaration()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.CompilationUnit#getPackagedeclaration <em>Packagedeclaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link tools.vitruv.domains.jml.language.jML.ImportDeclaration}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getCompilationUnit_Importdeclaration()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link tools.vitruv.domains.jml.language.jML.ClassifierDeclarationWithModifier}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getCompilationUnit_Typedeclaration()
   * @model containment="true"
   * @generated
   */
