 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getDeclaredParam <em>Declared Param</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getForExpression <em>For Expression</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getEachExpression <em>Each Expression</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getForLoopExpression()
 * @model
 * @generated
 */
public interface ForLoopExpression extends Expression
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getForLoopExpression_DeclaredParam()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getDeclaredParam <em>Declared Param</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getForLoopExpression_ForExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getForExpression <em>For Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getForLoopExpression_EachExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.ForLoopExpression#getEachExpression <em>Each Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
