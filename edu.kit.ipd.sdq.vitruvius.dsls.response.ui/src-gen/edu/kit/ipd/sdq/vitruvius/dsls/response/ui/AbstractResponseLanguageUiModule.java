 ...
 */
package edu.kit.ipd.sdq.vitruvius.dsls.response.ui;

import com.google.inject.Binder;
import com.google.inject.Provider;
import com.google.inject.name.Names;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ide.contentassist.antlr.PartialResponseLanguageContentAssistParser;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ide.contentassist.antlr.ResponseLanguageParser;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ide.contentassist.antlr.internal.InternalResponseLanguageLexer;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ui.contentassist.ResponseLanguageProposalProvider;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ui.labeling.ResponseLanguageDescriptionLabelProvider;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ui.labeling.ResponseLanguageLabelProvider;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ui.outline.ResponseLanguageOutlineTreeProvider;
import edu.kit.ipd.sdq.vitruvius.dsls.response.ui.quickfix.ResponseLanguageQuickfixProvider;
...
public abstract class AbstractResponseLanguageUiModule extends DefaultXbaseUiModule {

	public AbstractResponseLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(edu.kit.ipd.sdq.vitruvius.dsls.response.parser.antlr.internal.InternalResponseLanguageLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalResponseLanguageLexer.class).toProvider(LexerProvider.create(InternalResponseLanguageLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ResponseLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ResponseLanguageDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ResponseLanguageOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ResponseLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ResponseLanguageProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialResponseLanguageContentAssistParser.class;
	}
