/**
 */
package tools.vitruv.dsls.response.responseLanguage.inputTypes.impl;

import tools.vitruv.dsls.response.responseLanguage.inputTypes.InputTypesFactory;
...
public class InputTypesPackageImpl extends EPackageImpl implements InputTypesPackage {
	 ...
	 * @see tools.vitruv.dsls.response.responseLanguage.inputTypes.InputTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(stringEClass, tools.vitruv.dsls.response.responseLanguage.inputTypes.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
