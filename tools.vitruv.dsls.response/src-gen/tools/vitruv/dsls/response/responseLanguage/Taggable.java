 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.response.responseLanguage.Taggable#getTag <em>Tag</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.dsls.response.responseLanguage.ResponseLanguagePackage#getTaggable()
 * @model
 * @generated
 */
public interface Taggable extends EObject
{
   ...
   * @see tools.vitruv.dsls.response.responseLanguage.ResponseLanguagePackage#getTaggable_Tag()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.dsls.response.responseLanguage.Taggable#getTag <em>Tag</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
