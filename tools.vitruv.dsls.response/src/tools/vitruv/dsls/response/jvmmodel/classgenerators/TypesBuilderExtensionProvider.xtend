...
class TypesBuilderExtensionProvider {
	protected extension tools.vitruv.dsls.response.jvmmodel.JvmTypesBuilderWithoutAssociations _typesBuilder;
	...
	public def void setBuilders(tools.vitruv.dsls.response.jvmmodel.JvmTypesBuilderWithoutAssociations typesBuilder, JvmTypeReferenceBuilder typeReferenceBuilder, JvmAnnotationReferenceBuilder annotationReferenceBuilder) {
