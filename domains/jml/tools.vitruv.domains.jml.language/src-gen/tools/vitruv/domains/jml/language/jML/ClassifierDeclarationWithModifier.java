 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.ClassifierDeclarationWithModifier#getClassOrInterfaceDeclaration <em>Class Or Interface Declaration</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getClassifierDeclarationWithModifier()
 * @model
 * @generated
 */
public interface ClassifierDeclarationWithModifier extends Modifiable, BlockStatement
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getClassifierDeclarationWithModifier_ClassOrInterfaceDeclaration()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.ClassifierDeclarationWithModifier#getClassOrInterfaceDeclaration <em>Class Or Interface Declaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
