		...
		lv_packagedeclaration_1_0=rulePackageDeclaration		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.PackageDeclaration");
		...
		lv_importdeclaration_2_0=ruleImportDeclaration		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.ImportDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typedeclaration_3_0=ruleClassifierDeclarationWithModifier		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.ClassifierDeclarationWithModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_qualifiedname_1_0=ruleQualifiedName		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.QualifiedName");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifiers_0_0=ruleModifier		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"modifiers",
        		lv_modifiers_0_0, 
        		"tools.vitruv.domains.jml.language.JML.Modifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_classOrInterfaceDeclaration_1_0=ruleClassOrInterfaceDeclaration		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.ClassOrInterfaceDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifier_0_0=ruleModifierValue		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"modifier",
        		lv_modifier_0_0, 
        		"tools.vitruv.domains.jml.language.JML.ModifierValue");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typeparameters_2_0=ruleTypeParameters		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.TypeParameters");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_superType_4_0=ruleType		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"superType",
        		lv_superType_4_0, 
        		"tools.vitruv.domains.jml.language.JML.Type");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_bodyDeclarations_10_0=ruleClassBodyDeclaration		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.ClassBodyDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typeparameter_1_0=ruleTypeParameter		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.TypeParameter");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typebound_3_0=ruleTypeBound		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"typebound",
        		lv_typebound_3_0, 
        		"tools.vitruv.domains.jml.language.JML.TypeBound");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_enumconstants_7_0=ruleEnumConstants		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.EnumConstants");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_bodyDeclarations_9_0=ruleEnumBodyDeclarations		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.EnumBodyDeclarations");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_enumconstant_0_0=ruleEnumConstant		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"enumconstant",
        		lv_enumconstant_0_0, 
        		"tools.vitruv.domains.jml.language.JML.EnumConstant");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_annotations_1_0=ruleAnnotations		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"annotations",
        		lv_annotations_1_0, 
        		"tools.vitruv.domains.jml.language.JML.Annotations");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_arguments_3_0=ruleArguments		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"arguments",
        		lv_arguments_3_0, 
        		"tools.vitruv.domains.jml.language.JML.Arguments");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expressions_2_0=ruleExpression		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"expressions",
        		lv_expressions_2_0, 
        		"tools.vitruv.domains.jml.language.JML.Expression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_block_1_0=ruleBlock		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"block",
        		lv_block_1_0, 
        		"tools.vitruv.domains.jml.language.JML.Block");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_jmlTypeSpecifications_1_0=ruleJMLTypeExpressionWithModifier		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.JMLTypeExpressionWithModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_jmlSpecifications_3_0=ruleJMLMethodSpecificationWithModifier		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.JMLMethodSpecificationWithModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modelElement_4_0=ruleJMLSpecificationOnlyElementWithModifier		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"modelElement",
        		lv_modelElement_4_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLSpecificationOnlyElementWithModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_element_7_0=ruleMemberDeclWithModifierRegular		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"element",
        		lv_element_7_0, 
        		"tools.vitruv.domains.jml.language.JML.MemberDeclWithModifierRegular");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifier_0_0=ruleVisibilityModifierValue		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"modifier",
        		lv_modifier_0_0, 
        		"tools.vitruv.domains.jml.language.JML.VisibilityModifierValue");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifier_0_0=ruleVisiblityModifier		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"modifier",
        		lv_modifier_0_0, 
        		"tools.vitruv.domains.jml.language.JML.VisiblityModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_spec_1_0=ruleJMLMethodSpecification		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"spec",
        		lv_spec_1_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLMethodSpecification");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_specifications_1_0=ruleJMLMethodExpression		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.JMLMethodExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_element_1_0=ruleJMLSpecificationOnlyElement		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"element",
        		lv_element_1_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLSpecificationOnlyElement");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_element_2_0=ruleMemberDeclWithModifierSpec		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"element",
        		lv_element_2_0, 
        		"tools.vitruv.domains.jml.language.JML.MemberDeclWithModifierSpec");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_spec_1_0=ruleJMLTypeExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"spec",
        		lv_spec_1_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLTypeExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifier_0_0=ruleJMLSpecMemberModifier		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"modifier",
        		lv_modifier_0_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLSpecMemberModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_jmlModifiers_2_0=ruleJMLMemberModifier		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"jmlModifiers",
        		lv_jmlModifiers_2_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLMemberModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_memberdecl_4_0=ruleMemberDecl		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"memberdecl",
        		lv_memberdecl_4_0, 
        		"tools.vitruv.domains.jml.language.JML.MemberDecl");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_parameters_2_0=ruleFormalParameterDecl		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"parameters",
        		lv_parameters_2_0, 
        		"tools.vitruv.domains.jml.language.JML.FormalParameterDecl");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_exceptions_7_0=ruleDeclaredException		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"exceptions",
        		lv_exceptions_7_0, 
        		"tools.vitruv.domains.jml.language.JML.DeclaredException");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_constructorbody_10_0=ruleConstructorBody		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.ConstructorBody");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_method_2_0=ruleMethodDeclaration		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"method",
        		lv_method_2_0, 
        		"tools.vitruv.domains.jml.language.JML.MethodDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_field_3_0=ruleFieldDeclaration		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"field",
        		lv_field_3_0, 
        		"tools.vitruv.domains.jml.language.JML.FieldDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_constructor_5_0=ruleConstructor		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"constructor",
        		lv_constructor_5_0, 
        		"tools.vitruv.domains.jml.language.JML.Constructor");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_methodbody_10_0=ruleMethodBody		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"methodbody",
        		lv_methodbody_10_0, 
        		"tools.vitruv.domains.jml.language.JML.MethodBody");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_variabledeclarator_0_0=ruleVariableDeclarator		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.VariableDeclarator");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_brackets_2_0=ruleBrackets		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"brackets",
        		lv_brackets_2_0, 
        		"tools.vitruv.domains.jml.language.JML.Brackets");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_type_0_0=ruleClassifierType		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"type",
        		lv_type_0_0, 
        		"tools.vitruv.domains.jml.language.JML.ClassifierType");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_primitivetype_0_0=rulePrimitiveType		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.PrimitiveType");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typearguments_1_0=ruleTypeArguments		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.TypeArguments");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_typeargument_1_0=ruleTypeArgument		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"typeargument",
        		lv_typeargument_1_0, 
        		"tools.vitruv.domains.jml.language.JML.TypeArgument");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_blockstatement_2_0=ruleBlockStatement		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.BlockStatement");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_annotation_0_0=ruleAnnotation		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"annotation",
        		lv_annotation_0_0, 
        		"tools.vitruv.domains.jml.language.JML.Annotation");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_annotationname_2_0=ruleAnnotationName		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.AnnotationName");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_elementvaluepairs_4_0=ruleElementValuePairs		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.ElementValuePairs");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_elementvalue_5_0=ruleElementValue		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"elementvalue",
        		lv_elementvalue_5_0, 
        		"tools.vitruv.domains.jml.language.JML.ElementValue");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_elementvaluepair_0_0=ruleElementValuePair		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.ElementValuePair");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_annotationtypeelementdeclaration_4_0=ruleAnnotationTypeElementDeclaration		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.AnnotationTypeElementDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_annotationtypeelementrest_1_0=ruleAnnotationTypeElementRest		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.AnnotationTypeElementRest");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_method_1_0=ruleAnnotationMethodRest		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"method",
        		lv_method_1_0, 
        		"tools.vitruv.domains.jml.language.JML.AnnotationMethodRest");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_constant_2_0=ruleAnnotationConstantRest		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"constant",
        		lv_constant_2_0, 
        		"tools.vitruv.domains.jml.language.JML.AnnotationConstantRest");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_defaultvalue_4_0=ruleDefaultValue		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"defaultvalue",
        		lv_defaultvalue_4_0, 
        		"tools.vitruv.domains.jml.language.JML.DefaultValue");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_4_0=ruleFeatureCallID		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_4_0, 
        		"tools.vitruv.domains.jml.language.JML.FeatureCallID");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_value_6_0=ruleAssignment		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"value",
        		lv_value_6_0, 
        		"tools.vitruv.domains.jml.language.JML.Assignment");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_9_0=ruleOpMultiAssign		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_9_0, 
        		"tools.vitruv.domains.jml.language.JML.OpMultiAssign");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpOr		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpOr");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleAndExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.AndExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpAnd		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpAnd");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleEqualityExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.EqualityExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpEquality		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpEquality");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleRelationalExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.RelationalExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_5_0=ruleOpCompare		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_5_0, 
        		"tools.vitruv.domains.jml.language.JML.OpCompare");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_6_0=ruleOtherOperatorExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_6_0, 
        		"tools.vitruv.domains.jml.language.JML.OtherOperatorExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpOther		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpOther");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleAdditiveExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.AdditiveExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpAdd		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpAdd");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleMultiplicativeExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.MultiplicativeExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpMulti		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpMulti");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_rightOperand_3_0=ruleUnaryOperation		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"tools.vitruv.domains.jml.language.JML.UnaryOperation");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_1_0=ruleOpUnary		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_1_0, 
        		"tools.vitruv.domains.jml.language.JML.OpUnary");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_2_0=ruleOpPostfix		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_2_0, 
        		"tools.vitruv.domains.jml.language.JML.OpPostfix");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_feature_15_0=ruleIdOrSuper		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"feature",
        		lv_feature_15_0, 
        		"tools.vitruv.domains.jml.language.JML.IdOrSuper");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_memberCallArguments_17_0=ruleShortClosure		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.ShortClosure");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_memberCallArguments_22_0=ruleClosure		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.Closure");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expr_1_0=ruleParenthesizedExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"expr",
        		lv_expr_1_0, 
        		"tools.vitruv.domains.jml.language.JML.ParenthesizedExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expr_2_0=ruleJMLForAllExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"expr",
        		lv_expr_2_0, 
        		"tools.vitruv.domains.jml.language.JML.JMLForAllExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expr_2_0=ruleParenthesisExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"expr",
        		lv_expr_2_0, 
        		"tools.vitruv.domains.jml.language.JML.ParenthesisExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_initExpressions_2_0=ruleVarDecl		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.VarDecl");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_declaredFormalParameters_2_0=ruleJvmFormalParameter		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"tools.vitruv.domains.jml.language.JML.JvmFormalParameter");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expression_6_0=ruleExpressionInClosure		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"expression",
        		lv_expression_6_0, 
        		"tools.vitruv.domains.jml.language.JML.ExpressionInClosure");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_expressions_1_0=ruleExpressionOrVarDeclaration		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"expressions",
        		lv_expressions_1_0, 
        		"tools.vitruv.domains.jml.language.JML.ExpressionOrVarDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_cases_11_0=ruleCasePart		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"cases",
        		lv_cases_11_0, 
        		"tools.vitruv.domains.jml.language.JML.CasePart");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_value_1_0=ruleNumber		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"value",
        		lv_value_1_0, 
        		"tools.vitruv.domains.jml.language.JML.Number");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"value",
        		lv_value_1_0, 
        		"tools.vitruv.domains.jml.language.JML.STRING");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"value",
        		lv_value_1_0, 
        		"tools.vitruv.domains.jml.language.JML.CHAR");
	    }
		...
		lv_catchClauses_3_0=ruleCatchClause		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"catchClauses",
        		lv_catchClauses_3_0, 
        		"tools.vitruv.domains.jml.language.JML.CatchClause");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_declaredParam_2_0=ruleFullJvmFormalParameter		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"tools.vitruv.domains.jml.language.JML.FullJvmFormalParameter");
	        afterParserOrEnumRuleCall();
	    }
