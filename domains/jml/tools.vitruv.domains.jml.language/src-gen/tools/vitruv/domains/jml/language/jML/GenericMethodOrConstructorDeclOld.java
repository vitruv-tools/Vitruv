 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.GenericMethodOrConstructorDeclOld#getConstructor <em>Constructor</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getGenericMethodOrConstructorDeclOld()
 * @model
 * @generated
 */
public interface GenericMethodOrConstructorDeclOld extends EObject
{
   ...
   * @see tools.vitruv.domains.jml.language.jML.JMLPackage#getGenericMethodOrConstructorDeclOld_Constructor()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.domains.jml.language.jML.GenericMethodOrConstructorDeclOld#getConstructor <em>Constructor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
