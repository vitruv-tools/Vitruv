 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.impl.NormalClassDeclarationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.impl.NormalClassDeclarationImpl#getTypeparameters <em>Typeparameters</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.impl.NormalClassDeclarationImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.impl.NormalClassDeclarationImpl#getImplementedTypes <em>Implemented Types</em>}</li>
 *   <li>{@link tools.vitruv.domains.jml.language.jML.impl.NormalClassDeclarationImpl#getBodyDeclarations <em>Body Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
