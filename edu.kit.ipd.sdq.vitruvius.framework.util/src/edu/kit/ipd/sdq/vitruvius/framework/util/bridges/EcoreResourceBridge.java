...
/**
 * A utility class hiding details of the resources part of the Eclipse Modeling Framework API
 * related for recurring tasks that are not project-specific.<br/>
 * <br/>
...
public final class EcoreResourceBridge {
    ...
    public static EObject getUniqueContentRoot(final Resource resource, final String modelName) {
        ...
        if (uniqueResourceContentRootElement != null) {
            ...
            throw new RuntimeException("The " + modelName + " '" + resource
                    + "' has to contain exactly one root element!");
        }
    }
