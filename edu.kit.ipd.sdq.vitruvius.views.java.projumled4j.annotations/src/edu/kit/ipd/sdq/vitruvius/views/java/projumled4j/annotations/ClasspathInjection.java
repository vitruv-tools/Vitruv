...
package edu.kit.ipd.sdq.vitruvius.views.java.projumled4j.annotations;
...
public class ClasspathInjection {
	private static final String PLUGIN_ID = "edu.kit.ipd.sdq.vitruvius.views.java.projumled4j.annotations";
