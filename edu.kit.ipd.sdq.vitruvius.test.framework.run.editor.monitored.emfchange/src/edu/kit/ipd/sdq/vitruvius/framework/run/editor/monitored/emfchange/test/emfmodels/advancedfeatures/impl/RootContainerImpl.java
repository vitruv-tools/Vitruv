...
import edu.kit.ipd.sdq.vitruvius.framework.run.editor.monitored.emfchange.test.emfmodels.advancedfeatures.FeatureMapContaining;
 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.run.editor.monitored.emfchange.test.emfmodels.advancedfeatures.impl.RootContainerImpl#getFeatureMapContaining <em>Feature Map Containing</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.run.editor.monitored.emfchange.test.emfmodels.advancedfeatures.impl.RootContainerImpl#getReferenceListContaining <em>Reference List Containing</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.run.editor.monitored.emfchange.test.emfmodels.advancedfeatures.impl.RootContainerImpl#getDummyDataContainerContaining <em>Dummy Data Container Containing</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.run.editor.monitored.emfchange.test.emfmodels.advancedfeatures.impl.RootContainerImpl#getAttributeListContaining <em>Attribute List Containing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
