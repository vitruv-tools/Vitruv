...
public abstract class EFeatureCorrespondenceImpl<TFeature extends EStructuralFeature> extends SameTypeCorrespondenceImpl implements EFeatureCorrespondence<TFeature> {
	 ...
	 * @generated
	 */
	public void setFeatureA(TFeature newFeatureA) {
		TFeature oldFeatureA = featureA;
		featureA = newFeatureA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_A, oldFeatureA, featureA));
	}
	 ...
	 * @generated
	 */
	public void setFeatureB(TFeature newFeatureB) {
		TFeature oldFeatureB = featureB;
		featureB = newFeatureB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_B, oldFeatureB, featureB));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__TYPE:
				...
				return;
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_A:
				setFeatureA((TFeature)newValue);
				return;
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_B:
				setFeatureB((TFeature)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__TYPE:
				...
				return;
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_A:
				setFeatureA((TFeature)null);
				return;
			case CorrespondencePackage.EFEATURE_CORRESPONDENCE__FEATURE_B:
				setFeatureB((TFeature)null);
				return;
		}
