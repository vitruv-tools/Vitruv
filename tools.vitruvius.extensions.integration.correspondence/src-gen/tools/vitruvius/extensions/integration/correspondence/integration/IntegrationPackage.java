 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see tools.vitruvius.extensions.integration.correspondence.integration.IntegrationFactory
 * @model kind="package"
 * @generated
 */
public interface IntegrationPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://tools.vitruvius/Correspondence/Integration/1.0";
	 ...
	 * @generated
	 */
	IntegrationPackage eINSTANCE = tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationPackageImpl.init();

	/**
	 * The meta object id for the '{@link tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationCorrespondenceImpl <em>Correspondence</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationCorrespondenceImpl
	 * @see tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationPackageImpl#getIntegrationCorrespondence()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruvius.extensions.integration.correspondence.integration.IntegrationCorrespondence <em>Correspondence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Correspondence</em>'.
	 * @see tools.vitruvius.extensions.integration.correspondence.integration.IntegrationCorrespondence
	 * @generated
	 */
	EClass getIntegrationCorrespondence();

	/**
	 * Returns the meta object for the attribute '{@link tools.vitruvius.extensions.integration.correspondence.integration.IntegrationCorrespondence#isCreatedByIntegration <em>Created By Integration</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Created By Integration</em>'.
	 * @see tools.vitruvius.extensions.integration.correspondence.integration.IntegrationCorrespondence#isCreatedByIntegration()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationCorrespondenceImpl <em>Correspondence</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationCorrespondenceImpl
		 * @see tools.vitruvius.extensions.integration.correspondence.integration.impl.IntegrationPackageImpl#getIntegrationCorrespondence()
