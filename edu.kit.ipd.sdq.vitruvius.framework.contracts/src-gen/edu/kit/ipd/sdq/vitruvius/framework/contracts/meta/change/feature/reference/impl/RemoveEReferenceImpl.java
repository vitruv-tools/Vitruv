 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.change.feature.reference.impl.RemoveEReferenceImpl#getFeatureName2OldValueMap <em>Feature Name2 Old Value Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveEReferenceImpl<T extends EObject> extends RemoveFromEListImpl<T> implements RemoveEReference<T> {
    ...
    public void setFeatureName2OldValueMap(Map<String, Object> newFeatureName2OldValueMap) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ReferencePackage.REMOVE_EREFERENCE__FEATURE_NAME2_OLD_VALUE_MAP, oldFeatureName2OldValueMap, featureName2OldValueMap));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ReferencePackage.REMOVE_EREFERENCE__OLD_TUID:
                return getOldTUID();
            case ReferencePackage.REMOVE_EREFERENCE__FEATURE_NAME2_OLD_VALUE_MAP:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == SubtractiveReferenceChange.class) {
            switch (derivedFeatureID) {
                case ReferencePackage.REMOVE_EREFERENCE__OLD_TUID: return ChangePackage.SUBTRACTIVE_REFERENCE_CHANGE__OLD_TUID;
                case ReferencePackage.REMOVE_EREFERENCE__FEATURE_NAME2_OLD_VALUE_MAP: return ChangePackage.SUBTRACTIVE_REFERENCE_CHANGE__FEATURE_NAME2_OLD_VALUE_MAP;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == SubtractiveReferenceChange.class) {
            switch (baseFeatureID) {
                case ChangePackage.SUBTRACTIVE_REFERENCE_CHANGE__OLD_TUID: return ReferencePackage.REMOVE_EREFERENCE__OLD_TUID;
                case ChangePackage.SUBTRACTIVE_REFERENCE_CHANGE__FEATURE_NAME2_OLD_VALUE_MAP: return ReferencePackage.REMOVE_EREFERENCE__FEATURE_NAME2_OLD_VALUE_MAP;
                default: return -1;
            }
        }
    ...
    public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        ...
        if (baseClass == SubtractiveChange.class) {
            switch (baseOperationID) {
                case ChangePackage.SUBTRACTIVE_CHANGE___GET_OLD_VALUE: return ReferencePackage.REMOVE_EREFERENCE___GET_OLD_VALUE;
                default: return -1;
            }
        }
        if (baseClass == SubtractiveReferenceChange.class) {
