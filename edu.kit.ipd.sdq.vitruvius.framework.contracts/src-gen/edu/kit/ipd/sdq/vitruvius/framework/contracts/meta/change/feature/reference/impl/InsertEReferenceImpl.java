...
public class InsertEReferenceImpl<T extends EObject> extends InsertInEListImpl<T> implements InsertEReference<T> {
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == AdditiveReferenceChange.class) {
            switch (derivedFeatureID) {
                case ReferencePackage.INSERT_EREFERENCE__NEW_VALUE: return ChangePackage.ADDITIVE_REFERENCE_CHANGE__NEW_VALUE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == AdditiveReferenceChange.class) {
            switch (baseFeatureID) {
                case ChangePackage.ADDITIVE_REFERENCE_CHANGE__NEW_VALUE: return ReferencePackage.INSERT_EREFERENCE__NEW_VALUE;
                default: return -1;
            }
        }
    ...
    public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        ...
        if (baseClass == AdditiveChange.class) {
            switch (baseOperationID) {
                case ChangePackage.ADDITIVE_CHANGE___GET_NEW_VALUE: return ReferencePackage.INSERT_EREFERENCE___GET_NEW_VALUE;
                default: return -1;
            }
        }
        if (baseClass == AdditiveReferenceChange.class) {
