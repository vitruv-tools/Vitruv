 ...
 * <ul>
 * <li>
 * {@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.correspondence.impl.CorrespondenceImpl#getParent
 * <em>Parent</em>}</li>
 * <li>
 * {@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.correspondence.impl.CorrespondenceImpl#getDependsOn
 * <em>Depends On</em>}</li>
 * <li>
 * {@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.correspondence.impl.CorrespondenceImpl#getDependedOnBy
 * <em>Depended On By</em>}</li>
 * <li>
 * {@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.correspondence.impl.CorrespondenceImpl#getATUIDs
 * <em>ATUI Ds</em>}</li>
 * <li>
 * {@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.correspondence.impl.CorrespondenceImpl#getBTUIDs
 * <em>BTUI Ds</em>}</li>
 * </ul>
 *
 * @generated
...
public class CorrespondenceImpl extends EObjectImpl implements Correspondence, Serializable {
    ...
    public EList<EObject> getAs() {
        return new BasicEList<EObject>(getParent().getCorrespondenceInstance().resolveEObjectsFromTUIDs(getATUIDs()));
    }
    ...
    public EList<EObject> getBs() {
        return new BasicEList<EObject>(getParent().getCorrespondenceInstance().resolveEObjectsFromTUIDs(getBTUIDs()));
    }
