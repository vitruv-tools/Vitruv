...
// this(getNsURISet(nsURI), uri, new DefaultTUIDCalculatorAndResolver(getTUIDPrefix(nsURI)),
// fileExtensions);
// }
//
...
// }
//
// public Metamodel(final String nsURI, final String nameOfIDFeature, final String
// nameOfNameAttribute, final VURI uri,
...
// }
//
// public Metamodel(final String nsURI, final VURI uri, final TUIDCalculatorAndResolver
// tuidCalculatorAndResolver,
// final String... fileExtensions) {
...
//
// public Metamodel(final Set<String> nsURIs, final VURI uri,
// final TUIDCalculatorAndResolver tuidCalculatorAndResolver, final Map<Object, Object>
// defaultLoadOptions,
...
// return
// VURI.getInstance(this.tuidCalculatorAndResolver.getModelVURIContainingIdentifiedEObject(tuid));
// }
//
