...
// * i.e. a call to toString() always returns the current TUID based on the links to its
// predecessors.
...
// * existing, then the packages are merged. In such cases {@link #moveLastSegment(String)} should
// be
// * called. <br/>
// * <br/>
// *
...
// private static final ForwardHashedBackwardLinkedTree<String> SEGMENTS =
// generateForwardHashedBackwardLinkedTree();
//
...
// }
//
// private static final Map<ForwardHashedBackwardLinkedTree<String>.Segment, TUID>
// LAST_SEGMENT_2_TUID_INSTANCES_MAP = new HashMap<ForwardHashedBackwardLinkedTree<String>.Segment,
// TUID>();
//
...
// final Iterator<ForwardHashedBackwardLinkedTree<String>.Segment> segmentIterator =
// lastSegment.iterator();
// ForwardHashedBackwardLinkedTree<String>.Segment pivot;
// while (segmentIterator.hasNext()) {
// pivot = segmentIterator.next();
// final TUID subInstance =
// getInstance(pivot.toString(VitruviusConstants.getTUIDSegmentSeperator()),
// true);
...
//
// /**
// * Moves the last segment of this TUID to the second but last segment of the given TUID and
// * merges the children for the last segments of both TUIDs. Both TUIDs have to end with
// * equivalent segments.
// *
// * This tuid and anotherTUID has to have at least two segments
// *
// * @param anotherTUID
// */
// public void moveLastSegmentToSecondButLastSegmentOfAnotherTUIDAndMergeChildren(final TUID
// anotherTUID) {
// if (getSegmentCount() < 2 || anotherTUID.getSegmentCount() < 2) {
// throw new RuntimeException("To move the last segment of '" + this + "' to the second but last
// segment of '"
// + anotherTUID + "' both TUIDs have to have at least two segments!");
// }
// if (getLastSegment().toString().equals(anotherTUID.getLastSegment().toString())) {
//
// }
// }
//
...
// * contains the TUID separator
// */
// private void renameLastSegment(final String newLastSegmentString, final
// BeforeHashCodeUpdateLambda before,
...
// final ForwardHashedBackwardLinkedTree<String>.Segment ancestor =
// this.lastSegment.iterator().next();
...
// } else {
// throw new IllegalArgumentException("The last segment '" + this.lastSegment + "' of the TUID '" +
// this
...
// * @return
// */
// private void moveLastSegment(final TUID fullDestinationTUID, final BeforeHashCodeUpdateLambda
// before,
// final AfterHashCodeUpdateLambda after) {
// final Collection<Pair<ForwardHashedBackwardLinkedTree<String>.Segment,
// ForwardHashedBackwardLinkedTree<String>.Segment>> segmentPairs = SEGMENTS
// .mergeSegmentIntoAnother(this.lastSegment, fullDestinationTUID.lastSegment);
// for (final Pair<ForwardHashedBackwardLinkedTree<String>.Segment,
// ForwardHashedBackwardLinkedTree<String>.Segment> segmentPair : segmentPairs) {
...
// return 0;
// } else {
// final String[] commonPrefixSegments =
// commonPrefix.split(VitruviusConstants.getTUIDSegmentSeperator());
...
// throw new IllegalArgumentException("Cannot update the TUID " + this + " because the new TUID " +
// newTUID
...
// */
// @Deprecated
// public List<Pair<String, String>> renameSegments(final TUID newTUID, final
// BeforeHashCodeUpdateLambda before,
// final AfterHashCodeUpdateLambda after) {
...
// oldPrefixPlusFirstSegmentToChange.moveLastSegment(newPrefixPlusFirstChangedSegment, before,
// after);
...
// Triple<TUID, String, Iterable<Pair<List<TUID>, Set<Correspondence>>>> performPreAction(TUID
// oldTUID);
// }
//
// public interface AfterHashCodeUpdateLambda {
// void performPostAction(Triple<TUID, String, Iterable<Pair<List<TUID>, Set<Correspondence>>>>
// removedMapEntries);
// }
//
