...
package tools.vitruv.views.java.projumled4j.editor.diagramGeneration;
...
import tools.vitruv.views.java.projumled4j.editor.diagramGeneration.MultiplicityDetermination;
import tools.vitruv.views.java.projumled4j.util.JamoppUtils;

/**
 * This class provides functionality for generating {@link tools.vitruv.javauml.annotations.Assocation} annotations
...
public class AssociationGenerator {
	...
	private static final String ANNOTATIONS_PACKAGE = "tools.vitruv.views.java.projumled4j.annotations";
