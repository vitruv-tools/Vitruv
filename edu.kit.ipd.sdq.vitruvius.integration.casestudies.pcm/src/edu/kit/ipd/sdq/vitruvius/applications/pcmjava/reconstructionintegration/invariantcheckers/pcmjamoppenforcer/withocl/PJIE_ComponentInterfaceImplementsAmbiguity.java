package edu.kit.ipd.sdq.vitruvius.applications.pcmjava.reconstructionintegration.invariantcheckers.pcmjamoppenforcer.withocl;
...
import edu.kit.ipd.sdq.vitruvius.applications.pcmjava.reconstructionintegration.invariantcheckers.PCMRepositorytoJaMoPPInvariantEnforcer;
...
public class PJIE_ComponentInterfaceImplementsAmbiguity extends PCMRepositorytoJaMoPPInvariantEnforcer {
    ...
    public void enforceInvariant() {
        ...
        final Bundle bundle = Platform
                .getBundle("edu.kit.ipd.sdq.vitruvius.applications.pcmjava.reconstructionintegration");
