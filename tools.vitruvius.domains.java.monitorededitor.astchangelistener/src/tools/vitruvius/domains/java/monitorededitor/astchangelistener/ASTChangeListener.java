package tools.vitruvius.domains.java.monitorededitor.astchangelistener;
...
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postchange.CreatePackageClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postchange.DeletePackageClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postchange.RemoveCompilationUnitClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postchange.RenamePackageClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.AddFieldClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.AddImportClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.AddMethodClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeAnnotationClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeFieldModifiersClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeFieldTypeClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeMethodModifiersClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeMethodParameterClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeMethodReturnTypeClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangePackageDeclarationClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeSupertypeClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.ChangeTypeModifiersClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.CreateTypeClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.HigherOperationEventsFilter;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.JavaDocClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RemoveFieldClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RemoveImportClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RemoveMethodClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RemoveTypeClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RenameFieldClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RenameMethodClassifier;
import tools.vitruvius.domains.java.monitorededitor.astchangelistener.classification.postreconcile.RenameTypeClassifier;
...
public class ASTChangeListener implements IStartup, IElementChangedListener {
    ...
    private static ConcreteChangeClassifier[] getPostReconcileClassifiers() {
        ...
        classifiers.addAll(getRegisteredClassifiers(
                "tools.vitruvius.domains.java.monitorededitor.astchangelistener.postreconcile"));
    ...
    private static ConcreteChangeClassifier[] getPostChangeClassifiers() {
        ...
        classifiers.addAll(getRegisteredClassifiers(
                "tools.vitruvius.domains.java.monitorededitor.astchangelistener.postchange"));
        return classifiers.toArray(new ConcreteChangeClassifier[0]);
    }
