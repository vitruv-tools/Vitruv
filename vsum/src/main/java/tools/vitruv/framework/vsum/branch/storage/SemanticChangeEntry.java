 ...
 * <ul>
 *   <li>Understand the change without EMF knowledge (via {@link #changeType} and {@link #changeDescription}).</li>
 *   <li>Replay or reverse the change (via {@link #elementUuid}, {@link #feature}, {@link #from}, {@link #to}).</li>
 *   <li>Detect semantic conflicts during branch merges (via {@link #elementUuid} and {@link #feature}).</li>
 * </ul>
 *
...
public class SemanticChangeEntry {
     ...
     *   <li>For single-valued reference changes: the UUID of the previously referenced element.</li>
     ...
     * {@link SemanticChangeType#REFERENCE_VALUE_INSERTED}, {@link SemanticChangeType#REFERENCE_VALUE_REMOVED}).
