...
package edu.kit.ipd.sdq.vitruvius.javauml.editor.diagramGeneration.commands;
		...
		if (firstElement instanceof IPackageFragment) {
			...
			IRunnableWithProgress diagramGeneration = new IRunnableWithProgress() {
				public void run(IProgressMonitor monitor) {
					try {
						new edu.kit.ipd.sdq.vitruvius.javauml.editor.diagramGeneration.UmlClassDiagramGeneration(monitor, packg).createAndOpenDiagram();
