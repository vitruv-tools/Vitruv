...
public class DeleteNonRootEObjectImpl<T extends Object> extends DeleteRootEObjectImpl implements DeleteNonRootEObject<T> {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == UpdateEReference.class) {
            switch (derivedFeatureID) {
                case ChangePackage.DELETE_NON_ROOT_EOBJECT__NEW_VALUE: return ChangePackage.UPDATE_EREFERENCE__NEW_VALUE;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == UpdateEReference.class) {
            switch (baseFeatureID) {
                case ChangePackage.UPDATE_EREFERENCE__NEW_VALUE: return ChangePackage.DELETE_NON_ROOT_EOBJECT__NEW_VALUE;
                default: return -1;
            }
        }
        if (baseClass == UpdateEContainmentReference.class) {
