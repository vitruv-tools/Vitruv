 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.impl.DeleteNonRootEObjectImpl#getAffectedFeature <em>Affected Feature</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.impl.DeleteNonRootEObjectImpl#getAffectedEObject <em>Affected EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeleteNonRootEObjectImpl<T extends EObject, U extends EReference> extends DeleteRootEObjectImpl implements DeleteNonRootEObject<T, U> {
    /**
    ...
    public U getAffectedFeature() {
        if (affectedFeature != null && affectedFeature.eIsProxy()) {
            ...
            if (affectedFeature != oldAffectedFeature) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_FEATURE, oldAffectedFeature, affectedFeature));
            }
        }
    ...
    public void setAffectedFeature(U newAffectedFeature) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_FEATURE, oldAffectedFeature, affectedFeature));
    }
    ...
    public EObject getAffectedEObject() {
        if (affectedEObject != null && affectedEObject.eIsProxy()) {
            ...
            if (affectedEObject != oldAffectedEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
            }
        }
    ...
    public void setAffectedEObject(EObject newAffectedEObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_FEATURE:
                if (resolve) return getAffectedFeature();
                return basicGetAffectedFeature();
            case ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_EOBJECT:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (derivedFeatureID) {
                case ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_FEATURE: return ChangePackage.EFEATURE_CHANGE__AFFECTED_FEATURE;
                case ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_EOBJECT: return ChangePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (baseFeatureID) {
                case ChangePackage.EFEATURE_CHANGE__AFFECTED_FEATURE: return ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_FEATURE;
                case ChangePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT: return ChangePackage.DELETE_NON_ROOT_EOBJECT__AFFECTED_EOBJECT;
                default: return -1;
            }
        }
        if (baseClass == EReferenceChange.class) {
