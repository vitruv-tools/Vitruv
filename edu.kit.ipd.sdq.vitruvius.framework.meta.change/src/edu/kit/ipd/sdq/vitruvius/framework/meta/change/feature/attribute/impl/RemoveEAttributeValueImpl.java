 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.attribute.impl.RemoveEAttributeValueImpl#getAffectedFeature <em>Affected Feature</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.attribute.impl.RemoveEAttributeValueImpl#getOldAffectedEObject <em>Old Affected EObject</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.attribute.impl.RemoveEAttributeValueImpl#getNewAffectedEObject <em>New Affected EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemoveEAttributeValueImpl<T extends Object> extends RemoveFromEListImpl<T> implements RemoveEAttributeValue<T> {
	/**
	...
	public EObject getOldAffectedEObject() {
        if (oldAffectedEObject != null && oldAffectedEObject.eIsProxy()) {
            ...
            if (oldAffectedEObject != oldOldAffectedEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, AttributePackage.REMOVE_EATTRIBUTE_VALUE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
            }
        }
	...
	public void setOldAffectedEObject(EObject newOldAffectedEObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AttributePackage.REMOVE_EATTRIBUTE_VALUE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
    }
	...
	public EObject getNewAffectedEObject() {
        if (newAffectedEObject != null && newAffectedEObject.eIsProxy()) {
            ...
            if (newAffectedEObject != oldNewAffectedEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, AttributePackage.REMOVE_EATTRIBUTE_VALUE__NEW_AFFECTED_EOBJECT, oldNewAffectedEObject, newAffectedEObject));
            }
        }
	...
	public void setNewAffectedEObject(EObject newNewAffectedEObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AttributePackage.REMOVE_EATTRIBUTE_VALUE__NEW_AFFECTED_EOBJECT, oldNewAffectedEObject, newAffectedEObject));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case AttributePackage.REMOVE_EATTRIBUTE_VALUE__OLD_AFFECTED_EOBJECT:
                if (resolve) return getOldAffectedEObject();
                return basicGetOldAffectedEObject();
            case AttributePackage.REMOVE_EATTRIBUTE_VALUE__NEW_AFFECTED_EOBJECT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (derivedFeatureID) {
                ...
                case AttributePackage.REMOVE_EATTRIBUTE_VALUE__OLD_AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__OLD_AFFECTED_EOBJECT;
                case AttributePackage.REMOVE_EATTRIBUTE_VALUE__NEW_AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__NEW_AFFECTED_EOBJECT;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (baseFeatureID) {
                ...
                case FeaturePackage.EFEATURE_CHANGE__OLD_AFFECTED_EOBJECT: return AttributePackage.REMOVE_EATTRIBUTE_VALUE__OLD_AFFECTED_EOBJECT;
                case FeaturePackage.EFEATURE_CHANGE__NEW_AFFECTED_EOBJECT: return AttributePackage.REMOVE_EATTRIBUTE_VALUE__NEW_AFFECTED_EOBJECT;
                default: return -1;
            }
        }
        if (baseClass == UpdateEAttribute.class) {
