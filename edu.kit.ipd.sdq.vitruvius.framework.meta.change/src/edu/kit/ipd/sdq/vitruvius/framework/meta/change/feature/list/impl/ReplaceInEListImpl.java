...
public abstract class ReplaceInEListImpl<T extends Object> extends UpdateSingleEListEntryImpl<T> implements ReplaceInEList<T> {
	...
	protected EClass eStaticClass() {
        return ListPackage.Literals.REPLACE_IN_ELIST;
    }
	...
	public void setNewValue(T newNewValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ListPackage.REPLACE_IN_ELIST__NEW_VALUE, oldNewValue, newValue));
    }
