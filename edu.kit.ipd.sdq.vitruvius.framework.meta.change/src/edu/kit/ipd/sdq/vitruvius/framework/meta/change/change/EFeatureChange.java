 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.EFeatureChange#getAffectedFeature <em>Affected Feature</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.EFeatureChange#getAffectedEObject <em>Affected EObject</em>}</li>
 * </ul>
 * </p>
 *
...
public interface EFeatureChange<T extends EStructuralFeature> extends EChange {
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.ChangePackage#getEFeatureChange_AffectedFeature()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.EFeatureChange#getAffectedFeature <em>Affected Feature</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.ChangePackage#getEFeatureChange_AffectedEObject()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.EFeatureChange#getAffectedEObject <em>Affected EObject</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
