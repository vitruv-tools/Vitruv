 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.change.impl.CreateNonRootEObjectImpl#getChangedFeatureType <em>Changed Feature Type</em>}</li>
...
public class CreateNonRootEObjectImpl<T extends EObject> extends CreateEObjectImpl implements CreateNonRootEObject<T> {
        ...
        if (changedFeatureType != null && changedFeatureType.eIsProxy()) {
            ...
            if (changedFeatureType != oldChangedFeatureType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChangePackage.CREATE_NON_ROOT_EOBJECT__CHANGED_FEATURE_TYPE, oldChangedFeatureType, changedFeatureType));
            }
        }
    ...
    public void setChangedFeatureType(EObject newChangedFeatureType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ChangePackage.CREATE_NON_ROOT_EOBJECT__CHANGED_FEATURE_TYPE, oldChangedFeatureType, changedFeatureType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ChangePackage.CREATE_NON_ROOT_EOBJECT__CHANGED_FEATURE_TYPE:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == EFeatureChange.class) {
            switch (derivedFeatureID) {
                case ChangePackage.CREATE_NON_ROOT_EOBJECT__CHANGED_FEATURE_TYPE: return ChangePackage.EFEATURE_CHANGE__CHANGED_FEATURE_TYPE;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == EFeatureChange.class) {
            switch (baseFeatureID) {
                case ChangePackage.EFEATURE_CHANGE__CHANGED_FEATURE_TYPE: return ChangePackage.CREATE_NON_ROOT_EOBJECT__CHANGED_FEATURE_TYPE;
                default: return -1;
            }
        }
        if (baseClass == UpdateEFeature.class) {
