...
public class ContainmentPackageImpl extends EPackageImpl implements ContainmentPackage {
     ...
     * @generated
     */
    private EClass insertNonRootEObjectInContainmentListEClass = null;
     ...
     * @generated
     */
    private EClass removeNonRootEObjectFromContainmentListEClass = null;
     ...
     * @generated
     */
    public EClass getInsertNonRootEObjectInContainmentList() {
        return insertNonRootEObjectInContainmentListEClass;
    }
     ...
     * @generated
     */
    public EClass getRemoveNonRootEObjectFromContainmentList() {
        return removeNonRootEObjectFromContainmentListEClass;
    }
	...
	public void createPackageContents() {
        ...
        insertNonRootEObjectInContainmentListEClass = createEClass(INSERT_NON_ROOT_EOBJECT_IN_CONTAINMENT_LIST);

        removeNonRootEObjectFromContainmentListEClass = createEClass(REMOVE_NON_ROOT_EOBJECT_FROM_CONTAINMENT_LIST);
    }
	...
	public void initializePackageContents() {
        ...
        ETypeParameter insertNonRootEObjectInContainmentListEClass_T = addETypeParameter(insertNonRootEObjectInContainmentListEClass, "T");
        ETypeParameter removeNonRootEObjectFromContainmentListEClass_T = addETypeParameter(removeNonRootEObjectFromContainmentListEClass, "T");
        ...
        g1 = createEGenericType(ecorePackage.getEObject());
        insertNonRootEObjectInContainmentListEClass_T.getEBounds().add(g1);
        g1 = createEGenericType(ecorePackage.getEObject());
        removeNonRootEObjectFromContainmentListEClass_T.getEBounds().add(g1);
        ...
        permuteContainmentEReferenceValuesEClass.getEGenericSuperTypes().add(g1);
        g1 = createEGenericType(theListPackage.getInsertInEList());
        g2 = createEGenericType(insertNonRootEObjectInContainmentListEClass_T);
        g1.getETypeArguments().add(g2);
        insertNonRootEObjectInContainmentListEClass.getEGenericSuperTypes().add(g1);
        g1 = createEGenericType(this.getUpdateContainmentEReference());
        g2 = createEGenericType(insertNonRootEObjectInContainmentListEClass_T);
        g1.getETypeArguments().add(g2);
        insertNonRootEObjectInContainmentListEClass.getEGenericSuperTypes().add(g1);
        g1 = createEGenericType(theListPackage.getRemoveFromEList());
        g2 = createEGenericType(removeNonRootEObjectFromContainmentListEClass_T);
        g1.getETypeArguments().add(g2);
        removeNonRootEObjectFromContainmentListEClass.getEGenericSuperTypes().add(g1);
        g1 = createEGenericType(this.getUpdateContainmentEReference());
        g2 = createEGenericType(removeNonRootEObjectFromContainmentListEClass_T);
        g1.getETypeArguments().add(g2);
        removeNonRootEObjectFromContainmentListEClass.getEGenericSuperTypes().add(g1);
        ...
        initEClass(insertNonRootEObjectInContainmentListEClass, InsertNonRootEObjectInContainmentList.class, "InsertNonRootEObjectInContainmentList", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(removeNonRootEObjectFromContainmentListEClass, RemoveNonRootEObjectFromContainmentList.class, "RemoveNonRootEObjectFromContainmentList", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    }
