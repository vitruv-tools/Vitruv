 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.object.impl.CreateEObjectImpl#getNewEObject <em>New EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CreateEObjectImpl<T extends EObject> extends EObjectChangeImpl<T> implements CreateEObject<T> {
		...
		if (newEObject != null && newEObject.eIsProxy()) {
			...
			if (newEObject != oldNewEObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ObjectPackage.CREATE_EOBJECT__NEW_EOBJECT, oldNewEObject, newEObject));
			}
		}
		return newEObject;
	}
	...
	public void setNewEObject(T newNewEObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ObjectPackage.CREATE_EOBJECT__NEW_EOBJECT, oldNewEObject, newEObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ObjectPackage.CREATE_EOBJECT__NEW_EOBJECT:
