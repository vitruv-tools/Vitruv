 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.EFeatureChange#getAffectedEObject <em>Affected EObject</em>}</li>
 * </ul>
 * </p>
 *
...
public interface EFeatureChange<T extends EStructuralFeature> extends EChange {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.FeaturePackage#getEFeatureChange_AffectedEObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.EFeatureChange#getAffectedEObject <em>Affected EObject</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
