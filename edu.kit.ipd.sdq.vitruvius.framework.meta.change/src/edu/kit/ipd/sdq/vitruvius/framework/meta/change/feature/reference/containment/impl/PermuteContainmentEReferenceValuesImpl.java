 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.reference.containment.impl.PermuteContainmentEReferenceValuesImpl#getAffectedEObject <em>Affected EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PermuteContainmentEReferenceValuesImpl<T extends EObject> extends PermuteEListImpl<T> implements PermuteContainmentEReferenceValues<T> {
	...
	public EObject getAffectedEObject() {
		if (affectedEObject != null && affectedEObject.eIsProxy()) {
			...
			if (affectedEObject != oldAffectedEObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainmentPackage.PERMUTE_CONTAINMENT_EREFERENCE_VALUES__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
			}
		}
	...
	public void setAffectedEObject(EObject newAffectedEObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContainmentPackage.PERMUTE_CONTAINMENT_EREFERENCE_VALUES__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ContainmentPackage.PERMUTE_CONTAINMENT_EREFERENCE_VALUES__AFFECTED_EOBJECT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EFeatureChange.class) {
			switch (derivedFeatureID) {
				...
				case ContainmentPackage.PERMUTE_CONTAINMENT_EREFERENCE_VALUES__AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EFeatureChange.class) {
			switch (baseFeatureID) {
				...
				case FeaturePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT: return ContainmentPackage.PERMUTE_CONTAINMENT_EREFERENCE_VALUES__AFFECTED_EOBJECT;
				default: return -1;
			}
		}
		if (baseClass == UpdateEReference.class) {
