...
public class ChangePackageImpl extends EPackageImpl implements ChangePackage {
    ...
    public void initializePackageContents() {
        ...
        EGenericType g2 = createEGenericType(createNonRootEObjectEClass_T);
        g1.getETypeArguments().add(g2);
        createNonRootEObjectEClass.getEGenericSuperTypes().add(g1);
        createRootEObjectEClass.getESuperTypes().add(this.getCreateEObject());
        updateEFeatureEClass.getESuperTypes().add(this.getEFeatureChange());
        unsetEFeatureEClass.getESuperTypes().add(this.getEFeatureChange());
        ...
        initEReference(getUpdateEFeature_NewValue(), g1, null, "newValue", null, 0, 1, UpdateEFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
