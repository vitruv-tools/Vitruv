 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.list.impl.InsertInEListImpl#getNewValue <em>New Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InsertInEListImpl<T extends Object> extends UpdateSingleEListEntryImpl<T> implements InsertInEList<T> {
	...
	public void setNewValue(T newNewValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ListPackage.INSERT_IN_ELIST__NEW_VALUE, oldNewValue, newValue));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ListPackage.INSERT_IN_ELIST__NEW_VALUE:
                return getNewValue();
        }
