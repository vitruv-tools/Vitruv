 ...
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.UpdateEFeature#getNewValue <em>New Value</em>}</li>
 * </ul>
 * </p>
 *
...
public interface UpdateEFeature<T extends Object> extends EObject {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.meta.change.ChangePackage#getUpdateEFeature_NewValue()
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.UpdateEFeature#getNewValue <em>New Value</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
