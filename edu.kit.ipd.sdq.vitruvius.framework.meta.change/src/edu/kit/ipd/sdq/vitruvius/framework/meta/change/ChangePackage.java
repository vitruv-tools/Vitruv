...
public interface ChangePackage extends EPackage {
	...
	/**
	 * Returns the meta object for the reference '{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.UpdateEFeature#getNewValue <em>New Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>New Value</em>'.
	 * @see edu.kit.ipd.sdq.vitruvius.framework.meta.change.UpdateEFeature#getNewValue()
