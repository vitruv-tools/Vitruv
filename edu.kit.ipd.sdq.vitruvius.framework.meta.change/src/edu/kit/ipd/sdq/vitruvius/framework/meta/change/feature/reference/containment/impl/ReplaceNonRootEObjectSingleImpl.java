...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Replace Non Root EObject Single</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.reference.containment.impl.ReplaceNonRootEObjectSingleImpl#getOldAffectedEObject <em>Old Affected EObject</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.meta.change.feature.reference.containment.impl.ReplaceNonRootEObjectSingleImpl#getNewAffectedEObject <em>New Affected EObject</em>}</li>
...
public class ReplaceNonRootEObjectSingleImpl<T extends EObject> extends ReplaceEObjectImpl<T> implements ReplaceNonRootEObjectSingle<T> {
     ...
     * @generated
     */
	protected ReplaceNonRootEObjectSingleImpl() {
        super();
    }
	...
	protected EClass eStaticClass() {
        return ContainmentPackage.Literals.REPLACE_NON_ROOT_EOBJECT_SINGLE;
    }
	...
	public EReference getAffectedFeature() {
        if (affectedFeature != null && affectedFeature.eIsProxy()) {
            ...
            if (affectedFeature != oldAffectedFeature) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_FEATURE, oldAffectedFeature, affectedFeature));
            }
        }
	...
	public void setAffectedFeature(EReference newAffectedFeature) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_FEATURE, oldAffectedFeature, affectedFeature));
    }
	...
	public EObject getOldAffectedEObject() {
        if (oldAffectedEObject != null && oldAffectedEObject.eIsProxy()) {
            ...
            if (oldAffectedEObject != oldOldAffectedEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
            }
        }
	...
	public void setOldAffectedEObject(EObject newOldAffectedEObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__OLD_AFFECTED_EOBJECT, oldOldAffectedEObject, oldAffectedEObject));
    }
	...
	public EObject getNewAffectedEObject() {
        if (newAffectedEObject != null && newAffectedEObject.eIsProxy()) {
            ...
            if (newAffectedEObject != oldNewAffectedEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__NEW_AFFECTED_EOBJECT, oldNewAffectedEObject, newAffectedEObject));
            }
        }
	...
	public void setNewAffectedEObject(EObject newNewAffectedEObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__NEW_AFFECTED_EOBJECT, oldNewAffectedEObject, newAffectedEObject));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__OLD_AFFECTED_EOBJECT:
                if (resolve) return getOldAffectedEObject();
                return basicGetOldAffectedEObject();
            case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__NEW_AFFECTED_EOBJECT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (derivedFeatureID) {
                case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_FEATURE: return FeaturePackage.EFEATURE_CHANGE__AFFECTED_FEATURE;
                case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__OLD_AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__OLD_AFFECTED_EOBJECT;
                case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__NEW_AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__NEW_AFFECTED_EOBJECT;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EFeatureChange.class) {
            switch (baseFeatureID) {
                case FeaturePackage.EFEATURE_CHANGE__AFFECTED_FEATURE: return ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_FEATURE;
                case FeaturePackage.EFEATURE_CHANGE__OLD_AFFECTED_EOBJECT: return ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__OLD_AFFECTED_EOBJECT;
                case FeaturePackage.EFEATURE_CHANGE__NEW_AFFECTED_EOBJECT: return ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__NEW_AFFECTED_EOBJECT;
                default: return -1;
            }
        }
        if (baseClass == UpdateEReference.class) {
...
} //ReplaceNonRootEObjectSingleImpl
