...
public class ReplaceNonRootEObjectSingleImpl<T extends EObject> extends ReplaceEObjectImpl<T> implements ReplaceNonRootEObjectSingle<T> {
	...
	public EObject getAffectedEObject() {
		if (affectedEObject != null && affectedEObject.eIsProxy()) {
			...
			if (affectedEObject != oldAffectedEObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
			}
		}
	...
	public void setAffectedEObject(EObject newAffectedEObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_EOBJECT, oldAffectedEObject, affectedEObject));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EFeatureChange.class) {
			switch (derivedFeatureID) {
				...
				case ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_EOBJECT: return FeaturePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EFeatureChange.class) {
			switch (baseFeatureID) {
				...
				case FeaturePackage.EFEATURE_CHANGE__AFFECTED_EOBJECT: return ContainmentPackage.REPLACE_NON_ROOT_EOBJECT_SINGLE__AFFECTED_EOBJECT;
				default: return -1;
			}
		}
		if (baseClass == UpdateEReference.class) {
