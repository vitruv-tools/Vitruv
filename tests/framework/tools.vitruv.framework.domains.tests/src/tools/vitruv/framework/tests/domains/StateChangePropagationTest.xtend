...
abstract class StateChangePropagationTest extends DomainTest {
	...
	protected def Resource createCheckpoint(ModelInstance model) { // TODO TS model resource or root resource?
	...
	protected def CompositeContainerChange getRecordedChanges() throws IOException {
