...
class CorrespondenceTest extends VsumTest {
	...
	static extension Logger = Logger.getLogger(CorrespondenceTest.getSimpleName())
	...
	@Test def void testCorrespondenceUpdate() {
		...
		@Test def void testMoveRootEObjectBetweenResource() {
			...
			def private void testCorrespondencePersistence(InternalVirtualModel vsum, Repository repo, UPackage pkg,
				...
				var InternalVirtualModel vsum2 = createAlternativeVirtualModelAndModelInstances(
					alternativePcmInstanceURI, alterantiveUMLInstanceURI);
			...
			def private void testSimpleRemove(UPackage pkg, CorrespondenceModel corresp, Correspondence repo2pkg,
				...
				var Set<Interface> correspForRepoInterfaceType = corresp.
					getAllEObjectsOfTypeInCorrespondences(Interface)
			...
			def private void testCreateRepo2PkgCorrespondenceAndUpdateTuid(
				Repository repo,
				UPackage pkg,
				CorrespondenceModel corresp,
				Correspondence repo2pkg
