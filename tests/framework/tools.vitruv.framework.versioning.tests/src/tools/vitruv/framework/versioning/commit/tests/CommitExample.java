...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>commit</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CommitExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.commit"));
				MergeCommit root = CommitFactory.eINSTANCE.createMergeCommit();
