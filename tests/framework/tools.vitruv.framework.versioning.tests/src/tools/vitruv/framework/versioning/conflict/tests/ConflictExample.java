...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>conflict</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConflictExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ConflictPackage.eNS_URI, 
			 ConflictPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.conflict"));
				SimpleChangeConflict root = ConflictFactory.eINSTANCE.createSimpleChangeConflict();
