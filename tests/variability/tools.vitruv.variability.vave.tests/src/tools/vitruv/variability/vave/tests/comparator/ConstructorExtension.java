...
public class ConstructorExtension {
	...
	/**
	 * Returns <code>true</code> if the given {@link Constructor} <code>co</code> is a better match for the given constructor call than {@link Constructor} <code>other</code>.
	 *
	 * Possible Result:
	 * <ol>
	 ...
	 * @return True only if the new {@link Constructor} <code>co</code> is better than the other one.
	 */
	 ...
	 * @param call              The call to check for.
	 * @param needsPerfectMatch Flag how to handle parameters with variable argument (array) length
