...
import static tools.vitruv.applications.demo.addressesrecipients.tests.AddressesCreators.*
import static tools.vitruv.applications.demo.addressesrecipients.tests.AddressesXRecipientsTestConstants.*
import static tools.vitruv.applications.demo.addressesrecipients.tests.RecipientsCreators.*
