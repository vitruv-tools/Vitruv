...
public class RecipientDeletedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.adXre_R2L.RecipientDeletedReaction.ActionUserExecution userExecution = new mir.reactions.adXre_R2L.RecipientDeletedReaction.ActionUserExecution(this.executionState, this);
