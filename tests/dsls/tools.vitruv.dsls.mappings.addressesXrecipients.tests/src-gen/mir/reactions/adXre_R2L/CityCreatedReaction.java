...
public class CityCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.adXre_R2L.CityCreatedReaction.ActionUserExecution userExecution = new mir.reactions.adXre_R2L.CityCreatedReaction.ActionUserExecution(this.executionState, this);
