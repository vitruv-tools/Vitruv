...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean ensureAllMappings() {
    mir.routines.adXre_L2R.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("adXre_L2R").prepend(this._getParentImportPath()));
