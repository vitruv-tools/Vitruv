  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(@Extension final RoutinesFacade _routinesFacade) {
      ...
      for (final RightAdRootXReRootInstanceHalf instance : instances) {
        _routinesFacade.updateAdRootXReRootMappingInstance(instance.getRRoot());
      }
    }
  }
  
  public UpdateAdRootXReRootMappingInstancesRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.adXre_R2L.UpdateAdRootXReRootMappingInstancesRoutine.ActionUserExecution(getExecutionState(), this);
  }
