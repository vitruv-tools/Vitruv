...
public class EnforceAdRootXReRootMappingConditionsFromRightToLeftRoutine extends AbstractRepairRoutineRealization {
  ...
  public EnforceAdRootXReRootMappingConditionsFromRightToLeftRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Addresses aRoot, final Recipients rRoot) {
