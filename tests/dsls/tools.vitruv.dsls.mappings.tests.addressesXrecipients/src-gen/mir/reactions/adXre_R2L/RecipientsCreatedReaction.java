...
public class RecipientsCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.adXre_R2L.RecipientsCreatedReaction.ActionUserExecution userExecution = new mir.reactions.adXre_R2L.RecipientsCreatedReaction.ActionUserExecution(this.executionState, this);
