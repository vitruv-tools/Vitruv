...
class LocationDeletedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.Location> typedChange = (DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.Location>)change;
    edu.kit.ipd.sdq.mdsd.recipients.Location affectedEObject = typedChange.getAffectedEObject();
  ...
  private boolean checkChangeProperties(final EChange change) {
    DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.Location> relevantChange = (DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.Location>)change;
    if (!(relevantChange.getAffectedEObject() instanceof edu.kit.ipd.sdq.mdsd.recipients.Location)) {
    	return false;
    }
    return true;
  }
