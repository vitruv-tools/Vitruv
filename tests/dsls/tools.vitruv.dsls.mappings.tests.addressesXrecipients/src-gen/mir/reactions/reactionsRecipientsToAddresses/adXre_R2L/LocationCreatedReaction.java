...
class LocationCreatedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Location> typedChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Location>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Location> relevantChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Location>)change;
