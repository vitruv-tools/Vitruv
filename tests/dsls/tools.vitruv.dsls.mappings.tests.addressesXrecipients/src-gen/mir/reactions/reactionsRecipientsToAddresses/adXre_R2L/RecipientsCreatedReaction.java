...
class RecipientsCreatedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Recipients> typedChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Recipients>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Recipients> relevantChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.recipients.Recipients>)change;
