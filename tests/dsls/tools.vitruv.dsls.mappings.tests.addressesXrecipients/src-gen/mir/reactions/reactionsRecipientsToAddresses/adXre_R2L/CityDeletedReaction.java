...
class CityDeletedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.City> typedChange = (DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.City>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.City> relevantChange = (DeleteEObject<edu.kit.ipd.sdq.mdsd.recipients.City>)change;
