...
class AddressesCreatedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Addresses> typedChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Addresses>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Addresses> relevantChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Addresses>)change;
