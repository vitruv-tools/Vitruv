...
class AddressCreatedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Address> typedChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Address>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Address> relevantChange = (CreateEObject<edu.kit.ipd.sdq.mdsd.addresses.Address>)change;
