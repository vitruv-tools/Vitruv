...
class AddressDeletedReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    DeleteEObject<Address> typedChange = (DeleteEObject<Address>)change;
    ...
    mir.reactions.reactionsAddressesToRecipients.ad2re.AddressDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsAddressesToRecipients.ad2re.AddressDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    DeleteEObject<Address> relevantChange = (DeleteEObject<Address>)change;
