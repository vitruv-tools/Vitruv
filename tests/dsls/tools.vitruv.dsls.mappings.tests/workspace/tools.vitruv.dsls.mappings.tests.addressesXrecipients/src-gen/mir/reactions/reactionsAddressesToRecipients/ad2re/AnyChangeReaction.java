...
class AnyChangeReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsAddressesToRecipients.ad2re.AnyChangeReaction.ActionUserExecution userExecution = new mir.reactions.reactionsAddressesToRecipients.ad2re.AnyChangeReaction.ActionUserExecution(this.executionState, this);
