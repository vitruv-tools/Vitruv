...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public void deleteAddressXRecipientLocationCityMappingInstance(final Address a) {
    mir.routines.ad2re.DeleteAddressXRecipientLocationCityMappingInstanceRoutine effect = new mir.routines.ad2re.DeleteAddressXRecipientLocationCityMappingInstanceRoutine(this.executionState, calledBy,
    	a);
    effect.applyRoutine();
  }
  ...
  public void createAddressXRecipientLocationCityMappingInstance(final Address a) {
    mir.routines.ad2re.CreateAddressXRecipientLocationCityMappingInstanceRoutine effect = new mir.routines.ad2re.CreateAddressXRecipientLocationCityMappingInstanceRoutine(this.executionState, calledBy,
    	a);
    effect.applyRoutine();
  }
  ...
  public void updateAddressXRecipientLocationCityMappingInstance(final Address a) {
    mir.routines.ad2re.UpdateAddressXRecipientLocationCityMappingInstanceRoutine effect = new mir.routines.ad2re.UpdateAddressXRecipientLocationCityMappingInstanceRoutine(this.executionState, calledBy,
    	a);
    effect.applyRoutine();
  }
}
