...
class ReplacedSingleValuedPrimitiveTypeEAttributeReaction extends AbstractReactionRealization {
  public ReplacedSingleValuedPrimitiveTypeEAttributeReaction(final UserInteracting userInteracting) {
  ...
  private boolean checkChangeProperties(final EChange change) {
    ...
    if (!relevantChange.getAffectedFeature().getName().equals("singleValuedPrimitiveTypeEAttribute")) {
    	return false;
    }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Root affectedEObject, final EAttribute affectedFeature, final Integer oldValue, final Integer newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.replaceSingleValuedPrimitiveTypeEAttribute(affectedEObject, newValue);
    }
  }
}
