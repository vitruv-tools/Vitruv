...
public class RemoveEAttributeEffect extends AbstractEffectRealization {
  ...
  private static class EffectUserExecution extends AbstractEffectRealization.UserExecution {
    ...
    private void executeUserOperations(final Root root, final Integer removedAttributeValue, final Root targetElement) {
  ...
  private EObject getCorrepondenceSourceTargetElement(final Root root, final Integer removedAttributeValue) {
    return root;
  }
  ...
  protected void executeRoutine() throws IOException {
    ...
    Root targetElement = getCorrespondingElement(
    	getCorrepondenceSourceTargetElement(root, removedAttributeValue), // correspondence source supplier
    	Root.class,
    ...
    new mir.routines.simpleChangesTests.RemoveEAttributeEffect.EffectUserExecution(getExecutionState(), this).executeUserOperations(
