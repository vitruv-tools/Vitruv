...
public class ExecutorAllElementTypesToAllElementTypes extends AbstractResponseExecutor {
  ...
  protected void setup() {
    this.addResponse(mir.responses.responsesAllElementTypesToAllElementTypes.simpleChangesTests.SetSingleValuedEAttributeResponse.getExpectedChangeType(), new mir.responses.responsesAllElementTypesToAllElementTypes.simpleChangesTests.SetSingleValuedEAttributeResponse(userInteracting));
