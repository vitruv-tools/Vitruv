...
class DeleteRootTestResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    new mir.responses.responsesAllElementTypesToAllElementTypes.simpleChangesTests.DeleteRootTestResponse.CallRoutinesUserExecution(this.executionState, this).executeUserOperations(typedChange);
  }
