...
class RemovedEAttributeValueResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    new mir.responses.responsesAllElementTypesToAllElementTypes.simpleChangesTests.RemovedEAttributeValueResponse.CallRoutinesUserExecution(this.executionState, this).executeUserOperations(typedChange);
  }
