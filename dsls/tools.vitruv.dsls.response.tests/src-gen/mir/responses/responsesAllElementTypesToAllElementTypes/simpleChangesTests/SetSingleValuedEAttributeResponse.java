...
class SetSingleValuedEAttributeResponse extends AbstractResponseRealization {
  public SetSingleValuedEAttributeResponse(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.simpleChangesTests.SetSingleValuedEAttributeEffect effect = new mir.routines.simpleChangesTests.SetSingleValuedEAttributeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
