 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.reactionsLanguage.impl.AtomicRootObjectChangeImpl#getChangedElement <em>Changed Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtomicRootObjectChangeImpl extends AtomicConcreteModelElementChangeImpl implements AtomicRootObjectChange
{
  ...
  {
    return ReactionsLanguagePackage.Literals.ATOMIC_ROOT_OBJECT_CHANGE;
  }
  ...
  public NotificationChain basicSetChangedElement(MetaclassReference newChangedElement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReactionsLanguagePackage.ATOMIC_ROOT_OBJECT_CHANGE__CHANGED_ELEMENT, oldChangedElement, newChangedElement);
  ...
  public void setChangedElement(MetaclassReference newChangedElement)
  {
    if (newChangedElement != changedElement)
    {
      ...
      if (changedElement != null)
        msgs = ((InternalEObject)changedElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReactionsLanguagePackage.ATOMIC_ROOT_OBJECT_CHANGE__CHANGED_ELEMENT, null, msgs);
      if (newChangedElement != null)
        msgs = ((InternalEObject)newChangedElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReactionsLanguagePackage.ATOMIC_ROOT_OBJECT_CHANGE__CHANGED_ELEMENT, null, msgs);
      msgs = basicSetChangedElement(newChangedElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReactionsLanguagePackage.ATOMIC_ROOT_OBJECT_CHANGE__CHANGED_ELEMENT, newChangedElement, newChangedElement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReactionsLanguagePackage.ATOMIC_ROOT_OBJECT_CHANGE__CHANGED_ELEMENT:
