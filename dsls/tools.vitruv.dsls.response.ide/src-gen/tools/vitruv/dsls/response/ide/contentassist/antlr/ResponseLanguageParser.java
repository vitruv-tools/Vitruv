...
public class ResponseLanguageParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getResponsesSegmentAccess().getAlternatives_6(), "rule__ResponsesSegment__Alternatives_6");
					...
					put(grammarAccess.getEffectStatementAccess().getAlternatives(), "rule__EffectStatement__Alternatives");
					...
					put(grammarAccess.getCreateElementAccess().getGroup(), "rule__CreateElement__Group__0");
					put(grammarAccess.getCreateElementAccess().getGroup_3(), "rule__CreateElement__Group_3__0");
					put(grammarAccess.getDeleteElementAccess().getGroup(), "rule__DeleteElement__Group__0");
					put(grammarAccess.getUpdateElementAccess().getGroup(), "rule__UpdateElement__Group__0");
					...
					put(grammarAccess.getResponseFileAccess().getNamespaceImportsAssignment_0(), "rule__ResponseFile__NamespaceImportsAssignment_0");
					put(grammarAccess.getResponseFileAccess().getResponsesSegmentsAssignment_2(), "rule__ResponseFile__ResponsesSegmentsAssignment_2");
					put(grammarAccess.getResponsesSegmentAccess().getNameAssignment_1(), "rule__ResponsesSegment__NameAssignment_1");
					put(grammarAccess.getResponsesSegmentAccess().getFromMetamodelAssignment_3(), "rule__ResponsesSegment__FromMetamodelAssignment_3");
					put(grammarAccess.getResponsesSegmentAccess().getToMetamodelAssignment_5(), "rule__ResponsesSegment__ToMetamodelAssignment_5");
					put(grammarAccess.getResponsesSegmentAccess().getResponsesAssignment_6_0(), "rule__ResponsesSegment__ResponsesAssignment_6_0");
					put(grammarAccess.getResponsesSegmentAccess().getRoutinesAssignment_6_1(), "rule__ResponsesSegment__RoutinesAssignment_6_1");
					...
					put(grammarAccess.getResponseAccess().getTriggerAssignment_4(), "rule__Response__TriggerAssignment_4");
					put(grammarAccess.getResponseAccess().getCallRoutineAssignment_5(), "rule__Response__CallRoutineAssignment_5");
					...
					put(grammarAccess.getRoutineAccess().getEffectAssignment_7(), "rule__Routine__EffectAssignment_7");
					...
					put(grammarAccess.getMatcherAccess().getMatcherStatementsAssignment_3(), "rule__Matcher__MatcherStatementsAssignment_3");
					put(grammarAccess.getRetrieveModelElementStatementAccess().getRequiredAssignment_1_0(), "rule__RetrieveModelElementStatement__RequiredAssignment_1_0");
					put(grammarAccess.getRetrieveModelElementStatementAccess().getOptionalAssignment_1_1(), "rule__RetrieveModelElementStatement__OptionalAssignment_1_1");
					put(grammarAccess.getRetrieveModelElementStatementAccess().getAbscenceAssignment_1_2(), "rule__RetrieveModelElementStatement__AbscenceAssignment_1_2");
					put(grammarAccess.getRetrieveModelElementStatementAccess().getElementAssignment_2(), "rule__RetrieveModelElementStatement__ElementAssignment_2");
					...
					put(grammarAccess.getEffectAccess().getEffectStatementsAssignment_3(), "rule__Effect__EffectStatementsAssignment_3");
					put(grammarAccess.getCreateElementAccess().getElementAssignment_2(), "rule__CreateElement__ElementAssignment_2");
					put(grammarAccess.getCreateElementAccess().getInitializationBlockAssignment_3_1(), "rule__CreateElement__InitializationBlockAssignment_3_1");
					put(grammarAccess.getDeleteElementAccess().getElementAssignment_2(), "rule__DeleteElement__ElementAssignment_2");
					put(grammarAccess.getUpdateElementAccess().getElementAssignment_2(), "rule__UpdateElement__ElementAssignment_2");
					put(grammarAccess.getUpdateElementAccess().getUpdateBlockAssignment_3(), "rule__UpdateElement__UpdateBlockAssignment_3");
					put(grammarAccess.getCreateCorrespondenceAccess().getFirstElementAssignment_2(), "rule__CreateCorrespondence__FirstElementAssignment_2");
					put(grammarAccess.getCreateCorrespondenceAccess().getSecondElementAssignment_4(), "rule__CreateCorrespondence__SecondElementAssignment_4");
					put(grammarAccess.getRemoveCorrespondenceAccess().getFirstElementAssignment_2(), "rule__RemoveCorrespondence__FirstElementAssignment_2");
					put(grammarAccess.getRemoveCorrespondenceAccess().getSecondElementAssignment_4(), "rule__RemoveCorrespondence__SecondElementAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			...
			typedParser.entryRuleResponseFile();
