		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getResponsesSegmentAccess().getFromMetamodelAssignment_1(), "rule__ResponsesSegment__FromMetamodelAssignment_1");
					put(grammarAccess.getResponsesSegmentAccess().getToMetamodelAssignment_3(), "rule__ResponsesSegment__ToMetamodelAssignment_3");
					put(grammarAccess.getResponsesSegmentAccess().getNameAssignment_5(), "rule__ResponsesSegment__NameAssignment_5");
					...
					put(grammarAccess.getEffectAccess().getElementDeletionAssignment_2_1(), "rule__Effect__ElementDeletionAssignment_2_1");
					put(grammarAccess.getEffectAccess().getCorrespondenceCreationAssignment_2_2(), "rule__Effect__CorrespondenceCreationAssignment_2_2");
