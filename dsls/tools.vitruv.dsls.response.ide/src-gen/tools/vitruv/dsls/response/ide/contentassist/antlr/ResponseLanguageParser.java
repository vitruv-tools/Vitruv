		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCreateCorrespondenceAccess().getGroup_4(), "rule__CreateCorrespondence__Group_4__0");
					...
					put(grammarAccess.getEffectAccess().getElementCreationAssignment_3_0(), "rule__Effect__ElementCreationAssignment_3_0");
					put(grammarAccess.getEffectAccess().getElementDeletionAssignment_3_1(), "rule__Effect__ElementDeletionAssignment_3_1");
					put(grammarAccess.getEffectAccess().getCorrespondenceCreationAssignment_3_2(), "rule__Effect__CorrespondenceCreationAssignment_3_2");
					put(grammarAccess.getEffectAccess().getCorrespondenceDeletionAssignment_3_3(), "rule__Effect__CorrespondenceDeletionAssignment_3_3");
					put(grammarAccess.getEffectAccess().getCodeBlockAssignment_4_1(), "rule__Effect__CodeBlockAssignment_4_1");
					put(grammarAccess.getEffectAccess().getCallRoutineAssignment_5(), "rule__Effect__CallRoutineAssignment_5");
					...
					put(grammarAccess.getRetrieveModelElementAccess().getAbscenceAssignment_0_2(), "rule__RetrieveModelElement__AbscenceAssignment_0_2");
					put(grammarAccess.getRetrieveModelElementAccess().getElementAssignment_1(), "rule__RetrieveModelElement__ElementAssignment_1");
					put(grammarAccess.getRetrieveModelElementAccess().getCorrespondenceSourceAssignment_3(), "rule__RetrieveModelElement__CorrespondenceSourceAssignment_3");
					put(grammarAccess.getRetrieveModelElementAccess().getPreconditionAssignment_5_1(), "rule__RetrieveModelElement__PreconditionAssignment_5_1");
					put(grammarAccess.getCreateElementAccess().getElementAssignment_1(), "rule__CreateElement__ElementAssignment_1");
					put(grammarAccess.getDeleteElementAccess().getElementAssignment_1(), "rule__DeleteElement__ElementAssignment_1");
					put(grammarAccess.getCreateCorrespondenceAccess().getFirstElementAssignment_1(), "rule__CreateCorrespondence__FirstElementAssignment_1");
					put(grammarAccess.getCreateCorrespondenceAccess().getSecondElementAssignment_3(), "rule__CreateCorrespondence__SecondElementAssignment_3");
					put(grammarAccess.getRemoveCorrespondenceAccess().getFirstElementAssignment_1(), "rule__RemoveCorrespondence__FirstElementAssignment_1");
					put(grammarAccess.getRemoveCorrespondenceAccess().getSecondElementAssignment_3(), "rule__RemoveCorrespondence__SecondElementAssignment_3");
