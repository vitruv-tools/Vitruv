		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRoutineAccess().getMatchingAssignment_6(), "rule__Routine__MatchingAssignment_6");
					...
					put(grammarAccess.getMatchingAccess().getMatcherStatementsAssignment_3(), "rule__Matching__MatcherStatementsAssignment_3");
