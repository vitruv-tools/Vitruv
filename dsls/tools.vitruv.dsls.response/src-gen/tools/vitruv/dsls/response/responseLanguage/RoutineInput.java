 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.response.responseLanguage.RoutineInput#getModelInputElements <em>Model Input Elements</em>}</li>
 *   <li>{@link tools.vitruv.dsls.response.responseLanguage.RoutineInput#getJavaInputElements <em>Java Input Elements</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.dsls.response.responseLanguage.ResponseLanguagePackage#getRoutineInput()
 * @model
 * @generated
 */
public interface RoutineInput extends EObject
{
   ...
   * @see tools.vitruv.dsls.response.responseLanguage.ResponseLanguagePackage#getRoutineInput_ModelInputElements()
   ...
   * @see tools.vitruv.dsls.response.responseLanguage.ResponseLanguagePackage#getRoutineInput_JavaInputElements()
   * @model containment="true"
   * @generated
   */
