 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.response.responseLanguage.impl.RoutineCallBlockImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoutineCallBlockImpl extends CodeBlockImpl implements RoutineCallBlock
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.ROUTINE_CALL_BLOCK__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ResponseLanguagePackage.ROUTINE_CALL_BLOCK__NAME:
        return getName();
    }
