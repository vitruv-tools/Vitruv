...
public class InputTypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InputTypesPackage.STRING: {
				tools.vitruv.dsls.response.responseLanguage.inputTypes.String string = (tools.vitruv.dsls.response.responseLanguage.inputTypes.String)theEObject;
	 ...
	 * @generated
	 */
	public T caseString(tools.vitruv.dsls.response.responseLanguage.inputTypes.String object) {
		return null;
	}
