 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.mapping.mappingLanguage.impl.SignatureImpl#getDeclaredPackage <em>Declared Package</em>}</li>
 *   <li>{@link tools.vitruv.dsls.mapping.mappingLanguage.impl.SignatureImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignatureImpl extends MinimalEObjectImpl.Container implements Signature
{
   ...
   * @ordered
   */
  protected EList<NamedMetaclassReference> elements;
   ...
   * @generated
   */
  public EList<NamedMetaclassReference> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<NamedMetaclassReference>(NamedMetaclassReference.class, this, MappingLanguagePackage.SIGNATURE__ELEMENTS);
    }
    return elements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MappingLanguagePackage.SIGNATURE__ELEMENTS:
        getElements().clear();
        getElements().addAll((Collection<? extends NamedMetaclassReference>)newValue);
        return;
    }
