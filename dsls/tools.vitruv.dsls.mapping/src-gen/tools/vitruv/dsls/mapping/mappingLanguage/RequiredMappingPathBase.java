 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.mapping.mappingLanguage.RequiredMappingPathBase#getRequiredMapping <em>Required Mapping</em>}</li>
 *   <li>{@link tools.vitruv.dsls.mapping.mappingLanguage.RequiredMappingPathBase#getTail <em>Tail</em>}</li>
 * </ul>
 *
 * @see tools.vitruv.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathBase()
 * @model
 * @generated
 */
public interface RequiredMappingPathBase extends EObject
{
   ...
   * @see tools.vitruv.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathBase_RequiredMapping()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.dsls.mapping.mappingLanguage.RequiredMappingPathBase#getRequiredMapping <em>Required Mapping</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see tools.vitruv.dsls.mapping.mappingLanguage.MappingLanguagePackage#getRequiredMappingPathBase_Tail()
  ...
  /**
   * Sets the value of the '{@link tools.vitruv.dsls.mapping.mappingLanguage.RequiredMappingPathBase#getTail <em>Tail</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
