 ...
 * </p>
 * <ul>
 *   <li>{@link multicontainment_a.impl.IdentifiedImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiedImpl extends MinimalEObjectImpl.Container implements Identified {
	...
	protected EClass eStaticClass() {
		return Multicontainment_aPackage.Literals.IDENTIFIED;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Multicontainment_aPackage.IDENTIFIED__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Multicontainment_aPackage.IDENTIFIED__ID:
				return getId();
		}
