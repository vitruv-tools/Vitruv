 ...
 * </p>
 * <ul>
 *   <li>{@link pcm_mockup.impl.RepositoryImpl#getName <em>Name</em>}</li>
...
public class RepositoryImpl extends IdentifiedImpl implements Repository {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pcm_mockupPackage.REPOSITORY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pcm_mockupPackage.REPOSITORY__NAME:
				return getName();
			case Pcm_mockupPackage.REPOSITORY__INTERFACES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PNamedElement.class) {
			switch (derivedFeatureID) {
				case Pcm_mockupPackage.REPOSITORY__NAME: return Pcm_mockupPackage.PNAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PNamedElement.class) {
			switch (baseFeatureID) {
				case Pcm_mockupPackage.PNAMED_ELEMENT__NAME: return Pcm_mockupPackage.REPOSITORY__NAME;
				default: return -1;
			}
		}
