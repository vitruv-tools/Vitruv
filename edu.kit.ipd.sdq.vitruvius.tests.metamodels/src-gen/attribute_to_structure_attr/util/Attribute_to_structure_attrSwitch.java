...
public class Attribute_to_structure_attrSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Attribute_to_structure_attrPackage.IDENTIFIED: {
				Identified identified = (Identified)theEObject;
				T result = caseIdentified(identified);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Attribute_to_structure_attrPackage.MODEL_A: {
				ModelA modelA = (ModelA)theEObject;
				T result = caseModelA(modelA);
				if (result == null) result = caseIdentified(modelA);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseModelA(ModelA object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attributed</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Attributed</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAttributed(Attributed object) {
		return null;
	}
...
} //Attribute_to_structure_attrSwitch
