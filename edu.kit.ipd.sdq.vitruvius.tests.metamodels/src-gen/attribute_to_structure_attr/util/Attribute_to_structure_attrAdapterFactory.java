...
public class Attribute_to_structure_attrAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Attribute_to_structure_attrSwitch<Adapter> modelSwitch =
		new Attribute_to_structure_attrSwitch<Adapter>() {
			@Override
			public Adapter caseIdentified(Identified object) {
				return createIdentifiedAdapter();
			}
			@Override
			public Adapter caseModelA(ModelA object) {
				return createModelAAdapter();
			}
			@Override
			public Adapter caseAttributed(Attributed object) {
				return createAttributedAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link attribute_to_structure_attr.Identified <em>Identified</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link attribute_to_structure_attr.ModelA <em>Model A</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link attribute_to_structure_attr.Attributed <em>Attributed</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //Attribute_to_structure_attrAdapterFactory
