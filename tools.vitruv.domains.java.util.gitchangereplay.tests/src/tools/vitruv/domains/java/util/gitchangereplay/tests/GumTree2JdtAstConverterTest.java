package tools.vitruv.domains.java.util.gitchangereplay.tests;
...
import tools.vitruv.domains.java.util.gitchangereplay.converters.GumTree2JdtAstConverterImpl;
...
public class GumTree2JdtAstConverterTest {
	...
	private static final String TEST_BUNDLE_NAME = "tools.vitruv.domains.java.util.gitchangereplay.tests";
