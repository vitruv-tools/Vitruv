 ...
 * </p>
 * <ul>
 *   <li>{@link attribute_to_structure_attr.impl.IdentifiedImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiedImpl extends MinimalEObjectImpl.Container implements Identified {
	...
	protected EClass eStaticClass() {
		return Attribute_to_structure_attrPackage.Literals.IDENTIFIED;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Attribute_to_structure_attrPackage.IDENTIFIED__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Attribute_to_structure_attrPackage.IDENTIFIED__ID:
				return getId();
		}
