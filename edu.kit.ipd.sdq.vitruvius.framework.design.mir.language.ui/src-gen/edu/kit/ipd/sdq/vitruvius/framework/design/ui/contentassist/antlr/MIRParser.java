...
* generated by Xtext
*/
package edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr;
...
public class MIRParser extends AbstractContentAssistParser {
	...
	@Override
	protected edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr.internal.InternalMIRParser createParser() {
		edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr.internal.InternalMIRParser result = new edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr.internal.InternalMIRParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getResponseAccess().getAlternatives(), "rule__Response__Alternatives");
					put(grammarAccess.getOperationRestrictionAccess().getAlternatives(), "rule__OperationRestriction__Alternatives");
					put(grammarAccess.getMetaclassOperationTypeAccess().getAlternatives(), "rule__MetaclassOperationType__Alternatives");
					put(grammarAccess.getPackageQualifiedIDAccess().getAlternatives_3(), "rule__PackageQualifiedID__Alternatives_3");
					...
					put(grammarAccess.getMappingBaseAccess().getGroup(), "rule__MappingBase__Group__0");
					put(grammarAccess.getMappingBaseAccess().getGroup_0(), "rule__MappingBase__Group_0__0");
					put(grammarAccess.getMappingBaseAccess().getGroup_3(), "rule__MappingBase__Group_3__0");
					...
					put(grammarAccess.getResponseAccess().getGroup_0(), "rule__Response__Group_0__0");
					put(grammarAccess.getResponseAccess().getGroup_1(), "rule__Response__Group_1__0");
					put(grammarAccess.getResponseAccess().getGroup_1_0(), "rule__Response__Group_1_0__0");
					put(grammarAccess.getOperationRestrictionAccess().getGroup_0(), "rule__OperationRestriction__Group_0__0");
					put(grammarAccess.getMetalclassOperationRestrictionAccess().getGroup(), "rule__MetalclassOperationRestriction__Group__0");
					put(grammarAccess.getFeatureOperationRestrictionAccess().getGroup(), "rule__FeatureOperationRestriction__Group__0");
					put(grammarAccess.getInvariantRestrictionAccess().getGroup(), "rule__InvariantRestriction__Group__0");
					put(grammarAccess.getInvariantRestrictionAccess().getGroup_3(), "rule__InvariantRestriction__Group_3__0");
					put(grammarAccess.getCpxIDAccess().getGroup(), "rule__CpxID__Group__0");
					put(grammarAccess.getCpxIDAccess().getGroup_1(), "rule__CpxID__Group_1__0");
					put(grammarAccess.getNsPrefixQualifiedIDAccess().getGroup(), "rule__NsPrefixQualifiedID__Group__0");
					put(grammarAccess.getPackageQualifiedIDAccess().getGroup(), "rule__PackageQualifiedID__Group__0");
					put(grammarAccess.getPackageQualifiedIDAccess().getGroup_1(), "rule__PackageQualifiedID__Group_1__0");
					...
					put(grammarAccess.getModelAccess().getMmImportsAssignment_0(), "rule__Model__MmImportsAssignment_0");
					put(grammarAccess.getModelAccess().getJavaImportSectionAssignment_1(), "rule__Model__JavaImportSectionAssignment_1");
					put(grammarAccess.getModelAccess().getMappingsAssignment_2(), "rule__Model__MappingsAssignment_2");
					put(grammarAccess.getModelAccess().getInvariantsAssignment_3(), "rule__Model__InvariantsAssignment_3");
					put(grammarAccess.getModelAccess().getGlobalVariablesAssignment_4(), "rule__Model__GlobalVariablesAssignment_4");
					put(grammarAccess.getModelAccess().getResponesAssignment_5(), "rule__Model__ResponesAssignment_5");
					put(grammarAccess.getImportAccess().getNsURIAssignment_1(), "rule__Import__NsURIAssignment_1");
					put(grammarAccess.getImportAccess().getMmNsPrefixAssignment_3(), "rule__Import__MmNsPrefixAssignment_3");
					put(grammarAccess.getMMNsPrefixAccess().getNsPrefixAssignment(), "rule__MMNsPrefix__NsPrefixAssignment");
					put(grammarAccess.getMappingBaseAccess().getNameAAssignment_0_0(), "rule__MappingBase__NameAAssignment_0_0");
					put(grammarAccess.getMappingBaseAccess().getMetaclassAAssignment_1(), "rule__MappingBase__MetaclassAAssignment_1");
					put(grammarAccess.getMappingBaseAccess().getNameBAssignment_3_0(), "rule__MappingBase__NameBAssignment_3_0");
					put(grammarAccess.getMappingBaseAccess().getMetaclassBAssignment_4(), "rule__MappingBase__MetaclassBAssignment_4");
					put(grammarAccess.getMappingBaseAccess().getWhensAssignment_6(), "rule__MappingBase__WhensAssignment_6");
					put(grammarAccess.getMappingBaseAccess().getWithsAssignment_7(), "rule__MappingBase__WithsAssignment_7");
					put(grammarAccess.getWhenAccess().getXorExpressionAssignment_1(), "rule__When__XorExpressionAssignment_1");
					put(grammarAccess.getInvariantAccess().getNameAssignment_3(), "rule__Invariant__NameAssignment_3");
					put(grammarAccess.getInvariantAccess().getParametersAssignment_4(), "rule__Invariant__ParametersAssignment_4");
					put(grammarAccess.getInvariantAccess().getXorExpressionAssignment_6(), "rule__Invariant__XorExpressionAssignment_6");
					put(grammarAccess.getParameterAccess().getNameAssignment_0_0(), "rule__Parameter__NameAssignment_0_0");
					put(grammarAccess.getParameterAccess().getMetaclassAssignment_1(), "rule__Parameter__MetaclassAssignment_1");
					put(grammarAccess.getGlobalVariableAccess().getNameAssignment_1(), "rule__GlobalVariable__NameAssignment_1");
					put(grammarAccess.getGlobalVariableAccess().getJvmTypeReferenceAssignment_3(), "rule__GlobalVariable__JvmTypeReferenceAssignment_3");
					put(grammarAccess.getResponseAccess().getOperationRestrictionAssignment_0_0(), "rule__Response__OperationRestrictionAssignment_0_0");
					put(grammarAccess.getResponseAccess().getInvariantRestrictionAssignment_0_1(), "rule__Response__InvariantRestrictionAssignment_0_1");
					put(grammarAccess.getResponseAccess().getOperationRestrictionAssignment_1_0_0(), "rule__Response__OperationRestrictionAssignment_1_0_0");
					put(grammarAccess.getResponseAccess().getInvariantRestrictionAssignment_1_0_1(), "rule__Response__InvariantRestrictionAssignment_1_0_1");
					put(grammarAccess.getResponseAccess().getXtendStmtAssignment_1_3(), "rule__Response__XtendStmtAssignment_1_3");
					put(grammarAccess.getFeatureOperationRestrictionAccess().getFeatureAssignment_4(), "rule__FeatureOperationRestriction__FeatureAssignment_4");
					put(grammarAccess.getInvariantRestrictionAccess().getNameAssignment_2(), "rule__InvariantRestriction__NameAssignment_2");
					put(grammarAccess.getInvariantRestrictionAccess().getParametersAssignment_3_1(), "rule__InvariantRestriction__ParametersAssignment_3_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr.internal.InternalMIRParser typedParser = (edu.kit.ipd.sdq.vitruvius.framework.design.ui.contentassist.antlr.internal.InternalMIRParser) parser;
