...
/**
 * Manual modifications go to {edu.kit.ipd.sdq.vitruvius.framework.design.MIRRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractMIRRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "edu/kit/ipd/sdq/vitruvius/framework/design/MIR.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("edu.kit.ipd.sdq.vitruvius.framework.design.MIR");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("mir");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.services.MIRGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.serializer.MIRSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.serializer.MIRSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.MIRParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.MIRAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.internal.InternalMIRLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.internal.InternalMIRLexer> provideInternalMIRLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.internal.InternalMIRLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(edu.kit.ipd.sdq.vitruvius.framework.design.parser.antlr.internal.InternalMIRLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends edu.kit.ipd.sdq.vitruvius.framework.design.validation.MIRValidator> bindMIRValidator() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.validation.MIRValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.formatting.MIRFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return edu.kit.ipd.sdq.vitruvius.framework.design.jvmmodel.MIRJvmModelInferrer.class;
	}
