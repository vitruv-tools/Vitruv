 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.domains.jml.language.jML.impl.SwitchExpressionImpl#getDeclaredParam <em>Declared Param</em>}</li>
 *   <li>{@link tools.vitruvius.domains.jml.language.jML.impl.SwitchExpressionImpl#getSwitch <em>Switch</em>}</li>
 *   <li>{@link tools.vitruvius.domains.jml.language.jML.impl.SwitchExpressionImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link tools.vitruvius.domains.jml.language.jML.impl.SwitchExpressionImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
