 ...
 */
package tools.vitruvius.dsls.response.ide.contentassist.antlr;

import com.google.inject.Inject;
import tools.vitruvius.dsls.response.ide.contentassist.antlr.internal.InternalResponseLanguageParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEffectAccess().getCorrespondenceCreationAssignment_3_0(), "rule__Effect__CorrespondenceCreationAssignment_3_0");
					put(grammarAccess.getEffectAccess().getCorrespondenceDeletionAssignment_3_1(), "rule__Effect__CorrespondenceDeletionAssignment_3_1");
