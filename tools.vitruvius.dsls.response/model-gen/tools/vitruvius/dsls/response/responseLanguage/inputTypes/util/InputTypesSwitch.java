/**
 */
package tools.vitruvius.dsls.response.responseLanguage.inputTypes.util;
...
public class InputTypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InputTypesPackage.STRING: {
				tools.vitruvius.dsls.response.responseLanguage.inputTypes.String string = (tools.vitruvius.dsls.response.responseLanguage.inputTypes.String)theEObject;
	 ...
	 * @generated
	 */
	public T caseString(tools.vitruvius.dsls.response.responseLanguage.inputTypes.String object) {
		return null;
	}
