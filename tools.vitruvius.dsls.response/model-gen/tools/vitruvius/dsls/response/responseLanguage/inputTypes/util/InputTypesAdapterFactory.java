...
public class InputTypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected InputTypesSwitch<Adapter> modelSwitch =
		new InputTypesSwitch<Adapter>() {
			@Override
			public Adapter caseString(tools.vitruvius.dsls.response.responseLanguage.inputTypes.String object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruvius.dsls.response.responseLanguage.inputTypes.String <em>String</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruvius.dsls.response.responseLanguage.inputTypes.Int <em>Int</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
