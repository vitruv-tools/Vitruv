 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruvius.dsls.response.responseLanguage.impl.InvariantViolationEventImpl#getViolation <em>Violation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvariantViolationEventImpl extends TriggerImpl implements InvariantViolationEvent
{
  ...
  {
    return ResponseLanguagePackage.Literals.INVARIANT_VIOLATION_EVENT;
  }
    ...
    if (violation != null && violation.eIsProxy())
    {
      ...
      if (violation != oldViolation)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResponseLanguagePackage.INVARIANT_VIOLATION_EVENT__VIOLATION, oldViolation, violation));
      }
    }
    return violation;
  }
  ...
  public void setViolation(EClass newViolation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ResponseLanguagePackage.INVARIANT_VIOLATION_EVENT__VIOLATION, oldViolation, violation));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ResponseLanguagePackage.INVARIANT_VIOLATION_EVENT__VIOLATION:
