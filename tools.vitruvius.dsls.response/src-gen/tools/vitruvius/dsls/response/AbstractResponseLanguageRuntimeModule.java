...
import tools.vitruvius.dsls.response.jvmmodel.ResponseLanguageJvmModelInferrer;
import tools.vitruvius.dsls.response.parser.antlr.ResponseLanguageAntlrTokenFileProvider;
import tools.vitruvius.dsls.response.parser.antlr.ResponseLanguageParser;
import tools.vitruvius.dsls.response.parser.antlr.internal.InternalResponseLanguageLexer;
import tools.vitruvius.dsls.response.scoping.ResponseLanguageScopeProvider;
import tools.vitruvius.dsls.response.serializer.ResponseLanguageSemanticSequencer;
import tools.vitruvius.dsls.response.serializer.ResponseLanguageSyntacticSequencer;
import tools.vitruvius.dsls.response.services.ResponseLanguageGrammarAccess;
import tools.vitruvius.dsls.response.validation.ResponseLanguageValidator;
...
public abstract class AbstractResponseLanguageRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "tools.vitruvius/dsls/response/ResponseLanguage.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("tools.vitruvius.dsls.response.ResponseLanguage");
	}
