package tools.vitruvius.extensions.constructionsimulation.invariantcheckers;
...
public abstract class StandardInvariantEnforcer<T extends EObject> extends InvariantEnforcer {
     ...
     * 
     * @see
     * tools.vitruvius.integration.invariantChecker.InvariantEnforcer#loadModelRoot(org
     ...
     * 
     * @see
     * tools.vitruvius.integration.invariantChecker.InvariantEnforcer#enforceInvariant()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see tools.vitruvius.integration.invariantChecker.InvariantEnforcer#returnModel()
     */
    @Override
