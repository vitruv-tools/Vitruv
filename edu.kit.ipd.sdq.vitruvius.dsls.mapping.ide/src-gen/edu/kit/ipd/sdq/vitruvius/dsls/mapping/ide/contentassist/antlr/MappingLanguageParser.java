		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSignatureAccess().getElementsAssignment_2_0(), "rule__Signature__ElementsAssignment_2_0");
					put(grammarAccess.getSignatureAccess().getElementsAssignment_2_1_1(), "rule__Signature__ElementsAssignment_2_1_1");
