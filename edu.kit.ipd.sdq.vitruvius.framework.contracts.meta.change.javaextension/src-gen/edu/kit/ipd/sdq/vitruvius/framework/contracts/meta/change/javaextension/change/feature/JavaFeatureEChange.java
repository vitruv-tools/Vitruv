 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.change.javaextension.change.feature.JavaFeatureEChange#getOldAffectedEObject <em>Old Affected EObject</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.change.javaextension.change.feature.FeaturePackage#getJavaFeatureEChange()
 * @model
 * @generated
 */
public interface JavaFeatureEChange<A extends EObject, F extends EStructuralFeature> extends FeatureEChange<A, F> {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.change.javaextension.change.feature.FeaturePackage#getJavaFeatureEChange_OldAffectedEObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.contracts.meta.change.javaextension.change.feature.JavaFeatureEChange#getOldAffectedEObject <em>Old Affected EObject</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
