 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getSubtractWhereChange <em>Subtract Where Change</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getSubtractWhatChange <em>Subtract What Change</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getAddWhereChange <em>Add Where Change</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getAddWhatChange <em>Add What Change</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage#getMoveEObject()
 * @model
 * @generated
 */
public interface MoveEObject<A extends EObject, B extends EObject, T extends EObject> extends CompoundEChange {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage#getMoveEObject_SubtractWhereChange()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getSubtractWhereChange <em>Subtract Where Change</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage#getMoveEObject_SubtractWhatChange()
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getSubtractWhatChange <em>Subtract What Change</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage#getMoveEObject_AddWhereChange()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getAddWhereChange <em>Add Where Change</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage#getMoveEObject_AddWhatChange()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.MoveEObject#getAddWhatChange <em>Add What Change</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
