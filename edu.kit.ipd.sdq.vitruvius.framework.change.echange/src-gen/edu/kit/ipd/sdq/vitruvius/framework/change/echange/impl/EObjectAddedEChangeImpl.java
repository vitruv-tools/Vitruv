 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.impl.EObjectAddedEChangeImpl#getNewValue <em>New Value</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.impl.EObjectAddedEChangeImpl#isIsCreate <em>Is Create</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EObjectAddedEChangeImpl<T extends EObject> extends edu.kit.ipd.sdq.vitruvius.framework.change.echange.impl.AdditiveEChangeImpl<T> implements EObjectAddedEChange<T> {
    /**
