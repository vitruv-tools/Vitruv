package edu.kit.ipd.sdq.vitruvius.extensions.constructionsimulation;
...
public class LoggerConfigurator {
    ...
    public static void clearLogFile() {
        final Bundle bundle = Platform.getBundle("edu.kit.ipd.sdq.vitruvius.integration");
    ...
    public static void configureLogger(File logFile) {
        Bundle bundle = Platform.getBundle("edu.kit.ipd.sdq.vitruvius.integration");
