...
import edu.kit.ipd.sdq.vitruvius.integration.traversal.composite.CompositeTraversalStrategy;
...
public class PCMRepositoryIntegrationStrategy extends PCMIntegrationStrategy {
    ...
    protected EList<Change> createChangeModels(final IResource originalResource, final Resource validModel) {
        ...
        final Repository repository = (Repository) extractor.getImpl(validModel);
