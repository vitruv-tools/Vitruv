 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.list.PermuteListEChange#getNewIndicesForElementsAtOldIndices <em>New Indices For Elements At Old Indices</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.list.ListPackage#getPermuteListEChange()
 * @model abstract="true"
 * @generated
 */
public interface PermuteListEChange<A extends EObject, F extends EStructuralFeature> extends UpdateMultiValuedFeatureEChange<A, F> {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.list.ListPackage#getPermuteListEChange_NewIndicesForElementsAtOldIndices()
	 * @model required="true"
	 * @generated
	 */
