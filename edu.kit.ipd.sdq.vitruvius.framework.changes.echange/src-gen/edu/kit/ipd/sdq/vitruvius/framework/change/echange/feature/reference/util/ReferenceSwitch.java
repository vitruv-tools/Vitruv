...
public class ReferenceSwitch<T1> extends Switch<T1> {
    ...
    protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReferencePackage.UPDATE_REFERENCE_ECHANGE: {
				edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.reference.UpdateReferenceEChange<?> updateReferenceEChange = (edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.reference.UpdateReferenceEChange<?>)theEObject;
	 ...
	 * @generated
	 */
	public <A extends EObject> T1 caseUpdateReferenceEChange(edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.reference.UpdateReferenceEChange<A> object) {
		return null;
	}
