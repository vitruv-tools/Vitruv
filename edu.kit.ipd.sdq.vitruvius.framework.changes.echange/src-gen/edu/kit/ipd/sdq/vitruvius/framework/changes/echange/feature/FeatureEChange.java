 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeatureEChange#getAffectedFeature <em>Affected Feature</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeatureEChange#getAffectedEObject <em>Affected EObject</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeaturePackage#getFeatureEChange()
 * @model abstract="true"
 * @generated
 */
public interface FeatureEChange<A extends EObject, F extends EStructuralFeature> extends AtomicEChange {
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeaturePackage#getFeatureEChange_AffectedFeature()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeatureEChange#getAffectedFeature <em>Affected Feature</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeaturePackage#getFeatureEChange_AffectedEObject()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.FeatureEChange#getAffectedEObject <em>Affected EObject</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
