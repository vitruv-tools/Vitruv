/**
 */
package edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.list.impl;
...
import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.impl.CompoundPackageImpl;
...
import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.attribute.impl.AttributePackageImpl;

import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.impl.FeaturePackageImpl;

import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.list.InsertInListEChange;
import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.list.ListFactory;
...
import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.reference.impl.ReferencePackageImpl;

import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.impl.ChangePackageImpl;

import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.root.RootPackage;

import edu.kit.ipd.sdq.vitruvius.framework.changes.echange.root.impl.RootPackageImpl;
...
public class ListPackageImpl extends EPackageImpl implements ListPackage {
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.feature.list.ListPackage#eNS_URI
     * @see #init()
     * @generated
     */
