...
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.CompoundPackage;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.compound.impl.CompoundPackageImpl;
...
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.attribute.impl.AttributePackageImpl;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.impl.FeaturePackageImpl;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.list.ListPackage;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.list.impl.ListPackageImpl;
...
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.reference.PermuteEReferences;
...
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.impl.EChangePackageImpl;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.root.RootPackage;
import edu.kit.ipd.sdq.vitruvius.framework.change.echange.root.impl.RootPackageImpl;
...
public class ReferencePackageImpl extends EPackageImpl implements ReferencePackage {
	 ...
	 * @see edu.kit.ipd.sdq.vitruvius.framework.change.echange.feature.reference.ReferencePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
