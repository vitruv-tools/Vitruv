 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.impl.EObjectSubtractedEChangeImpl#getOldValue <em>Old Value</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.impl.EObjectSubtractedEChangeImpl#isIsDelete <em>Is Delete</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EObjectSubtractedEChangeImpl<T extends EObject> extends SubtractiveEChangeImpl<T> implements EObjectSubtractedEChange<T> {
    ...
    protected EClass eStaticClass() {
        return ChangePackage.Literals.EOBJECT_SUBTRACTED_ECHANGE;
    }
        ...
        if (oldValue != null && oldValue.eIsProxy()) {
            ...
            if (oldValue != oldOldValue) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChangePackage.EOBJECT_SUBTRACTED_ECHANGE__OLD_VALUE, oldOldValue, oldValue));
            }
        }
        return oldValue;
    }
    ...
    public void setOldValue(T newOldValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ChangePackage.EOBJECT_SUBTRACTED_ECHANGE__OLD_VALUE, oldOldValue, oldValue));
    }
    ...
    public void setIsDelete(boolean newIsDelete) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ChangePackage.EOBJECT_SUBTRACTED_ECHANGE__IS_DELETE, oldIsDelete, isDelete));
    }
