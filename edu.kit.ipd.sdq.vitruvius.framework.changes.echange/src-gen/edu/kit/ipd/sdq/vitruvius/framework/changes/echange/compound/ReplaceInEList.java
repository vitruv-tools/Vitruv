 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.ReplaceInEList#getRemoveChange <em>Remove Change</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.ReplaceInEList#getInsertChange <em>Insert Change</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.CompoundPackage#getReplaceInEList()
 * @model
 * @generated
 */
public interface ReplaceInEList<A extends EObject, F extends EStructuralFeature, T extends EObject, R extends RemoveFromListEChange<A, F> & FeatureEChange<A, F> & SubtractiveEChange<T>, I extends InsertInListEChange<A, F> & FeatureEChange<A, F> & AdditiveEChange<T>> extends CompoundEChange {
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.CompoundPackage#getReplaceInEList_RemoveChange()
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.ReplaceInEList#getRemoveChange <em>Remove Change</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.CompoundPackage#getReplaceInEList_InsertChange()
     * @model containment="true" required="true"
     * @generated
     */
    I getInsertChange();
    ...
    /**
     * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.framework.changes.echange.compound.ReplaceInEList#getInsertChange <em>Insert Change</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
