package tools.vitruvius.applications.pcmjava.reconstructionintegration.invariantcheckers.pcmjamoppenforcer.withocl;
...
import tools.vitruvius.applications.pcmjava.reconstructionintegration.invariantcheckers.PCMRepositorytoJaMoPPInvariantEnforcer;
...
public class PJIE_ComponentInterfaceImplementsAmbiguity extends PCMRepositorytoJaMoPPInvariantEnforcer {
     ...
     * 
     * @see
     * tools.vitruvius.integration.invariantChecker.FixedInvariantEnforcer#enforceInvariant
     * ()
     */
    @Override
    public void enforceInvariant() {
        ...
        final Bundle bundle = Platform
                .getBundle("tools.vitruvius.applications.pcmjava.reconstructionintegration");
