...
import tools.vitruvius.applications.pcmjava.reconstructionintegration.util.PCMChangeBuildHelper;
import tools.vitruvius.extensions.constructionsimulation.traversal.EMFTraversalStrategy;
...
public class RepositoryTraversalStrategy extends EMFTraversalStrategy implements ITraversalStrategy<Repository> {
     ...
     *
     * @see
     * tools.vitruvius.integration.traversal.ITraversalStrategy#traverse(org.eclipse.emf
