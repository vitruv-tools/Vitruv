 ...
 */
package edu.kit.ipd.sdq.vitruvius.dsls.mirbase.services;
...
public class MirBaseGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FeatureOfElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.mirbase.MirBase.FeatureOfElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cElementAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cElementEClassCrossReference_0_0 = (CrossReference)cElementAssignment_0.eContents().get(0);
		private final RuleCall cElementEClassQualifiedNameParserRuleCall_0_0_1 = (RuleCall)cElementEClassCrossReference_0_0.eContents().get(1);
	...
	public class MetamodelReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.mirbase.MirBase.MetamodelReference");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("edu.kit.ipd.sdq.vitruvius.dsls.mirbase.MirBase".equals(grammar.getName())) {
				return grammar;
			}
