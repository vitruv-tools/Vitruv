 ...
 */
package edu.kit.ipd.sdq.vitruvius.dsls.serializer;
...
import edu.kit.ipd.sdq.vitruvius.dsls.mirBase.MetamodelReference;
...
public class MirBaseSemanticSequencer extends XbaseSemanticSequencer {
	...
	protected void sequence_MetamodelImport(ISerializationContext context, MetamodelImport semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MirBasePackage.Literals.METAMODEL_IMPORT__PACKAGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MirBasePackage.Literals.METAMODEL_IMPORT__PACKAGE));
			if (transientValues.isValueTransient(semanticObject, MirBasePackage.Literals.METAMODEL_IMPORT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MirBasePackage.Literals.METAMODEL_IMPORT__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMetamodelImportAccess().getPackageEPackageSTRINGTerminalRuleCall_1_0_1(), semanticObject.getPackage());
		feeder.accept(grammarAccess.getMetamodelImportAccess().getNameValidIDParserRuleCall_3_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     model=[MetamodelImport|ID]
	 */
	protected void sequence_MetamodelReference(ISerializationContext context, MetamodelReference semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MirBasePackage.Literals.METAMODEL_REFERENCE__MODEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MirBasePackage.Literals.METAMODEL_REFERENCE__MODEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMetamodelReferenceAccess().getModelMetamodelImportIDTerminalRuleCall_0_1(), semanticObject.getModel());
		feeder.finish();
	}
