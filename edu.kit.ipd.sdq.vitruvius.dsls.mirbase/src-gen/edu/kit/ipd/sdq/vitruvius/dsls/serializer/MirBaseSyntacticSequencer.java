...
public class MirBaseSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MirBaseGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MirBaseGrammarAccess) access;
