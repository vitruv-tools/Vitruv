 ...
 */
package edu.kit.ipd.sdq.vitruvius.dsls.services;
...
public class MirBaseGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MetamodelImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.MirBase.MetamodelImport");
	...
	public class ModelElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.MirBase.ModelElement");
	...
	public class NamedModelElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.MirBase.NamedModelElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FeatureOfElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.MirBase.FeatureOfElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MetamodelReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "edu.kit.ipd.sdq.vitruvius.dsls.MirBase.MetamodelReference");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("edu.kit.ipd.sdq.vitruvius.dsls.MirBase".equals(grammar.getName())) {
				return grammar;
			}
