...
public interface MirBasePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute '{@link edu.kit.ipd.sdq.vitruvius.dsls.mirbase.mirBase.MetamodelImport#isUseSimpleNames <em>Use Simple Names</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Use Simple Names</em>'.
   * @see edu.kit.ipd.sdq.vitruvius.dsls.mirbase.mirBase.MetamodelImport#isUseSimpleNames()
   * @see #getMetamodelImport()
   * @generated
   */
