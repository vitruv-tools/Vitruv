package tools.vitruvius.applications.pcmjava.tests.ejbtransformations.seffstatements
...
import tools.vitruvius.applications.pcmjava.tests.pojotransformations.seffstatements.IncrementalSEFFReconstructionTest
import tools.vitruvius.applications.pcmjava.tests.ejbtransformations.java2pcm.EJBClassMappingTest
import tools.vitruvius.applications.pcmjava.tests.ejbtransformations.java2pcm.EJBJaMoPP2PCMTransformationTest
