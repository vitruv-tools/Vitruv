...
public class RenameInterfaceRoutine extends AbstractRepairRoutineRealization {
  ...
  private RenameInterfaceRoutine.EffectUserExecution userExecution;
  ...
  public RenameInterfaceRoutine(final ResponseExecutionState responseExecutionState, final CallHierarchyHaving calledBy, final OperationInterface interf) {
    super(responseExecutionState, calledBy);
    this.userExecution = new mir.routines.pcm2java.RenameInterfaceRoutine.EffectUserExecution(getExecutionState(), this);
