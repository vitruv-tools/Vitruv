...
class DeletedCollectionDataTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    new mir.responses.responses5_1ToJava.pcm2java.DeletedCollectionDataTypeResponse.CallRoutinesUserExecution(this.executionState, this).executeUserOperations(typedChange);
  }
