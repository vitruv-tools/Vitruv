...
class DeletedCollectionDataTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.responses.responses5_1ToJava.pcm2java.DeletedCollectionDataTypeResponse.CallRoutinesUserExecution userExecution = new mir.responses.responses5_1ToJava.pcm2java.DeletedCollectionDataTypeResponse.CallRoutinesUserExecution(this.executionState, this);
  ...
  private static class CallRoutinesUserExecution extends AbstractEffectRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference<Repository, DataType> change, @Extension final RoutinesFacade _routinesFacade) {
      DataType _oldValue = change.getOldValue();
      _routinesFacade.deleteJavaClassifier(((CollectionDataType) _oldValue));
    }
  }
}
