...
class ChangedParameterTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.responses.responses5_1ToJava.pcm2java.ChangedParameterTypeResponse.EffectUserExecution userExecution = new mir.responses.responses5_1ToJava.pcm2java.ChangedParameterTypeResponse.EffectUserExecution(this.executionState, this);
