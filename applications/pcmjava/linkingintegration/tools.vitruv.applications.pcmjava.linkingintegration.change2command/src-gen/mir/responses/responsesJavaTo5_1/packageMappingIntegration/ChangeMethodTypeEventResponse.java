...
class ChangeMethodTypeEventResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.responses.responsesJavaTo5_1.packageMappingIntegration.ChangeMethodTypeEventResponse.EffectUserExecution userExecution = new mir.responses.responsesJavaTo5_1.packageMappingIntegration.ChangeMethodTypeEventResponse.EffectUserExecution(this.executionState, this);
