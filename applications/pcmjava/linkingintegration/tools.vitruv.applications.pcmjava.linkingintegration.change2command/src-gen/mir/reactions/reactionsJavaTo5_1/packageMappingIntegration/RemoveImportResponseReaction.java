...
class RemoveImportResponseReaction extends AbstractResponseRealization {
  public RemoveImportResponseReaction(final UserInteracting userInteracting) {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.reactions.reactionsJavaTo5_1.packageMappingIntegration.RemoveImportResponseReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaTo5_1.packageMappingIntegration.RemoveImportResponseReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference<JavaRoot, Import> change, @Extension final RoutinesFacade _routinesFacade) {
    }
  }
}
