...
class CreateClassAnnotationResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.responses.responsesJavaTo5_1.ejbjava2pcm.CreateClassAnnotationResponse.EffectUserExecution userExecution = new mir.responses.responsesJavaTo5_1.ejbjava2pcm.CreateClassAnnotationResponse.EffectUserExecution(this.executionState, this);
