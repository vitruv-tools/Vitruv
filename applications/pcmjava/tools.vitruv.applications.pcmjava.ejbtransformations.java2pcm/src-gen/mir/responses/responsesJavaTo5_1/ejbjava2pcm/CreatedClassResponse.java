...
class CreatedClassResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.responses.responsesJavaTo5_1.ejbjava2pcm.CreatedClassResponse.EffectUserExecution userExecution = new mir.responses.responsesJavaTo5_1.ejbjava2pcm.CreatedClassResponse.EffectUserExecution(this.executionState, this);
