...
import tools.vitruv.applications.jmljava.helper.StringOperationsJaMoPP
...
class Java2JMLCorrespondenceAdder {
	...
	static def addCorrespondencesForCompilationUnit(CompilationUnit javaRoot, tools.vitruv.domains.jml.language.jML.CompilationUnit jmlRoot, CorrespondenceModel ci) {
	...
	static def dispatch Void addCorrespondences(Constructor javaConstructor, JMLSpecifiedElement jmlSpecifiedElement, CorrespondenceModel ci) {
		...
		// member declaration
		val jmlMemberDecl = jmlMemberDeclWithModifier.memberdecl as tools.vitruv.domains.jml.language.jML.Constructor
