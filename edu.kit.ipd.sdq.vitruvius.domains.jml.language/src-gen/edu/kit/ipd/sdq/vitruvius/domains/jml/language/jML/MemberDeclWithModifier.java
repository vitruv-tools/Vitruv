 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.MemberDeclWithModifier#getJmlModifiers <em>Jml Modifiers</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.MemberDeclWithModifier#getMemberdecl <em>Memberdecl</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getMemberDeclWithModifier()
 * @model
 * @generated
 */
public interface MemberDeclWithModifier extends Modifiable
{
   ...
   * The list contents are of type {@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLMemberModifier}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getMemberDeclWithModifier_JmlModifiers()
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getMemberDeclWithModifier_Memberdecl()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.MemberDeclWithModifier#getMemberdecl <em>Memberdecl</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
