 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.impl.CollectionLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionLiteralImpl extends ExpressionImpl implements CollectionLiteral
{
  ...
  {
    return JMLPackage.Literals.COLLECTION_LITERAL;
  }
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, JMLPackage.COLLECTION_LITERAL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JMLPackage.COLLECTION_LITERAL__ELEMENTS:
