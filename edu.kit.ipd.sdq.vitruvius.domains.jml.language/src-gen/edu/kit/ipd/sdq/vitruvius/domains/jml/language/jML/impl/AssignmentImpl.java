 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.impl.AssignmentImpl#getTypeForVariableDeclaration <em>Type For Variable Declaration</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.impl.AssignmentImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.impl.AssignmentImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.impl.AssignmentImpl#getAssignable <em>Assignable</em>}</li>
 * </ul>
 *
 * @generated
 */
