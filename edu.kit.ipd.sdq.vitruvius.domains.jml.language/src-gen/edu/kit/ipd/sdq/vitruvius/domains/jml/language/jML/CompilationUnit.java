 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.CompilationUnit#getPackagedeclaration <em>Packagedeclaration</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.CompilationUnit#getImportdeclaration <em>Importdeclaration</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.CompilationUnit#getTypedeclaration <em>Typedeclaration</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getCompilationUnit()
 * @model
 * @generated
 */
public interface CompilationUnit extends EObject
{
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getCompilationUnit_Packagedeclaration()
  ...
  /**
   * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.CompilationUnit#getPackagedeclaration <em>Packagedeclaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.ImportDeclaration}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getCompilationUnit_Importdeclaration()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.ClassifierDeclarationWithModifier}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getCompilationUnit_Typedeclaration()
   * @model containment="true"
   * @generated
   */
