 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.EnumDeclaration#getImplementedTypes <em>Implemented Types</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.EnumDeclaration#getEnumconstants <em>Enumconstants</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.EnumDeclaration#getBodyDeclarations <em>Body Declarations</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getEnumDeclaration()
 * @model
 * @generated
 */
public interface EnumDeclaration extends ClassDeclaration, AnnotationTypeElementRest, IdentifierHaving
{
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getEnumDeclaration_ImplementedTypes()
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getEnumDeclaration_Enumconstants()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.EnumDeclaration#getEnumconstants <em>Enumconstants</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage#getEnumDeclaration_BodyDeclarations()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.EnumDeclaration#getBodyDeclarations <em>Body Declarations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
