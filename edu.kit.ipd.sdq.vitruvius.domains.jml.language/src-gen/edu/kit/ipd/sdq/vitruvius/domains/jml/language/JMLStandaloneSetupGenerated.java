...
public class JMLStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new edu.kit.ipd.sdq.vitruvius.domains.jml.language.JMLRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.kit.edu/ipd/sdq/vitruvius/domains/jml/language/JML")) {
		EPackage.Registry.INSTANCE.put("http://www.kit.edu/ipd/sdq/vitruvius/domains/jml/language/JML", edu.kit.ipd.sdq.vitruvius.domains.jml.language.jML.JMLPackage.eINSTANCE);
	}
