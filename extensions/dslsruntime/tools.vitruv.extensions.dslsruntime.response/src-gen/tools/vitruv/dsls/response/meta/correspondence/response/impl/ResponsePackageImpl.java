...
import tools.vitruv.dsls.response.meta.correspondence.response.ResponseFactory;
...
public class ResponsePackageImpl extends EPackageImpl implements ResponsePackage {
	 ...
	 * @see tools.vitruv.dsls.response.meta.correspondence.response.ResponsePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
