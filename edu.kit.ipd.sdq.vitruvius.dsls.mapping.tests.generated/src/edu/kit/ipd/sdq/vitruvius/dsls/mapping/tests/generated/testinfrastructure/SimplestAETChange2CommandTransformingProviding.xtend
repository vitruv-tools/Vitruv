...
import responses.simplestAET.responsesAllElementTypes2ToAllElementTypes.ResponseAllElementTypes2ToAllElementTypesExecutor
import responses.simplestAET.responsesAllElementTypesToAllElementTypes2.ResponseAllElementTypesToAllElementTypes2Executor

class SimplestAETChange2CommandTransformingProviding extends AbstractResponseChange2CommandTransformingProviding {
	new() {
