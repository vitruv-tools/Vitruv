...
import responses.test1.responsesPcm_mockupToUml_mockup.ResponsePcm_mockupToUml_mockupExecutor
import responses.test1.responsesUml_mockupToPcm_mockup.ResponseUml_mockupToPcm_mockupExecutor

class Test1Change2CommandTransformingProviding extends AbstractResponseChange2CommandTransformingProviding {
	new() {
