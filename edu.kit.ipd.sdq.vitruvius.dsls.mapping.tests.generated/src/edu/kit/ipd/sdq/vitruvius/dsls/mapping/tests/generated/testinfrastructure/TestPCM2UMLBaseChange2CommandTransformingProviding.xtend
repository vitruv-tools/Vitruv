...
import responses.testPCM2UMLBase.responsesPcm_mockupToUml_mockup.ResponsePcm_mockupToUml_mockupExecutor
import responses.testPCM2UMLBase.responsesUml_mockupToPcm_mockup.ResponseUml_mockupToPcm_mockupExecutor

class TestPCM2UMLBaseChange2CommandTransformingProviding extends AbstractResponseChange2CommandTransformingProviding {
	new() {
