...
import responses.testPCM2UMLSignature.responsesPcm_mockupToUml_mockup.ResponsePcm_mockupToUml_mockupExecutor
import responses.testPCM2UMLSignature.responsesUml_mockupToPcm_mockup.ResponseUml_mockupToPcm_mockupExecutor

class TestPCM2UMLSignatureChange2CommandTransformingProviding extends AbstractResponseChange2CommandTransformingProviding {
	new() {
