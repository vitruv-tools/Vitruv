...
package edu.kit.ipd.sdq.vitruvius.javauml.editor.viewpoint;
...
public class Activator extends AbstractUIPlugin {
    ...
    public void start(BundleContext context) throws Exception {
	  ...
	  viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(PLUGIN_ID + "/description/javauml.odesign")); 
    }
